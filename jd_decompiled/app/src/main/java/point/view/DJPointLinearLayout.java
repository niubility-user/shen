...
public class DJPointLinearLayout extends LinearLayout implements DJPointView, RoundMethodInterface, DarkViewInterface {
    private final DJPointViewDelegate djPointViewDelegate;
    private int mDarkColor;
    private RoundHelper mHelper;
    private boolean mSwitchDark;

    public DJPointLinearLayout(Context context) {
        this(context, null);
    }
    ...
    public DJPointLinearLayout(Context context, @Nullable AttributeSet attributeSet) {
    ...
    public DJPointLinearLayout(Context context, @Nullable AttributeSet attributeSet, int i2) {
