...
public final class HttpUrl {
    ...
    private InetAddress resolverInetAddress;
    final String scheme;
    ...
    HttpUrl(Builder builder) {
        ...
        this.resolverInetAddress = builder.resolverInetAddress;
    }
    ...
    public InetAddress getResolverInetAddress() {
        return this.resolverInetAddress;
    }
    ...
    public static final class Builder {
        ...
        String host;
        @Nullable
        InetAddress resolverInetAddress;
        @Nullable
        String scheme;
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:44:0x0041 -> B:36:0x0029). Please submit an issue!!! */
        /*
        ...
        */
        ...
        public Builder externalAddress(InetAddress inetAddress) {
            this.resolverInetAddress = inetAddress;
            return this;
        }
        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (slashCount < 2 && httpUrl != null && httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    if (charAt == '\uffff' || charAt == c3 || charAt == '/' || charAt == '\\' || charAt == c2) {
                        break;
                    }
                    if (charAt == '@') {
                        if (!z) {
