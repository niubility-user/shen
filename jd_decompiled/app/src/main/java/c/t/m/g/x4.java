    ...
    */
    public final void n(java.util.List<android.net.wifi.ScanResult> r5) {
        ...
        L12:
            boolean r0 = r4.j(r5)
            if (r0 == 0) goto L2a
            c.t.m.g.b1 r0 = new c.t.m.g.b1
            long r1 = r4.d
            android.net.wifi.WifiManager r3 = r4.f746c
            int r3 = c.t.m.g.k1.a(r3)
            r0.<init>(r5, r1, r3)
            c.t.m.g.y4 r5 = r4.b
            r5.f(r0)
        L2a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: c.t.m.g.x4.n(java.util.List):void");
    }
