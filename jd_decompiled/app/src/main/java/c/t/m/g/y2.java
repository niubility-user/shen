    ...
    */
    public final void c() {
        /*
            ...
            r1 = 0
            r2 = 1
            java.util.concurrent.ConcurrentHashMap<java.lang.String, java.lang.String> r3 = r8.b     // Catch: java.lang.Throwable -> L3f
            ...
            boolean r4 = c.t.m.g.t2.c(r3)     // Catch: java.lang.Throwable -> L3f
            if (r4 == 0) goto L1a
        L14:
            java.util.concurrent.atomic.AtomicBoolean r3 = r8.f778e     // Catch: java.lang.Throwable -> L3f
            r3.getAndSet(r2)     // Catch: java.lang.Throwable -> L3f
            goto L44
        L1a:
            java.lang.String r4 = c.t.m.g.z3.k()     // Catch: java.lang.Throwable -> L3f
            java.lang.String r5 = " "
            java.lang.String r6 = ""
            java.lang.String r4 = r4.replace(r5, r6)     // Catch: java.lang.Throwable -> L3f
            java.lang.String[] r3 = r3.split(r0)     // Catch: java.lang.Throwable -> L3f
            java.util.concurrent.atomic.AtomicBoolean r5 = r8.f778e     // Catch: java.lang.Throwable -> L3f
            r5.getAndSet(r1)     // Catch: java.lang.Throwable -> L3f
            int r5 = r3.length     // Catch: java.lang.Throwable -> L3f
            r6 = 0
        L31:
            if (r6 >= r5) goto L44
            r7 = r3[r6]     // Catch: java.lang.Throwable -> L3f
            boolean r7 = r4.equalsIgnoreCase(r7)     // Catch: java.lang.Throwable -> L3f
            if (r7 == 0) goto L3c
            goto L14
        L3c:
            int r6 = r6 + 1
            goto L31
        L3f:
            java.util.concurrent.atomic.AtomicBoolean r3 = r8.f778e
            r3.getAndSet(r2)
        L44:
            java.util.concurrent.ConcurrentHashMap<java.lang.String, java.lang.String> r3 = r8.b     // Catch: java.lang.Throwable -> L7d
            ...
            boolean r4 = c.t.m.g.t2.c(r3)     // Catch: java.lang.Throwable -> L7d
            if (r4 == 0) goto L5a
            java.util.concurrent.atomic.AtomicBoolean r0 = r8.f779f     // Catch: java.lang.Throwable -> L7d
            r0.getAndSet(r2)     // Catch: java.lang.Throwable -> L7d
            return
        L5a:
            int r4 = android.os.Build.VERSION.SDK_INT     // Catch: java.lang.Throwable -> L7d
            java.lang.String r4 = java.lang.Integer.toString(r4)     // Catch: java.lang.Throwable -> L7d
            java.lang.String[] r0 = r3.split(r0)     // Catch: java.lang.Throwable -> L7d
            java.util.concurrent.atomic.AtomicBoolean r3 = r8.f779f     // Catch: java.lang.Throwable -> L7d
            r3.getAndSet(r1)     // Catch: java.lang.Throwable -> L7d
            int r3 = r0.length     // Catch: java.lang.Throwable -> L7d
        L6a:
            if (r1 >= r3) goto L82
            r5 = r0[r1]     // Catch: java.lang.Throwable -> L7d
            boolean r5 = r4.equalsIgnoreCase(r5)     // Catch: java.lang.Throwable -> L7d
            if (r5 == 0) goto L7a
            java.util.concurrent.atomic.AtomicBoolean r0 = r8.f779f     // Catch: java.lang.Throwable -> L7d
            r0.getAndSet(r2)     // Catch: java.lang.Throwable -> L7d
            return
        L7a:
            ...
            goto L6a
        L7d:
            java.util.concurrent.atomic.AtomicBoolean r0 = r8.f779f
            r0.getAndSet(r2)
        L82:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: c.t.m.g.y2.c():void");
    }
