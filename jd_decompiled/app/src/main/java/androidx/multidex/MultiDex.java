...
public final class MultiDex {
    ...
    private static void doInstallation(Context context, File file, File file2, String str, String str2, boolean z) throws IOException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException {
        ...
        synchronized (set) {
            ...
            if (i2 > 20) {
                String str3 = "MultiDex is not guaranteed to work in SDK version " + i2 + ": SDK version higher than 20 should be backed by runtime with built-in multidex capabilty but it's not the case here: java.vm.version=\"" + System.getProperty("java.vm.version") + "\"";
            }
    ...
    public static void install(Context context) {
        ...
        throw new RuntimeException("MultiDex installation failed. SDK " + i2 + " is unsupported. Min SDK version is 4" + OrderISVUtil.MONEY_DECIMAL);
    }
    ...
    public static void installInstrumentation(Context context, Context context2) {
        ...
        if (i2 >= 4) {
            try {
                ...
                String str = context.getPackageName() + OrderISVUtil.MONEY_DECIMAL;
    ...
    static boolean isVMMultidexCapable(String str) {
        boolean z = false;
        if (str != null) {
            StringTokenizer stringTokenizer = new StringTokenizer(str, OrderISVUtil.MONEY_DECIMAL);
