...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    View findOneVisibleChild(int i2, int i3, boolean z, boolean z2) {
        ensureLayoutState();
        int i4 = z ? R2.styleable.RoundTextView_rTopRadius : 320;
        int i5 = z2 ? 320 : 0;
        if (this.mOrientation == 0) {
            return this.mHorizontalBoundCheck.findOneViewWithinBoundFlags(i2, i3, i4, i5);
        }
    ...
    public void prepareForDrop(@NonNull View view, @NonNull View view2, int i2, int i3) {
        ...
        char c2 = position < position2 ? (char) 1 : '\uffff';
        if (this.mShouldReverseLayout) {
            if (c2 == 1) {
