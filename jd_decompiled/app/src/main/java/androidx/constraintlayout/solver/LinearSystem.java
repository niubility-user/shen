...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        String str = "";
        for (int i2 = 0; i2 < this.mNumRows; i2++) {
            str = (str + this.mRows[i2]) + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        System.out.println(str + this.mGoal + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
    }

    private void displaySolverVariables() {
        System.out.println("Display Rows (" + this.mNumRows + JshopConst.JSHOP_PROMOTIO_X + this.mNumColumns + ")\n");
    }
    ...
    void displayReadableRows() {
        ...
        if (this.mGoal != null) {
            str = str + this.mGoal + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i2 = 0; i2 < this.mNumRows; i2++) {
            if (this.mRows[i2].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                str = (str + this.mRows[i2].toReadableString()) + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
            }
        }
        System.out.println(str + this.mGoal + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
    }
