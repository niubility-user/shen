        ...
        if (this.mState <= 1) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0015: INVOKE 
                  (r8v0 'this' androidx.fragment.app.Fragment A[IMMUTABLE_TYPE, THIS])
                  (wrap: androidx.fragment.app.Fragment$OnPreAttachedListener : 0x0012: CONSTRUCTOR 
                  (r8v0 'this' androidx.fragment.app.Fragment A[IMMUTABLE_TYPE, THIS])
                  (r10v0 'function' androidx.arch.core.util.Function<java.lang.Void, androidx.activity.result.ActivityResultRegistry> A[DONT_INLINE])
                  (r0 I:java.util.concurrent.atomic.AtomicReference A[DONT_GENERATE, DONT_INLINE, REMOVE])
                  (r9v0 'activityResultContract' androidx.activity.result.contract.ActivityResultContract<I, O> A[DONT_INLINE])
                  (r11v0 'activityResultCallback' androidx.activity.result.ActivityResultCallback<O> A[DONT_INLINE])
                 A[MD:(androidx.fragment.app.Fragment, androidx.arch.core.util.Function, java.util.concurrent.atomic.AtomicReference, androidx.activity.result.contract.ActivityResultContract, androidx.activity.result.ActivityResultCallback):void (m), WRAPPED] (LINE:3) call: androidx.fragment.app.Fragment.8.<init>(androidx.fragment.app.Fragment, androidx.arch.core.util.Function, java.util.concurrent.atomic.AtomicReference, androidx.activity.result.contract.ActivityResultContract, androidx.activity.result.ActivityResultCallback):void type: CONSTRUCTOR)
                 type: DIRECT call: androidx.fragment.app.Fragment.registerOnPreAttachListener(androidx.fragment.app.Fragment$OnPreAttachedListener):void A[MD:(androidx.fragment.app.Fragment$OnPreAttachedListener):void (m)] (LINE:3) in method: androidx.fragment.app.Fragment.prepareCallInternal(androidx.activity.result.contract.ActivityResultContract<I, O>, androidx.arch.core.util.Function<java.lang.Void, androidx.activity.result.ActivityResultRegistry>, androidx.activity.result.ActivityResultCallback<O>):androidx.activity.result.ActivityResultLauncher<I>, file: classes.dex
