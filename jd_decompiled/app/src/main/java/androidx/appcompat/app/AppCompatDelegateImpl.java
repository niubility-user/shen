...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x003f: INVOKE 
              (wrap: java.lang.Thread$UncaughtExceptionHandler : 0x003c: CONSTRUCTOR (r0 I:java.lang.Thread$UncaughtExceptionHandler A[DONT_GENERATE, DONT_INLINE, REMOVE]) A[MD:(java.lang.Thread$UncaughtExceptionHandler):void (m), WRAPPED] (LINE:9) call: androidx.appcompat.app.AppCompatDelegateImpl.1.<init>(java.lang.Thread$UncaughtExceptionHandler):void type: CONSTRUCTOR)
             type: STATIC call: java.lang.Thread.setDefaultUncaughtExceptionHandler(java.lang.Thread$UncaughtExceptionHandler):void A[MD:(java.lang.Thread$UncaughtExceptionHandler):void (c)] (LINE:9) in method: androidx.appcompat.app.AppCompatDelegateImpl.<clinit>():void, file: classes.dex
        ...
        L11:
            r3 = 0
        L12:
            androidx.appcompat.app.AppCompatDelegateImpl.IS_PRE_LOLLIPOP = r3
            int[] r4 = new int[r2]
            r5 = 16842836(0x1010054, float:2.3693793E-38)
            r4[r1] = r5
            androidx.appcompat.app.AppCompatDelegateImpl.sWindowBackgroundStyleable = r4
            java.lang.String r4 = android.os.Build.FINGERPRINT
            java.lang.String r5 = "robolectric"
            boolean r4 = r5.equals(r4)
            r4 = r4 ^ r2
            androidx.appcompat.app.AppCompatDelegateImpl.sCanReturnDifferentContext = r4
            r4 = 17
            if (r0 < r4) goto L2e
            r1 = 1
        L2e:
            ...
            androidx.appcompat.app.AppCompatDelegateImpl.sInstalledExceptionHandler = r2
        L44:
            return
        */
    ...
    private static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            int i25 = configuration.screenLayout & R2.attr.dividerDrawableHorizontal;
            int i26 = configuration2.screenLayout;
            if (i25 != (i26 & R2.attr.dividerDrawableHorizontal)) {
                configuration3.screenLayout |= i26 & R2.attr.dividerDrawableHorizontal;
            }
            if (i6 >= 26) {
