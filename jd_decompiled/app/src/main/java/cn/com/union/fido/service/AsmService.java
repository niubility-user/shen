...
public class AsmService implements AsmStatusCode {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:95:0x003c, code lost:
        if (r1.isSecondFactorOnly != false) goto L159;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private cn.com.union.fido.bean.asm.ASMResponse authenticateRequest(cn.com.union.fido.bean.asm.ASMRequest r10) {
        /*
            Method dump skipped, instructions count: 273
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.com.union.fido.service.AsmService.authenticateRequest(cn.com.union.fido.bean.asm.ASMRequest):cn.com.union.fido.bean.asm.ASMResponse");
    }
