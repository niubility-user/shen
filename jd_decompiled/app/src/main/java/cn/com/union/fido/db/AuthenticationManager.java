    ...
    */
    public int getCountByUserName(java.lang.String r6) {
        /*
            r5 = this;
            r0 = -1
            android.database.sqlite.SQLiteDatabase r1 = r5.db     // Catch: java.lang.Throwable -> L21
            ...
            android.database.Cursor r6 = r1.rawQuery(r2, r3)     // Catch: java.lang.Throwable -> L21
            boolean r1 = r6.moveToNext()     // Catch: java.lang.Throwable -> L1f
            if (r1 == 0) goto L19
            int r0 = r6.getInt(r4)     // Catch: java.lang.Throwable -> L1f
        L19:
            if (r6 == 0) goto L25
        L1b:
            r6.close()
