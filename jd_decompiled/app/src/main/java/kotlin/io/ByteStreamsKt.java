...
public final class ByteStreamsKt {
    ...
    @InlineOnly
    private static final BufferedOutputStream buffered(@NotNull OutputStream outputStream, int i2) {
    ...
    @InlineOnly
    private static final ByteArrayInputStream inputStream(@NotNull byte[] bArr, int i2, int i3) {
