...
public class WJLoginCommunion extends WJLoginInternational {
    ...
    */
    public void i(byte r5, jd.wjlogin_sdk.tlvtype.a r6, jd.wjlogin_sdk.common.listener.OnCommonCallback r7) {
        /*
            r4 = this;
            jd.wjlogin_sdk.model.FailResult r0 = new jd.wjlogin_sdk.model.FailResult     // Catch: java.lang.Exception -> L54
            r0.<init>()     // Catch: java.lang.Exception -> L54
            r1 = 3
            r2 = 30
            if (r5 != 0) goto L46
            r0 = 0
            r4.a(r6, r0)     // Catch: java.lang.Exception -> L54
            java.lang.String r6 = r4.getA2()     // Catch: java.lang.Exception -> L54
            boolean r6 = android.text.TextUtils.isEmpty(r6)     // Catch: java.lang.Exception -> L54
            if (r6 != 0) goto L2c
            java.lang.String r6 = r4.getPin()     // Catch: java.lang.Exception -> L54
            boolean r6 = android.text.TextUtils.isEmpty(r6)     // Catch: java.lang.Exception -> L54
            if (r6 == 0) goto L23
            goto L2c
        L23:
            if (r7 == 0) goto L28
            r7.onSuccessHandleInner()     // Catch: java.lang.Exception -> L54
        L28:
            r4.b(r5, r2, r1)     // Catch: java.lang.Exception -> L54
            return
        L2c:
            if (r7 == 0) goto L41
            ...
            jd.wjlogin_sdk.model.ErrorResult r5 = jd.wjlogin_sdk.util.b0.a(r5, r6, r0)     // Catch: java.lang.Exception -> L54
            r7.onErrorHandleInner(r5)     // Catch: java.lang.Exception -> L54
        L41:
            r5 = -2
            r4.b(r5, r2, r1)     // Catch: java.lang.Exception -> L54
            return
        L46:
            jd.wjlogin_sdk.tlvtype.x r6 = r6.p()     // Catch: java.lang.Exception -> L54
            r4.a(r0, r5, r6)     // Catch: java.lang.Exception -> L54
            r7.onFailHandleInner(r0)     // Catch: java.lang.Exception -> L54
            r4.b(r5, r2, r1)     // Catch: java.lang.Exception -> L54
            goto L61
        L54:
            r5 = move-exception
        ...
        L61:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: jd.wjlogin_sdk.common.communion.WJLoginCommunion.i(byte, jd.wjlogin_sdk.tlvtype.a, jd.wjlogin_sdk.common.listener.OnCommonCallback):void");
    }
