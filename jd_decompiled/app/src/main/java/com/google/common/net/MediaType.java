...
public final class MediaType {
    ...
    public static final MediaType I_CALENDAR_UTF_8 = createConstantUtf8("text", NavigatorHolder.NaviEntity.TYPE_CALENDAR);
    ...
    public static final MediaType GIF = createConstant("image", WareBusinessMagicHeadPicInfoEntity.IMAGE_TYPE_GIF);
