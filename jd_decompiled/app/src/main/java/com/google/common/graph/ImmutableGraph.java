...
@Immutable(containerOf = {AuraConstants.MESSAGE_COUPON_TYPE_NEW})
@Beta
...
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    private static <N> GraphConnections<N, GraphConstants.Presence> connectionsOf(Graph<N> graph, N n2) {
        ...
        if (graph.isDirected()) {
            return DirectedGraphConnections.ofImmutable(graph.predecessors((Graph<N>) n2), Maps.asMap(graph.successors((Graph<N>) n2), constant));
        }
