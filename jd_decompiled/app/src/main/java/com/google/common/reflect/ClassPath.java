...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.on(LangUtils.SINGLE_SPACE).omitEmptyStrings();
    ...
    static String getClassName(String str) {
        return str.substring(0, str.length() - 6).replace('/', OrderISVUtil.MONEY_DECIMAL_CHAR);
    }
    ...
    public ImmutableSet<ClassInfo> getTopLevelClassesRecursive(String str) {
        ...
        String str2 = str + OrderISVUtil.MONEY_DECIMAL_CHAR;
