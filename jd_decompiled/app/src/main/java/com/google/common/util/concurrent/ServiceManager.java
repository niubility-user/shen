...
public final class ServiceManager {
    ...
    public String toString() {
        return MoreObjects.toStringHelper((Class<?>) ServiceManager.class).add(i2.d, Collections2.filter(this.services, Predicates.not(Predicates.instanceOf(NoOpService.class)))).toString();
    }
    ...
    private static final class ServiceManagerState {
        ...
        void awaitStopped(long j2, TimeUnit timeUnit) throws TimeoutException {
            this.monitor.enter();
            try {
        ...
        void awaitHealthy(long j2, TimeUnit timeUnit) throws TimeoutException {
            this.monitor.enter();
            try {
