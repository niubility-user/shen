...
final class DecodedBitStreamParser {
    ...
    private static final char[] C40_SHIFT2_SET_CHARS = {'!', Typography.quote, '#', Typography.dollar, '%', Typography.amp, '\'', '(', ')', '*', '+', ',', '-', OrderISVUtil.MONEY_DECIMAL_CHAR, '/', ':', ';', Typography.less, '=', Typography.greater, '?', '@', '[', '\\', ']', '^', '_'};
    ...
    private static void parseTwoBytes(int i2, int i3, int[] iArr) {
        int i4 = ((i2 << 8) + i3) - 1;
        int i5 = i4 / R2.attr.ptrMode;
        iArr[0] = i5;
        int i6 = i4 - (i5 * R2.attr.ptrMode);
        int i7 = i6 / 40;
        iArr[1] = i7;
        iArr[2] = i6 - (i7 * 40);
    }
    ...
    private static int unrandomize255State(int i2, int i3) {
        int i4 = i2 - (((i3 * R2.anim.mtrl_bottom_sheet_slide_out) % 255) + 1);
