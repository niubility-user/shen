...
public final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int i2) {
        ...
        if (obtainStyledAttributes.hasValue(i3)) {
            this.collapsedTextColor = obtainStyledAttributes.getColorStateList(i3);
        }
        if (obtainStyledAttributes.hasValue(R.styleable.TextAppearance_android_textSize)) {
            this.collapsedTextSize = obtainStyledAttributes.getDimensionPixelSize(r1, (int) this.collapsedTextSize);
        }
    ...
    public void setExpandedTextAppearance(int i2) {
        ...
        int i3 = R.styleable.TextAppearance_android_textColor;
        if (obtainStyledAttributes.hasValue(i3)) {
            this.expandedTextColor = obtainStyledAttributes.getColorStateList(i3);
        }
        if (obtainStyledAttributes.hasValue(R.styleable.TextAppearance_android_textSize)) {
            this.expandedTextSize = obtainStyledAttributes.getDimensionPixelSize(r1, (int) this.expandedTextSize);
        }
