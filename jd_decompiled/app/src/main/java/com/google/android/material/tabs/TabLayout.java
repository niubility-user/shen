    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        try {
            ...
            if (obtainStyledAttributes.hasValue(i5)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, obtainStyledAttributes, i5);
            }
            int i6 = R.styleable.TabLayout_tabSelectedTextColor;
            if (obtainStyledAttributes.hasValue(i6)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), obtainStyledAttributes.getColor(i6, 0));
            }
