...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
                ...
                if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableStart") == null) {
                    if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableEnd") == null) {
                        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableRight") == null) {
                            if (attributeSet.getAttributeBooleanValue(NAMESPACE_ANDROID, "singleLine", true) && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "lines", 1) == 1 && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "minLines", 1) == 1 && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, DYConstants.DY_TEXT_MAXLINES, 1) == 1) {
                                attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, DYConstants.DY_GRAVITY, 8388627);
                                return;
                            }
    ...
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        ...
        if (keyCode != 61) {
            ...
            int i4 = this.focusedVirtualView;
            if (i4 == -1) {
                performClick();
                return true;
            } else if (i4 == 0) {
            ...
            if (keyEvent.hasNoModifiers()) {
                ...
                i3 = keyEvent.hasModifiers(1) ? 1 : 0;
            }
            if (i3 != 0) {
    ...
    */
    ...
    public Chip(Context context, AttributeSet attributeSet, int i2) {
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i2, R.style.Widget_MaterialComponents_Chip_Action);
