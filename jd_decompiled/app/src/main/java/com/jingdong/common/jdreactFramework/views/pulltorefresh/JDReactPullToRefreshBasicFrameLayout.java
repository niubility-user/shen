...
public class JDReactPullToRefreshBasicFrameLayout extends ViewGroup {
    ...
    */
    public boolean dispatchTouchEvent(android.view.MotionEvent r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jingdong.common.jdreactFramework.views.pulltorefresh.JDReactPullToRefreshBasicFrameLayout.dispatchTouchEvent(android.view.MotionEvent):boolean");
    }
