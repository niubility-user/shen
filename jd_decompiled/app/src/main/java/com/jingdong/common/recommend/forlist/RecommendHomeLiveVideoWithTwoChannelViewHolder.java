...
public class RecommendHomeLiveVideoWithTwoChannelViewHolder extends BaseRecommendViewHolder {
    private BaseActivity baseActivity;
    private ConstraintLayout cardview_container;
    private View recommendHomeCardTwoChannelItemView;
    private RecommendHomeCardTwoChannelViewHolder recommendHomeCardTwoChannelViewHolder;
    private View recommendHomeLiveVideoItemView;
    private RecommendHomeLiveVideoViewHolder recommendHomeLiveVideoViewHolder;

    public RecommendHomeLiveVideoWithTwoChannelViewHolder(BaseActivity baseActivity, View view) {
        super(view);
    ...
    private void findViews(View view) {
        ...
        this.recommendHomeCardTwoChannelItemView = view.findViewById(R.id.included_home_card_two_channel_floor);
        this.recommendHomeLiveVideoItemView = view.findViewById(R.id.video_cardview);
        View view2 = this.recommendHomeCardTwoChannelItemView;
        if (view2 != null) {
            this.recommendHomeCardTwoChannelViewHolder = new RecommendHomeCardTwoChannelViewHolder(this.baseActivity, view2);
        }
    ...
    public void exposurePercent(double d) {
        ...
        RecommendHomeCardTwoChannelViewHolder recommendHomeCardTwoChannelViewHolder = this.recommendHomeCardTwoChannelViewHolder;
        if (recommendHomeCardTwoChannelViewHolder != null) {
            recommendHomeCardTwoChannelViewHolder.exposurePercent(d);
        }
    ...
    public void setData(RecommendHomeCardBean recommendHomeCardBean, JDDisplayImageOptions jDDisplayImageOptions) {
        ...
        if (recommendHomeCardBean.subWareList.size() > 1) {
            ...
            RecommendHomeCardTwoChannelViewHolder recommendHomeCardTwoChannelViewHolder = this.recommendHomeCardTwoChannelViewHolder;
            if (recommendHomeCardTwoChannelViewHolder != null) {
                recommendHomeCardTwoChannelViewHolder.setData(recommendHomeCardBean2, jDDisplayImageOptions);
            }
        }
        RecommendHomeLiveVideoViewHolder recommendHomeLiveVideoViewHolder = this.recommendHomeLiveVideoViewHolder;
        if (recommendHomeLiveVideoViewHolder != null) {
