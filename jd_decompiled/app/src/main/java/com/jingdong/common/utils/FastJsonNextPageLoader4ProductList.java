...
public abstract class FastJsonNextPageLoader4ProductList implements HttpGroup.OnAllListener, IDestroyListener {
    ...
    private class BaseListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            FastJsonNextPageLoader4ProductList.this.onScroll(absListView, i2, i3, i4);
        }

        @Override // android.widget.AbsListView.OnScrollListener
        public void onScrollStateChanged(AbsListView absListView, int i2) {
            FastJsonNextPageLoader4ProductList.this.onScrollStateChanged(absListView, i2);
        }
    }
    ...
    public class GalleryListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> adapterView, View view, int i2, long j2) {
            if (FastJsonNextPageLoader4ProductList.this.showItemList.size() - 1 != i2 || FastJsonNextPageLoader4ProductList.this.isFinishing || FastJsonNextPageLoader4ProductList.this.isLoadedLastPage()) {
                return;
            }
    ...
    public abstract class OnScrollLastListener extends BaseListener {
        ...
        @Override // com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.BaseListener, android.widget.AbsListView.OnScrollListener
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            this.firstVisibleItem = i2;
            this.visibleItemCount = i3;
            this.totalItemCount = i4;
            FastJsonNextPageLoader4ProductList.this.setSelection(i2);
            FastJsonNextPageLoader4ProductList.this.mCurrPos = (i3 / 2) + i2;
            if (absListView.getAdapter() != null && ((ListAdapter) absListView.getAdapter()).getCount() > 0) {
                View childAt = absListView.getChildAt(0);
                FastJsonNextPageLoader4ProductList.this.onFirstVisible(absListView.getFirstVisiblePosition(), childAt == null ? 0 : childAt.getLeft(), childAt == null ? 0 : childAt.getTop(), childAt == null ? 0 : childAt.getRight(), childAt == null ? 0 : childAt.getBottom());
            }
    ...
    private void doAdapter() {
        ...
        this.onScrollLastListener = new OnScrollLastListener() { // from class: com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.3
            @Override // com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.OnScrollLastListener
            public void onScrollFling() {
                FastJsonNextPageLoader4ProductList.this.isFling = true;
            }

            @Override // com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.OnScrollLastListener
            public void onScrollIdle() {
                FastJsonNextPageLoader4ProductList.this.isHolding = false;
                FastJsonNextPageLoader4ProductList.this.isFling = false;
                if (FastJsonNextPageLoader4ProductList.this.isFinishing) {
                    return;
                }
                if (FastJsonNextPageLoader4ProductList.this.hasNotify) {
                    FastJsonNextPageLoader4ProductList.this.hasNotify = false;
                    if (FastJsonNextPageLoader4ProductList.this.isSencondDataStrucUsed()) {
                        if (FastJsonNextPageLoader4ProductList.this.secondAdapter != null) {
                            FastJsonNextPageLoader4ProductList.this.secondAdapter.notifyDataSetChanged();
                        }
                    } else if (FastJsonNextPageLoader4ProductList.this.adapter != null) {
                        FastJsonNextPageLoader4ProductList.this.adapter.notifyDataSetChanged();
                    }
                }
                checkLast();
            }
            ...
            public void onScrollLast() {
                if (FastJsonNextPageLoader4ProductList.this.isFinishing || FastJsonNextPageLoader4ProductList.this.isLoadedLastPage()) {
                    return;
                }
                FastJsonNextPageLoader4ProductList.this.tryShowNextPage();
            }
            ...
            public void onScrollStart() {
                if (FastJsonNextPageLoader4ProductList.this.isLoadedLastPage() || FastJsonNextPageLoader4ProductList.this.isWifi || FastJsonNextPageLoader4ProductList.this.hasLoadFirstData) {
                    return;
                }
                FastJsonNextPageLoader4ProductList.this.hasLoadFirstData = true;
                FastJsonNextPageLoader4ProductList.this.tryShowNextPage();
            }
        };
        this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.4
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action != 0) {
                    if (action == 1 && !FastJsonNextPageLoader4ProductList.this.isFling) {
                        FastJsonNextPageLoader4ProductList.this.onScrollLastListener.onScrollIdle();
                        return false;
                    }
                    return false;
                }
                FastJsonNextPageLoader4ProductList.this.isHolding = true;
                return false;
            }
        });
        ...
        if (adapterView instanceof ListView) {
            ...
            this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.5
                @Override // android.view.View.OnTouchListener
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    return false;
                }
    ...
    private void setLoading(final boolean z) {
        ...
        if (iMyActivity != null) {
            iMyActivity.post(new Runnable() { // from class: com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.1
                @Override // java.lang.Runnable
                public void run() {
                    if (!z) {
                        FastJsonNextPageLoader4ProductList.this.showLoadingView(false);
                        return;
                    }
                    ArrayList<Object> arrayList = FastJsonNextPageLoader4ProductList.this.showItemList;
                    if (arrayList == null || arrayList.size() <= 0) {
                        return;
                    }
                    FastJsonNextPageLoader4ProductList.this.showLoadingView(true);
                }
            });
        }
    }
    ...
    public void showNextPage(ArrayList<?> arrayList) {
        ...
        tryDoAdapter();
        this.handler.postDelayed(new Runnable() { // from class: com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.2
            @Override // java.lang.Runnable
            public void run() {
                FastJsonNextPageLoader4ProductList fastJsonNextPageLoader4ProductList = FastJsonNextPageLoader4ProductList.this;
                if (fastJsonNextPageLoader4ProductList.adapterView == null || fastJsonNextPageLoader4ProductList.showItemList.size() > FastJsonNextPageLoader4ProductList.this.adapterView.getChildCount()) {
                    return;
                }
                FastJsonNextPageLoader4ProductList.this.tryShowNextPage();
            }
    ...
    public void onEnd(final HttpResponse httpResponse) {
        ...
        this.handler.post(new Runnable() { // from class: com.jingdong.common.utils.FastJsonNextPageLoader4ProductList.6
            private boolean handleReturn(HttpResponse httpResponse2) {
                Map<String, Object> moreParams = httpResponse2.getMoreParams();
                Map<String, Object> keyParmas = FastJsonNextPageLoader4ProductList.this.getKeyParmas();
                ...
                for (String str : moreParams.keySet()) {
                    ...
                    if (OKLog.D) {
                        OKLog.d(FastJsonNextPageLoader4ProductList.TAG, "handleReturn() -->> moreKey = " + str);
                        OKLog.d(FastJsonNextPageLoader4ProductList.TAG, "handleReturn() -->> moreValue = " + obj);
                        OKLog.d(FastJsonNextPageLoader4ProductList.TAG, "handleReturn() -->> currentValue = " + obj2);
                    }
            ...
            private void handleSecondDataStruc(HttpResponse httpResponse2) {
                if (FastJsonNextPageLoader4ProductList.this.isUseSecondDataStrucFlag()) {
                    if (OKLog.D) {
                        OKLog.d(FastJsonNextPageLoader4ProductList.TAG, "handleSecondDataStruc() -->> \u4f7f\u7528\u4e86\u7b2c\u4e8c\u79cd\u6570\u636e\u7ed3\u6784 ");
                    }
                    ArrayList<?> secondList = FastJsonNextPageLoader4ProductList.this.toSecondList(httpResponse2);
                    ArrayList<Object> arrayList = FastJsonNextPageLoader4ProductList.this.secondDataStrucShowItemList;
                    if ((arrayList != null && arrayList.size() > 0) || (secondList != null && secondList.size() > 0)) {
                        FastJsonNextPageLoader4ProductList.this.showEmpty(false);
                        if (secondList != null && secondList.size() >= 1) {
                            if (secondList.size() > 0) {
                                if (OKLog.D) {
                                    OKLog.d(FastJsonNextPageLoader4ProductList.TAG, "handleSecondDataStruc() -->> \u4f7f\u7528\u4e86\u7b2c\u4e8c\u79cd\u6570\u636e\u7ed3\u6784\uff0c\u4e14\u8fd8\u4e0d\u4e3a\u7a7a\u54e6");
                                }
                                if (FastJsonNextPageLoader4ProductList.this.secondNextItemList != null && FastJsonNextPageLoader4ProductList.this.secondNextItemList.size() > 0 && (FastJsonNextPageLoader4ProductList.this.secondDataStrucShowItemList.size() * 2) / FastJsonNextPageLoader4ProductList.this.pageSize.intValue() < FastJsonNextPageLoader4ProductList.this.pageNum.intValue()) {
                                    FastJsonNextPageLoader4ProductList fastJsonNextPageLoader4ProductList = FastJsonNextPageLoader4ProductList.this;
                                    fastJsonNextPageLoader4ProductList.secondDataStrucShowItemList.addAll(fastJsonNextPageLoader4ProductList.secondNextItemList);
                                }
                                FastJsonNextPageLoader4ProductList.this.secondNextItemList = secondList;
                                if (FastJsonNextPageLoader4ProductList.this.isSencondDataStrucUsed()) {
                                    if (FastJsonNextPageLoader4ProductList.this.loadedShow()) {
                                        if (OKLog.D) {
                                            OKLog.d(FastJsonNextPageLoader4ProductList.TAG, "handleSecondDataStruc()  -->> show now -->> ");
                                        }
                                        FastJsonNextPageLoader4ProductList.this.showNextPage(secondList);
                                        return;
                                    }
                                    return;
                                }
                                FastJsonNextPageLoader4ProductList.this.secondDataStrucShowItemList.addAll(secondList);
                                return;
                            }
                            return;
                        }
                        OKLog.i(FastJsonNextPageLoader4ProductList.TAG, "handleSecondDataStruc() --->showError");
                        FastJsonNextPageLoader4ProductList.this.showError();
                        return;
                    }
                    FastJsonNextPageLoader4ProductList.this.showEmpty(true);
                }
            }
            ...
            public void run() {
                ...
                if (OKLog.D) {
                    OKLog.d(FastJsonNextPageLoader4ProductList.TAG, "onEnd -->> before handleReturn");
                }
                if (handleReturn(httpResponse)) {
                    if (OKLog.D) {
                        OKLog.d(FastJsonNextPageLoader4ProductList.TAG, "onEnd -->> after handleReturn");
                    }
                    try {
                        num = (Integer) httpResponse.getMoreParams().get(FastJsonNextPageLoader4ProductList.this.pageNumParamKey);
                    } catch (Exception e2) {
                        if (OKLog.E) {
                            OKLog.e(FastJsonNextPageLoader4ProductList.TAG, e2);
                        }
                    }
                    synchronized (FastJsonNextPageLoader4ProductList.this.loadedMap) {
                        if (FastJsonNextPageLoader4ProductList.this.TRUE == FastJsonNextPageLoader4ProductList.this.loadedMap.get(num)) {
                            return;
                        }
                        FastJsonNextPageLoader4ProductList.this.loadedMap.put(num, FastJsonNextPageLoader4ProductList.this.TRUE);
                        ArrayList<?> list = FastJsonNextPageLoader4ProductList.this.toList(httpResponse);
                        handleSecondDataStruc(httpResponse);
                        ArrayList<Object> arrayList = FastJsonNextPageLoader4ProductList.this.showItemList;
                        if ((arrayList != null && arrayList.size() > 0) || (list != null && list.size() > 0)) {
                            FastJsonNextPageLoader4ProductList.this.showEmpty(false);
                            if (list != null) {
                                if (FastJsonNextPageLoader4ProductList.this.nextItemList != null && FastJsonNextPageLoader4ProductList.this.nextItemList.size() > 0 && FastJsonNextPageLoader4ProductList.this.showItemList.size() / FastJsonNextPageLoader4ProductList.this.pageSize.intValue() < FastJsonNextPageLoader4ProductList.this.pageNum.intValue()) {
                                    FastJsonNextPageLoader4ProductList fastJsonNextPageLoader4ProductList = FastJsonNextPageLoader4ProductList.this;
                                    fastJsonNextPageLoader4ProductList.showItemList.addAll(fastJsonNextPageLoader4ProductList.nextItemList);
                                }
                                FastJsonNextPageLoader4ProductList.this.nextItemList = list;
                                if (!FastJsonNextPageLoader4ProductList.this.isSencondDataStrucUsed()) {
                                    if (FastJsonNextPageLoader4ProductList.this.loadedShow()) {
                                        FastJsonNextPageLoader4ProductList.this.showNextPage(list);
                                        return;
                                    }
                                    return;
                                }
                                FastJsonNextPageLoader4ProductList.this.showItemList.addAll(list);
                                return;
                            }
                            OKLog.i(FastJsonNextPageLoader4ProductList.TAG, "onEnd--->showError");
                            FastJsonNextPageLoader4ProductList.this.showError();
                            return;
                        }
                        FastJsonNextPageLoader4ProductList.this.showEmpty(true);
