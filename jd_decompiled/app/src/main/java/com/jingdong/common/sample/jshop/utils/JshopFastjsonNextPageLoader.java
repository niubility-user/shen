...
public abstract class JshopFastjsonNextPageLoader implements HttpGroup.OnAllListener, IDestroyListener {
    ...
    */
    public void showNextPage(java.util.ArrayList<?> r9, boolean r10) {
        /*
            Method dump skipped, instructions count: 478
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.showNextPage(java.util.ArrayList, boolean):void");
    }
