...
public class CommonBeautyFilter extends CommonFilter {
    ...
    public CommonBeautyFilter() {
        super(CommonFilter.NO_FILTER_VERTEX_SHADER, BILATERAL_FRAGMENT_SHADER);
    ...
    public void setBeautyLevel(float f2, float f3) {
        this.beautyLevel = f2;
        this.toneLevel = f3;
        setParams(f2, f3);
    }
    ...
    public CommonBeautyFilter(float f2, float f3, float f4) {
        super(CommonFilter.NO_FILTER_VERTEX_SHADER, BILATERAL_FRAGMENT_SHADER);
        this.beautyLevel = f2;
        this.toneLevel = f3;
        this.brightLevel = f4;
