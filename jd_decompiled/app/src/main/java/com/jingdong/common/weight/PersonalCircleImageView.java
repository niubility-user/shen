...
public class PersonalCircleImageView extends SimpleDraweeView {
    private static final String TAG = "PersonalCircleImageView";
    ...
    public PersonalCircleImageView(Context context) {
        this(context, null);
    }
    ...
    public PersonalCircleImageView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public PersonalCircleImageView(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.PersonalCircleImageView, i2, 0);
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.PersonalCircleImageView_borderWidth, 0);
        this.mBorderColor = obtainStyledAttributes.getColor(R.styleable.PersonalCircleImageView_borderColor, -1);
