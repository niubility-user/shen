...
public abstract class NextPageLoader4ProductList implements HttpGroup.OnAllListener, IDestroyListener {
    ...
    private class BaseListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            NextPageLoader4ProductList.this.onScroll(absListView, i2, i3, i4);
        }

        @Override // android.widget.AbsListView.OnScrollListener
        public void onScrollStateChanged(AbsListView absListView, int i2) {
            NextPageLoader4ProductList.this.onScrollStateChanged(absListView, i2);
        }
    }
    ...
    public class GalleryListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> adapterView, View view, int i2, long j2) {
            if (NextPageLoader4ProductList.this.showItemList.size() - 1 != i2 || NextPageLoader4ProductList.this.isFinishing || NextPageLoader4ProductList.this.isLoadedLastPage()) {
                return;
            }
            NextPageLoader4ProductList.this.tryShowNextPage();
        }
    ...
    public abstract class OnScrollLastListener extends BaseListener {
        ...
        @Override // com.jingdong.common.utils.NextPageLoader4ProductList.BaseListener, android.widget.AbsListView.OnScrollListener
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            this.firstVisibleItem = i2;
            this.visibleItemCount = i3;
            this.totalItemCount = i4;
            NextPageLoader4ProductList.this.setSelection(i2);
            NextPageLoader4ProductList.this.mCurrPos = (i3 / 2) + i2;
            if (absListView.getAdapter() != null && ((ListAdapter) absListView.getAdapter()).getCount() > 0) {
                View childAt = absListView.getChildAt(0);
                NextPageLoader4ProductList.this.onFirstVisible(absListView.getFirstVisiblePosition(), childAt == null ? 0 : childAt.getLeft(), childAt == null ? 0 : childAt.getTop(), childAt == null ? 0 : childAt.getRight(), childAt == null ? 0 : childAt.getBottom());
            }
    ...
    public NextPageLoader4ProductList(IMyActivity iMyActivity, HttpGroup httpGroup, AdapterView adapterView, View view, String str) {
    ...
    private void doAdapter() {
        ...
        this.onScrollLastListener = new OnScrollLastListener() { // from class: com.jingdong.common.utils.NextPageLoader4ProductList.3
            @Override // com.jingdong.common.utils.NextPageLoader4ProductList.OnScrollLastListener
            public void onScrollFling() {
                NextPageLoader4ProductList.this.isFling = true;
            }

            @Override // com.jingdong.common.utils.NextPageLoader4ProductList.OnScrollLastListener
            public void onScrollIdle() {
                NextPageLoader4ProductList.this.isHolding = false;
                NextPageLoader4ProductList.this.isFling = false;
                if (NextPageLoader4ProductList.this.isFinishing) {
                    return;
                }
                if (NextPageLoader4ProductList.this.hasNotify) {
                    NextPageLoader4ProductList.this.hasNotify = false;
                    if (NextPageLoader4ProductList.this.isSencondDataStrucUsed()) {
                        if (NextPageLoader4ProductList.this.secondAdapter != null) {
                            NextPageLoader4ProductList.this.secondAdapter.notifyDataSetChanged();
                        }
                    } else if (NextPageLoader4ProductList.this.adapter != null) {
                        NextPageLoader4ProductList.this.adapter.notifyDataSetChanged();
                    }
                }
                checkLast();
            }
            ...
            public void onScrollLast() {
                if (NextPageLoader4ProductList.this.isFinishing || NextPageLoader4ProductList.this.isLoadedLastPage()) {
                    return;
                }
                NextPageLoader4ProductList.this.tryShowNextPage();
            }
            ...
            public void onScrollStart() {
                if (NextPageLoader4ProductList.this.isLoadedLastPage() || NextPageLoader4ProductList.this.isWifi || NextPageLoader4ProductList.this.hasLoadFirstData) {
                    return;
                }
                NextPageLoader4ProductList.this.hasLoadFirstData = true;
                NextPageLoader4ProductList.this.tryShowNextPage();
            }
        };
        this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.utils.NextPageLoader4ProductList.4
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action != 0) {
                    if (action == 1 && !NextPageLoader4ProductList.this.isFling) {
                        NextPageLoader4ProductList.this.onScrollLastListener.onScrollIdle();
                        return false;
                    }
                    return false;
                }
                NextPageLoader4ProductList.this.isHolding = true;
                return false;
            }
        });
        ...
        if (adapterView instanceof ListView) {
            ...
            this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.utils.NextPageLoader4ProductList.5
                @Override // android.view.View.OnTouchListener
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    return false;
                }
    ...
    private void setLoading(final boolean z) {
        ...
        if (iMyActivity != null) {
            iMyActivity.post(new Runnable() { // from class: com.jingdong.common.utils.NextPageLoader4ProductList.1
                @Override // java.lang.Runnable
                public void run() {
                    if (!z) {
                        NextPageLoader4ProductList.this.showLoadingView(false);
                        return;
                    }
                    ArrayList<Object> arrayList = NextPageLoader4ProductList.this.showItemList;
                    if (arrayList == null || arrayList.size() <= 0) {
                        return;
                    }
                    NextPageLoader4ProductList.this.showLoadingView(true);
                }
            });
        }
    }
    ...
    public void showNextPage(ArrayList<?> arrayList) {
        ...
        tryDoAdapter();
        this.handler.postDelayed(new Runnable() { // from class: com.jingdong.common.utils.NextPageLoader4ProductList.2
            @Override // java.lang.Runnable
            public void run() {
                NextPageLoader4ProductList nextPageLoader4ProductList = NextPageLoader4ProductList.this;
                if (nextPageLoader4ProductList.adapterView == null || nextPageLoader4ProductList.showItemList.size() > NextPageLoader4ProductList.this.adapterView.getChildCount()) {
                    return;
                }
                NextPageLoader4ProductList.this.tryShowNextPage();
            }
    ...
    public void onEnd(final HttpResponse httpResponse) {
        ...
        this.handler.post(new Runnable() { // from class: com.jingdong.common.utils.NextPageLoader4ProductList.6
            private boolean handleReturn(HttpResponse httpResponse2) {
                Map<String, Object> moreParams = httpResponse2.getMoreParams();
                Map<String, Object> keyParmas = NextPageLoader4ProductList.this.getKeyParmas();
                ...
                for (String str : moreParams.keySet()) {
                    ...
                    if (OKLog.D) {
                        OKLog.d(NextPageLoader4ProductList.TAG, "handleReturn() -->> moreKey = " + str);
                        OKLog.d(NextPageLoader4ProductList.TAG, "handleReturn() -->> moreValue = " + obj);
                        OKLog.d(NextPageLoader4ProductList.TAG, "handleReturn() -->> currentValue = " + obj2);
                    }
            ...
            private void handleSecondDataStruc(HttpResponse httpResponse2) {
                if (NextPageLoader4ProductList.this.isUseSecondDataStrucFlag()) {
                    if (OKLog.D) {
                        OKLog.d(NextPageLoader4ProductList.TAG, "handleSecondDataStruc() -->> \u4f7f\u7528\u4e86\u7b2c\u4e8c\u79cd\u6570\u636e\u7ed3\u6784 ");
                    }
                    ArrayList<?> secondList = NextPageLoader4ProductList.this.toSecondList(httpResponse2);
                    ArrayList<Object> arrayList = NextPageLoader4ProductList.this.secondDataStrucShowItemList;
                    if ((arrayList != null && arrayList.size() > 0) || (secondList != null && secondList.size() > 0)) {
                        NextPageLoader4ProductList.this.showEmpty(false);
                        if (secondList != null && secondList.size() >= 1) {
                            if (secondList.size() > 0) {
                                if (OKLog.D) {
                                    OKLog.d(NextPageLoader4ProductList.TAG, "handleSecondDataStruc() -->> \u4f7f\u7528\u4e86\u7b2c\u4e8c\u79cd\u6570\u636e\u7ed3\u6784\uff0c\u4e14\u8fd8\u4e0d\u4e3a\u7a7a\u54e6");
                                }
                                if (NextPageLoader4ProductList.this.secondNextItemList != null && NextPageLoader4ProductList.this.secondNextItemList.size() > 0 && (NextPageLoader4ProductList.this.secondDataStrucShowItemList.size() * 2) / NextPageLoader4ProductList.this.pageSize.intValue() < NextPageLoader4ProductList.this.pageNum.intValue()) {
                                    NextPageLoader4ProductList nextPageLoader4ProductList = NextPageLoader4ProductList.this;
                                    nextPageLoader4ProductList.secondDataStrucShowItemList.addAll(nextPageLoader4ProductList.secondNextItemList);
                                }
                                NextPageLoader4ProductList.this.secondNextItemList = secondList;
                                if (NextPageLoader4ProductList.this.isSencondDataStrucUsed()) {
                                    if (NextPageLoader4ProductList.this.loadedShow()) {
                                        if (OKLog.D) {
                                            OKLog.d(NextPageLoader4ProductList.TAG, "handleSecondDataStruc()  -->> show now -->> ");
                                        }
                                        NextPageLoader4ProductList.this.showNextPage(secondList);
                                        return;
                                    }
                                    return;
                                }
                                NextPageLoader4ProductList.this.secondDataStrucShowItemList.addAll(secondList);
                                return;
                            }
                            return;
                        }
                        OKLog.i(NextPageLoader4ProductList.TAG, "handleSecondDataStruc() --->showError");
                        NextPageLoader4ProductList.this.showError();
                        return;
                    }
                    NextPageLoader4ProductList.this.showEmpty(true);
                }
            }
            ...
            public void run() {
                ...
                if (OKLog.D) {
                    OKLog.d(NextPageLoader4ProductList.TAG, "onEnd -->> before handleReturn");
                }
                if (handleReturn(httpResponse)) {
                    if (OKLog.D) {
                        OKLog.d(NextPageLoader4ProductList.TAG, "onEnd -->> after handleReturn");
                    }
                    try {
                        num = (Integer) httpResponse.getMoreParams().get(NextPageLoader4ProductList.this.pageNumParamKey);
                    } catch (Exception e2) {
                        if (OKLog.E) {
                            OKLog.e(NextPageLoader4ProductList.TAG, e2);
                        }
                    }
                    synchronized (NextPageLoader4ProductList.this.loadedMap) {
                        if (NextPageLoader4ProductList.this.TRUE == NextPageLoader4ProductList.this.loadedMap.get(num)) {
                            return;
                        }
                        NextPageLoader4ProductList.this.loadedMap.put(num, NextPageLoader4ProductList.this.TRUE);
                        ArrayList<?> list = NextPageLoader4ProductList.this.toList(httpResponse);
                        handleSecondDataStruc(httpResponse);
                        ArrayList<Object> arrayList = NextPageLoader4ProductList.this.showItemList;
                        if ((arrayList != null && arrayList.size() > 0) || (list != null && list.size() > 0)) {
                            NextPageLoader4ProductList.this.showEmpty(false);
                            if (list != null) {
                                if (NextPageLoader4ProductList.this.nextItemList != null && NextPageLoader4ProductList.this.nextItemList.size() > 0 && NextPageLoader4ProductList.this.showItemList.size() / NextPageLoader4ProductList.this.pageSize.intValue() < NextPageLoader4ProductList.this.pageNum.intValue()) {
                                    NextPageLoader4ProductList nextPageLoader4ProductList = NextPageLoader4ProductList.this;
                                    nextPageLoader4ProductList.showItemList.addAll(nextPageLoader4ProductList.nextItemList);
                                }
                                NextPageLoader4ProductList.this.nextItemList = list;
                                if (!NextPageLoader4ProductList.this.isSencondDataStrucUsed()) {
                                    if (NextPageLoader4ProductList.this.loadedShow()) {
                                        NextPageLoader4ProductList.this.showNextPage(list);
                                        return;
                                    }
                                    return;
                                }
                                NextPageLoader4ProductList.this.showItemList.addAll(list);
                                return;
                            }
                            OKLog.i(NextPageLoader4ProductList.TAG, "onEnd--->showError");
                            NextPageLoader4ProductList.this.showError();
                            return;
                        }
                        NextPageLoader4ProductList.this.showEmpty(true);
    ...
    public NextPageLoader4ProductList(IMyActivity iMyActivity, HttpGroup httpGroup, AdapterView adapterView, View view, String str, JSONObject jSONObject) {
