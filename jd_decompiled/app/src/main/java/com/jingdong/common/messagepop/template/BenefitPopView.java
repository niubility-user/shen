...
public class BenefitPopView implements IPopView {
    ...
    public View initPopView(Context context, MessagePopModel messagePopModel, View.OnClickListener onClickListener) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.message_pop_item_benefit, (ViewGroup) null);
        ...
        if (!TextUtils.isEmpty(messagePopModel.channelTitle)) {
            ...
            textView.setText(Html.fromHtml(messagePopModel.channelTitle));
        ...
        if (!TextUtils.isEmpty(messagePopModel.btnText)) {
            TextView textView2 = (TextView) inflate.findViewById(R.id.benefit_btntext);
        ...
        if (!TextUtils.isEmpty(messagePopModel.benefit)) {
            ...
            textView3.setText(messagePopModel.benefit);
            textView3.setTextColor(Color.parseColor(DeepDarkChangeManager.getInstance().getUIMode() == 0 ? JDDarkUtil.COLOR_F2270C : "#ff3826"));
        }
        return inflate;
    }
}
