...
public abstract class NextPageLoader4SearchShopList implements HttpGroup.OnAllListener, IDestroyListener {
    ...
    private class BaseListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            NextPageLoader4SearchShopList.this.onScroll(absListView, i2, i3, i4);
        }

        @Override // android.widget.AbsListView.OnScrollListener
        public void onScrollStateChanged(AbsListView absListView, int i2) {
            NextPageLoader4SearchShopList.this.onScrollStateChanged(absListView, i2);
        }
    }
    ...
    public class GalleryListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> adapterView, View view, int i2, long j2) {
            if (NextPageLoader4SearchShopList.this.showItemList.size() - 1 != i2 || NextPageLoader4SearchShopList.this.isFinishing || NextPageLoader4SearchShopList.this.isLoadedLastPage()) {
                return;
            }
            NextPageLoader4SearchShopList.this.tryShowNextPage();
        }
    ...
    public abstract class OnScrollLastListener extends BaseListener {
        ...
        @Override // com.jingdong.common.utils.NextPageLoader4SearchShopList.BaseListener, android.widget.AbsListView.OnScrollListener
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            this.firstVisibleItem = i2;
            this.visibleItemCount = i3;
            this.totalItemCount = i4;
            NextPageLoader4SearchShopList.this.setSelection(i2);
            NextPageLoader4SearchShopList.this.mCurrPos = (i3 / 2) + i2;
            if (absListView.getAdapter() != null && ((ListAdapter) absListView.getAdapter()).getCount() > 0) {
                View childAt = absListView.getChildAt(0);
                NextPageLoader4SearchShopList.this.onFirstVisible(absListView.getFirstVisiblePosition(), childAt == null ? 0 : childAt.getLeft(), childAt == null ? 0 : childAt.getTop(), childAt == null ? 0 : childAt.getRight(), childAt == null ? 0 : childAt.getBottom());
            }
    ...
    public NextPageLoader4SearchShopList(IMyActivity iMyActivity, HttpGroup httpGroup, AdapterView adapterView, View view, String str) {
    ...
    private void doAdapter() {
        ...
        this.onScrollLastListener = new OnScrollLastListener() { // from class: com.jingdong.common.utils.NextPageLoader4SearchShopList.3
            @Override // com.jingdong.common.utils.NextPageLoader4SearchShopList.OnScrollLastListener
            public void onScrollFling() {
                NextPageLoader4SearchShopList.this.isFling = true;
            }

            @Override // com.jingdong.common.utils.NextPageLoader4SearchShopList.OnScrollLastListener
            public void onScrollIdle() {
                NextPageLoader4SearchShopList.this.isHolding = false;
                NextPageLoader4SearchShopList.this.isFling = false;
                if (NextPageLoader4SearchShopList.this.isFinishing) {
                    return;
                }
                if (NextPageLoader4SearchShopList.this.hasNotify) {
                    NextPageLoader4SearchShopList.this.hasNotify = false;
                    if (NextPageLoader4SearchShopList.this.isSencondDataStrucUsed()) {
                        if (NextPageLoader4SearchShopList.this.secondAdapter != null) {
                            NextPageLoader4SearchShopList.this.secondAdapter.notifyDataSetChanged();
                        }
                    } else if (NextPageLoader4SearchShopList.this.adapter != null) {
                        NextPageLoader4SearchShopList.this.adapter.notifyDataSetChanged();
                    }
                }
                checkLast();
            }
            ...
            public void onScrollLast() {
                if (NextPageLoader4SearchShopList.this.isFinishing || NextPageLoader4SearchShopList.this.isLoadedLastPage()) {
                    return;
                }
                NextPageLoader4SearchShopList.this.tryShowNextPage();
            }
            ...
            public void onScrollStart() {
                if (NextPageLoader4SearchShopList.this.isLoadedLastPage() || NextPageLoader4SearchShopList.this.isWifi || NextPageLoader4SearchShopList.this.hasLoadFirstData) {
                    return;
                }
                NextPageLoader4SearchShopList.this.hasLoadFirstData = true;
                NextPageLoader4SearchShopList.this.tryShowNextPage();
            }
        };
        this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.utils.NextPageLoader4SearchShopList.4
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction();
                if (action != 0) {
                    if (action == 1 && !NextPageLoader4SearchShopList.this.isFling) {
                        NextPageLoader4SearchShopList.this.onScrollLastListener.onScrollIdle();
                        return false;
                    }
                    return false;
                }
                NextPageLoader4SearchShopList.this.isHolding = true;
                return false;
            }
        });
        ...
        if (adapterView instanceof ListView) {
            ...
            this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.utils.NextPageLoader4SearchShopList.5
                @Override // android.view.View.OnTouchListener
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    return false;
                }
    ...
    private void setLoading(final boolean z) {
        ...
        if (iMyActivity != null) {
            iMyActivity.post(new Runnable() { // from class: com.jingdong.common.utils.NextPageLoader4SearchShopList.1
                @Override // java.lang.Runnable
                public void run() {
                    if (!z) {
                        NextPageLoader4SearchShopList.this.showLoadingView(false);
                        return;
                    }
                    ArrayList<Object> arrayList = NextPageLoader4SearchShopList.this.showItemList;
                    if (arrayList == null || arrayList.size() <= 0) {
                        return;
                    }
                    NextPageLoader4SearchShopList.this.showLoadingView(true);
                }
            });
        }
    }
    ...
    public void showNextPage(ArrayList<?> arrayList) {
        ...
        tryDoAdapter();
        this.handler.postDelayed(new Runnable() { // from class: com.jingdong.common.utils.NextPageLoader4SearchShopList.2
            @Override // java.lang.Runnable
            public void run() {
                NextPageLoader4SearchShopList nextPageLoader4SearchShopList = NextPageLoader4SearchShopList.this;
                if (nextPageLoader4SearchShopList.adapterView == null || nextPageLoader4SearchShopList.showItemList.size() > NextPageLoader4SearchShopList.this.adapterView.getChildCount()) {
                    return;
                }
                NextPageLoader4SearchShopList.this.tryShowNextPage();
            }
    ...
    public void onEnd(final HttpResponse httpResponse) {
        ...
        this.handler.post(new Runnable() { // from class: com.jingdong.common.utils.NextPageLoader4SearchShopList.6
            private boolean handleReturn(HttpResponse httpResponse2) {
                Map<String, Object> moreParams = httpResponse2.getMoreParams();
                Map<String, Object> keyParmas = NextPageLoader4SearchShopList.this.getKeyParmas();
                ...
                for (String str : moreParams.keySet()) {
                    ...
                    if (OKLog.D) {
                        OKLog.d(NextPageLoader4SearchShopList.TAG, "handleReturn() -->> moreKey = " + str);
                        OKLog.d(NextPageLoader4SearchShopList.TAG, "handleReturn() -->> moreValue = " + obj);
                        OKLog.d(NextPageLoader4SearchShopList.TAG, "handleReturn() -->> currentValue = " + obj2);
                    }
            ...
            private void handleSecondDataStruc(HttpResponse httpResponse2) {
                if (NextPageLoader4SearchShopList.this.isUseSecondDataStrucFlag()) {
                    if (OKLog.D) {
                        OKLog.d(NextPageLoader4SearchShopList.TAG, "handleSecondDataStruc() -->> \u4f7f\u7528\u4e86\u7b2c\u4e8c\u79cd\u6570\u636e\u7ed3\u6784 ");
                    }
                    ArrayList<?> secondList = NextPageLoader4SearchShopList.this.toSecondList(httpResponse2);
                    ArrayList<Object> arrayList = NextPageLoader4SearchShopList.this.secondDataStrucShowItemList;
                    if ((arrayList != null && arrayList.size() > 0) || (secondList != null && secondList.size() > 0)) {
                        NextPageLoader4SearchShopList.this.showEmpty(false);
                        if (secondList != null && secondList.size() >= 1) {
                            if (secondList.size() > 0) {
                                if (OKLog.D) {
                                    OKLog.d(NextPageLoader4SearchShopList.TAG, "handleSecondDataStruc() -->> \u4f7f\u7528\u4e86\u7b2c\u4e8c\u79cd\u6570\u636e\u7ed3\u6784\uff0c\u4e14\u8fd8\u4e0d\u4e3a\u7a7a\u54e6");
                                }
                                if (NextPageLoader4SearchShopList.this.secondNextItemList != null && NextPageLoader4SearchShopList.this.secondNextItemList.size() > 0 && (NextPageLoader4SearchShopList.this.secondDataStrucShowItemList.size() * 2) / NextPageLoader4SearchShopList.this.pageSize.intValue() < NextPageLoader4SearchShopList.this.pageNum.intValue()) {
                                    NextPageLoader4SearchShopList nextPageLoader4SearchShopList = NextPageLoader4SearchShopList.this;
                                    nextPageLoader4SearchShopList.secondDataStrucShowItemList.addAll(nextPageLoader4SearchShopList.secondNextItemList);
                                }
                                NextPageLoader4SearchShopList.this.secondNextItemList = secondList;
                                if (NextPageLoader4SearchShopList.this.isSencondDataStrucUsed()) {
                                    if (NextPageLoader4SearchShopList.this.loadedShow()) {
                                        if (OKLog.D) {
                                            OKLog.d(NextPageLoader4SearchShopList.TAG, "handleSecondDataStruc()  -->> show now -->> ");
                                        }
                                        NextPageLoader4SearchShopList.this.showNextPage(secondList);
                                        return;
                                    }
                                    return;
                                }
                                NextPageLoader4SearchShopList.this.secondDataStrucShowItemList.addAll(secondList);
                                return;
                            }
                            return;
                        }
                        OKLog.i(NextPageLoader4SearchShopList.TAG, "handleSecondDataStruc() --->showError");
                        NextPageLoader4SearchShopList.this.showError();
                        return;
                    }
                    NextPageLoader4SearchShopList.this.showEmpty(true);
                }
            }
            ...
            public void run() {
                ...
                if (OKLog.D) {
                    OKLog.d(NextPageLoader4SearchShopList.TAG, "onEnd -->> before handleReturn");
                }
                if (handleReturn(httpResponse)) {
                    if (OKLog.D) {
                        OKLog.d(NextPageLoader4SearchShopList.TAG, "onEnd -->> after handleReturn");
                    }
                    try {
                        num = (Integer) httpResponse.getMoreParams().get(NextPageLoader4SearchShopList.this.pageNumParamKey);
                    } catch (Exception e2) {
                        if (OKLog.E) {
                            OKLog.e(NextPageLoader4SearchShopList.TAG, e2);
                        }
                    }
                    synchronized (NextPageLoader4SearchShopList.this.loadedMap) {
                        if (NextPageLoader4SearchShopList.this.TRUE == NextPageLoader4SearchShopList.this.loadedMap.get(num)) {
                            return;
                        }
                        NextPageLoader4SearchShopList.this.loadedMap.put(num, NextPageLoader4SearchShopList.this.TRUE);
                        ArrayList<?> list = NextPageLoader4SearchShopList.this.toList(httpResponse);
                        handleSecondDataStruc(httpResponse);
                        ArrayList<Object> arrayList = NextPageLoader4SearchShopList.this.showItemList;
                        if ((arrayList != null && arrayList.size() > 0) || (list != null && list.size() > 0)) {
                            NextPageLoader4SearchShopList.this.showEmpty(false);
                            if (list != null) {
                                if (NextPageLoader4SearchShopList.this.nextItemList != null && NextPageLoader4SearchShopList.this.nextItemList.size() > 0 && NextPageLoader4SearchShopList.this.showItemList.size() / NextPageLoader4SearchShopList.this.pageSize.intValue() < NextPageLoader4SearchShopList.this.pageNum.intValue()) {
                                    NextPageLoader4SearchShopList nextPageLoader4SearchShopList = NextPageLoader4SearchShopList.this;
                                    nextPageLoader4SearchShopList.showItemList.addAll(nextPageLoader4SearchShopList.nextItemList);
                                }
                                NextPageLoader4SearchShopList.this.nextItemList = list;
                                if (!NextPageLoader4SearchShopList.this.isSencondDataStrucUsed()) {
                                    if (NextPageLoader4SearchShopList.this.loadedShow()) {
                                        NextPageLoader4SearchShopList.this.showNextPage(list);
                                        return;
                                    }
                                    return;
                                }
                                NextPageLoader4SearchShopList.this.showItemList.addAll(list);
                                return;
                            }
                            OKLog.i(NextPageLoader4SearchShopList.TAG, "onEnd--->showError");
                            NextPageLoader4SearchShopList.this.showError();
                            return;
                        }
                        NextPageLoader4SearchShopList.this.showEmpty(true);
    ...
    public NextPageLoader4SearchShopList(IMyActivity iMyActivity, HttpGroup httpGroup, AdapterView adapterView, View view, String str, JSONObject jSONObject) {
