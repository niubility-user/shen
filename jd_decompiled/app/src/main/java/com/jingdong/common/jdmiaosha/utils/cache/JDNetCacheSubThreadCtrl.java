...
public class JDNetCacheSubThreadCtrl {
    ...
    static {
        ThreadFactory threadFactory = new ThreadFactory() { // from class: com.jingdong.common.jdmiaosha.utils.cache.JDNetCacheSubThreadCtrl.1
            @Override // java.util.concurrent.ThreadFactory
            public Thread newThread(Runnable runnable) {
                return new Thread(runnable, "MIAOSHA_NORMAL");
            }
        };
        ...
        ThreadFactory threadFactory2 = new ThreadFactory() { // from class: com.jingdong.common.jdmiaosha.utils.cache.JDNetCacheSubThreadCtrl.2
            @Override // java.util.concurrent.ThreadFactory
            public Thread newThread(Runnable runnable) {
                return new Thread(runnable, "MIAOSHA_LONG");
            }
        };
