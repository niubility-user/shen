...
public abstract class LocationAddressNextPageLoader implements HttpGroup.OnAllListener, IDestroyListener {
    ...
    */
    public void showNextPage(java.util.ArrayList<?> r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jingdong.common.lbs.gis.LocationAddressNextPageLoader.showNextPage(java.util.ArrayList):void");
    }
