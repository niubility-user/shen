...
public final class PersonalAsyncInflateManager {
    ...
    */
    public final void handleFontSize(android.content.Context r6) {
        /*
            r5 = this;
        ...
        L7:
            ...
            if (r0 == 0) goto L62
            if (r6 == 0) goto L1c
            android.content.res.Resources r1 = r6.getResources()     // Catch: java.lang.Throwable -> L1a
            if (r1 == 0) goto L1c
            android.content.res.Configuration r1 = r1.getConfiguration()     // Catch: java.lang.Throwable -> L1a
            goto L1d
        L1a:
            r6 = move-exception
            goto L57
        ...
        L1d:
            if (r1 == 0) goto L22
            float r2 = r1.fontScale     // Catch: java.lang.Throwable -> L1a
            goto L23
        L22:
            r2 = 0
        L23:
            ...
            r5.printLog(r3)     // Catch: java.lang.Throwable -> L1a
            r3 = 1
            float r3 = (float) r3     // Catch: java.lang.Throwable -> L1a
            int r2 = (r2 > r3 ? 1 : (r2 == r3 ? 0 : -1))
            if (r2 <= 0) goto L62
            java.lang.String r2 = "\u5f02\u6b65\u52a0\u8f7d\u5e03\u5c40 \u91cd\u7f6e\u5b57\u53f7\uff081\uff09"
            r5.printLog(r2)     // Catch: java.lang.Throwable -> L1a
            if (r1 == 0) goto L46
            r1.fontScale = r3     // Catch: java.lang.Throwable -> L1a
        L46:
            if (r6 == 0) goto L51
            android.content.res.Resources r6 = r6.getResources()     // Catch: java.lang.Throwable -> L1a
            if (r6 == 0) goto L51
            r6.updateConfiguration(r1, r0)     // Catch: java.lang.Throwable -> L1a
        L51:
            java.lang.String r6 = "\u5f02\u6b65\u52a0\u8f7d\u5e03\u5c40 \u91cd\u7f6e\u5b57\u53f7\uff082\uff09"
            r5.printLog(r6)     // Catch: java.lang.Throwable -> L1a
            goto L62
        L57:
