...
public abstract class LifecycleRecyclerBaseViewHolder<VM extends BaseViewModel, N extends BaseNavigator> extends RecyclerView.ViewHolder implements EventListener, UnProguard {
    ...
    public LifecycleRecyclerBaseViewHolder(Context context, View view, String str) {
        super(view);
        this.mViewModel = null;
        this.isDestroy = false;
        this.mViewModelKey = null;
    ...
    public <T extends BaseViewModel> T getViewModel(Class<T> cls) {
        if (getFragment() == null) {
            ...
            throw new IllegalArgumentException("mContext must be instanseof FragmentActivity!");
        }
