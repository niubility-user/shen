...
public class PdRuleItemEntity implements Parcelable {
    public static final Parcelable.Creator<PdRuleItemEntity> CREATOR = new Parcelable.Creator<PdRuleItemEntity>() { // from class: com.jingdong.app.mall.bundle.styleinfoview.entitys.giftshopping.PdRuleItemEntity.1
