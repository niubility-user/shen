...
public class JDRoundedBitmapDisplayer implements JDBitmapDisplayer {
    ...
    */
    public JDRoundedBitmapDisplayer(int r1) {
        /*
            r0 = this;
            float r1 = (float) r1
            r0.<init>(r1, r1, r1, r1)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jingdong.app.util.image.display.JDRoundedBitmapDisplayer.<init>(int):void");
    }
