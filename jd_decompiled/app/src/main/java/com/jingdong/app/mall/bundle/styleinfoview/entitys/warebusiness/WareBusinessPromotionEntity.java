...
public class WareBusinessPromotionEntity {
    ...
    public void dealData() {
        ...
        Collections.sort(this.activity, new Comparator<WareBusinessPromotionGiftEntity>() { // from class: com.jingdong.app.mall.bundle.styleinfoview.entitys.warebusiness.WareBusinessPromotionEntity.1
