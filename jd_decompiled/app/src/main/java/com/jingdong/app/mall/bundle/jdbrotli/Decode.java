...
public class Decode {
    ...
    */
    public static void decompress(com.jingdong.app.mall.bundle.jdbrotli.State r18) {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static void readHuffmanCodeLengths(int[] r11, int r12, int[] r13, com.jingdong.app.mall.bundle.jdbrotli.State r14) {
        /*
            r0 = 33
            int[] r0 = new int[r0]
            r1 = 32
            r2 = 5
            r3 = 18
            com.jingdong.app.mall.bundle.jdbrotli.Huffman.buildHuffmanTable(r0, r1, r2, r11, r3)
        ...
        L18:
            if (r3 >= r12) goto L85
            if (r4 <= 0) goto L85
            com.jingdong.app.mall.bundle.jdbrotli.BitReader.readMoreInput(r14)
            com.jingdong.app.mall.bundle.jdbrotli.BitReader.fillBitWindow(r14)
            int r7 = com.jingdong.app.mall.bundle.jdbrotli.BitReader.peekBits(r14)
            r7 = r7 & 31
        ...
        L5a:
            com.jingdong.app.mall.bundle.jdbrotli.BitReader.fillBitWindow(r14)
            int r8 = com.jingdong.app.mall.bundle.jdbrotli.BitReader.readFewBits(r14, r8)
            int r8 = r8 + 3
            int r7 = r7 + r8
            int r6 = r7 - r6
            int r8 = r3 + r6
        ...
        L7b:
            ...
            goto L18
        L7d:
            com.jingdong.app.mall.bundle.jdbrotli.BrotliRuntimeException r11 = new com.jingdong.app.mall.bundle.jdbrotli.BrotliRuntimeException
