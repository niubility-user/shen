...
public class PDAuthCodeDialog {
    ...
    /* renamed from: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog$6  reason: invalid class name */
    /* loaded from: classes3.dex */
        ...
        public void onEnd(HttpResponse httpResponse) {
            ...
            if (parseBitmapFromResponse != null) {
                if (PDAuthCodeDialog.this.mContext != null) {
                    PDAuthCodeDialog.this.mContext.post(new Runnable() { // from class: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.6.1
                        @Override // java.lang.Runnable
                        public void run() {
                            if (PDAuthCodeDialog.this.mContext != null) {
                                PDAuthCodeDialog.this.setAuthCodeDialog(parseBitmapFromResponse, new AuthCodeDialogListener() { // from class: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.6.1.1
                                    @Override // com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.AuthCodeDialogListener
    ...
    public void checkAuthCode(String str, String str2) {
        ...
        httpSetting.setListener(new HttpGroup.OnCommonListener() { // from class: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.7
            @Override // com.jingdong.jdsdk.network.toolbox.HttpGroup.OnEndListener
            public void onEnd(HttpResponse httpResponse) {
                if (PDAuthCodeDialog.this.isDestroy) {
                    return;
    ...
    public void clearInput() {
        ...
        if (iMyActivity != null) {
            iMyActivity.post(new Runnable() { // from class: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.4
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void setAuthCodeDialog(Bitmap bitmap, final AuthCodeDialogListener authCodeDialogListener) {
        if (this.authCodeDialog == null) {
            this.authCodeDialog = JDDialogFactory.getInstance().createJdDialogWithStyle3(this.mContext.getThisActivity(), this.mContext.getThisActivity().getResources().getString(R.string.libpdstyleinfoview_lib_pd_authcode_title), this.mContext.getThisActivity().getResources().getString(R.string.libpdstyleinfoview_lib_pd_authcode_input_desc), "", this.mContext.getThisActivity().getResources().getString(R.string.libpdstyleinfoview_cancel), this.mContext.getThisActivity().getResources().getString(R.string.libpdstyleinfoview_ok));
        }
        ImageView imageView = this.authCodeDialog.imageView;
        if (imageView != null) {
            imageView.setImageBitmap(bitmap);
            this.authCodeDialog.imageView.setOnClickListener(new View.OnClickListener() { // from class: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.1
        ...
        this.authCodeDialog.setOnLeftButtonClickListener(new View.OnClickListener() { // from class: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.authCodeDialog.setOnRightButtonClickListener(new View.OnClickListener() { // from class: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public void getAuthCodeSession() {
        ...
        httpSetting.setNotifyUser(true);
        httpSetting.setUseFastJsonParser(true);
        httpSetting.setListener(new HttpGroup.OnCommonListener() { // from class: com.jingdong.app.mall.bundle.styleinfoview.views.PDAuthCodeDialog.5
            @Override // com.jingdong.jdsdk.network.toolbox.HttpGroup.OnEndListener
            public void onEnd(HttpResponse httpResponse) {
