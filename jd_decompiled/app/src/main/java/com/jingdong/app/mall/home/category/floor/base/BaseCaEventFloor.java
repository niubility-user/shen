...
public abstract class BaseCaEventFloor<M extends com.jingdong.app.mall.home.n.g.u.c> extends BaseCaFloor<M> {
    ...
    */
    public void k(@org.jetbrains.annotations.Nullable android.util.Pair<java.lang.Integer, java.lang.Integer> r3) {
        /*
            r2 = this;
            boolean r0 = r2.N()
            if (r0 == 0) goto L5f
            boolean r0 = com.jingdong.app.mall.home.o.a.f.M0()
            if (r0 == 0) goto L5f
            r2.mClipPair = r3
            r0 = 0
            if (r3 == 0) goto L40
        ...
        L16:
            ...
            int r3 = r3.intValue()
            int r3 = kotlin.jvm.internal.Intrinsics.compare(r3, r0)
            if (r3 > 0) goto L39
        ...
        L39:
            ...
            r0 = 1
        L40:
            android.view.ViewOutlineProvider r3 = r2.mClipProvider
            if (r3 != 0) goto L4d
            if (r0 == 0) goto L4d
            com.jingdong.app.mall.home.category.floor.base.BaseCaEventFloor$b r3 = new com.jingdong.app.mall.home.category.floor.base.BaseCaEventFloor$b
            r3.<init>()
            r2.mClipProvider = r3
        L4d:
        ...
        L5f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jingdong.app.mall.home.category.floor.base.BaseCaEventFloor.k(android.util.Pair):void");
    }
