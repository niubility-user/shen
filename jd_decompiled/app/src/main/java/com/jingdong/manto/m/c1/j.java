...
public class j extends d0 {
    ...
    public final void exec(com.jingdong.manto.h hVar, JSONObject jSONObject, int i2, String str) {
        ...
        if (TextUtils.isEmpty(optString)) {
            ...
            hVar.a(i2, putErrMsg("fail:uploadTaskId is null or nil", null, str));
            return;
        }
        ...
        if (TextUtils.isEmpty(optString2)) {
            ...
            com.jingdong.manto.p.h.c a = com.jingdong.manto.p.h.a.b().a(hVar.c());
            if (a == null) {
                MantoLog.i("operateUploadTask", "upload is null");
                hVar.a(i2, putErrMsg("fail:no task", null, str));
                return;
            }
            com.jingdong.manto.p.h.b a2 = a.a(optString);
            if (a2 == null) {
            ...
            com.jingdong.manto.m.d a3 = new f.b().a(hVar);
