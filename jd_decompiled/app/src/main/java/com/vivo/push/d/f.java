...
final class f extends com.vivo.push.l {
    ...
    public static boolean a(Context context) {
        ...
        List<ResolveInfo> queryIntentServices = context.getPackageManager().queryIntentServices(intent, R2.attr.checked_is_bold);
    ...
    private static List<ResolveInfo> c(Context context) {
        ...
        if (list == null || list.size() <= 0) {
            ...
            try {
                return context.getPackageManager().queryBroadcastReceivers(intent2, R2.attr.checked_is_bold);
    ...
    protected final void a(com.vivo.push.o oVar) {
        ...
        int d = jVar.d();
        int e2 = jVar.e();
        com.vivo.push.util.p.d("OnChangePushStatusTask", "OnChangePushStatusTask serviceStatus is " + d + " ; receiverStatus is " + e2);
        if (d == 2) {
            b(this.a);
        } else if (d == 1) {
            a(this.a);
