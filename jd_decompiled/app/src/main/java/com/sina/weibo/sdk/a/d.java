...
public final class d extends c<Void, Void, String> {
    ...
    public String l() {
        try {
            ...
            e.a aVar = new e.a();
            aVar.f16084i = "https://service.weibo.com/share/mobilesdk_uppic.php";
            return new com.sina.weibo.sdk.net.b().a(aVar.a("oauth_timestamp", valueOf).a("oauth_sign", d(valueOf)).b(PairKey.APP_KEY, this.ad).b("oauth_timestamp", valueOf).b("oauth_sign", d(valueOf)).b("img", this.ac).e()).f();
        } catch (Throwable th) {
            th.printStackTrace();
            this.ab = th;
            return null;
