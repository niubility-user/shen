...
public class SecurityFunctionalVerifyCodeBindingImpl extends SecurityFunctionalVerifyCodeBinding {
    @Nullable
    ...
    static {
        ...
        sparseIntArray.put(R.id.verifyCodeEditText, 4);
    }

    public SecurityFunctionalVerifyCodeBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    private SecurityFunctionalVerifyCodeBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[3], (LinearLayout) objArr[0], (TextView) objArr[1], (VerifyCodeEditText) objArr[4]);
        this.mDirtyFlags = -1L;
