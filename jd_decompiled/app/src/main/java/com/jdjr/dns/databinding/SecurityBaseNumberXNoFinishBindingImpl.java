...
public class SecurityBaseNumberXNoFinishBindingImpl extends SecurityBaseNumberXNoFinishBinding {
    @Nullable
    ...
    public SecurityBaseNumberXNoFinishBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    private SecurityBaseNumberXNoFinishBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
