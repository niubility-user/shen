...
public class SecurityTotalLetterKeyboardBindingImpl extends SecurityTotalLetterKeyboardBinding {
    ...
    protected void executeBindings() {
        ...
        if ((j2 & 1) != 0) {
            ImageButton imageButton = this.btnKeyCapslock;
            if (KeyboardUiMode.isDark()) {
                context = this.btnKeyCapslock.getContext();
                i2 = R.drawable.security_total_key_capslock_selector_dark;
            } else {
                context = this.btnKeyCapslock.getContext();
                i2 = R.drawable.security_total_key_capslock_selector;
            }
            ViewBindingAdapter.setBackground(imageButton, AppCompatResources.getDrawable(context, i2));
            ImageButton imageButton2 = this.btnKeyCapslock;
            if (KeyboardUiMode.isDark()) {
                context2 = this.btnKeyCapslock.getContext();
                i3 = R.drawable.security_total_key_capslock_src_selector_dark;
            } else {
                context2 = this.btnKeyCapslock.getContext();
                i3 = R.drawable.security_total_key_capslock_src_selector;
            }
            ImageViewBindingAdapter.setImageDrawable(imageButton2, AppCompatResources.getDrawable(context2, i3));
            Button button3 = this.btnLetter123;
            if (KeyboardUiMode.isDark()) {
            ...
            button3.setTextColor(ViewDataBinding.getColorFromResource(button, i4));
            Button button4 = this.btnLetter123;
            if (KeyboardUiMode.isDark()) {
                context3 = this.btnLetter123.getContext();
            ...
            ViewBindingAdapter.setBackground(button4, AppCompatResources.getDrawable(context3, i5));
            ImageButton imageButton3 = this.btnLetterDel;
            if (KeyboardUiMode.isDark()) {
                context4 = this.btnLetterDel.getContext();
            ...
            ViewBindingAdapter.setBackground(imageButton3, AppCompatResources.getDrawable(context4, i6));
            ImageButton imageButton4 = this.btnLetterDel;
            if (KeyboardUiMode.isDark()) {
                context5 = this.btnLetterDel.getContext();
                i7 = R.drawable.security_key_delete_icon_dark;
            } else {
                context5 = this.btnLetterDel.getContext();
                i7 = R.drawable.security_key_delete_icon;
            }
            ImageViewBindingAdapter.setImageDrawable(imageButton4, AppCompatResources.getDrawable(context5, i7));
            Button button5 = this.btnLetterSymbol;
            if (KeyboardUiMode.isDark()) {
                button2 = this.btnLetterSymbol;
                i8 = R.color.keyboard_color_total_btn_txt_dark;
            } else {
                button2 = this.btnLetterSymbol;
                i8 = R.color.keyboard_color_total_btn_txt;
            }
            button5.setTextColor(ViewDataBinding.getColorFromResource(button2, i8));
            Button button6 = this.btnLetterSymbol;
            if (KeyboardUiMode.isDark()) {
                context6 = this.btnLetterSymbol.getContext();
                i9 = R.drawable.security_total_function_key_gray_bg_selector_dark;
            } else {
                context6 = this.btnLetterSymbol.getContext();
                i9 = R.drawable.security_total_function_key_gray_bg_selector;
            }
            ViewBindingAdapter.setBackground(button6, AppCompatResources.getDrawable(context6, i9));
            ...
            if (KeyboardUiMode.isDark()) {
                context7 = this.mboundView1.getContext();
                i11 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context7 = this.mboundView1.getContext();
                i11 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView, AppCompatResources.getDrawable(context7, i11));
            TotalKeyView totalKeyView2 = this.mboundView10;
            if (KeyboardUiMode.isDark()) {
                context8 = this.mboundView10.getContext();
                i12 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context8 = this.mboundView10.getContext();
                i12 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView2, AppCompatResources.getDrawable(context8, i12));
            TotalKeyView totalKeyView3 = this.mboundView11;
            if (KeyboardUiMode.isDark()) {
                context9 = this.mboundView11.getContext();
                i13 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context9 = this.mboundView11.getContext();
                i13 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView3, AppCompatResources.getDrawable(context9, i13));
            TotalKeyView totalKeyView4 = this.mboundView12;
            if (KeyboardUiMode.isDark()) {
                context10 = this.mboundView12.getContext();
                i14 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context10 = this.mboundView12.getContext();
                i14 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView4, AppCompatResources.getDrawable(context10, i14));
            TotalKeyView totalKeyView5 = this.mboundView13;
            if (KeyboardUiMode.isDark()) {
                context11 = this.mboundView13.getContext();
                i15 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context11 = this.mboundView13.getContext();
                i15 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView5, AppCompatResources.getDrawable(context11, i15));
            TotalKeyView totalKeyView6 = this.mboundView14;
            if (KeyboardUiMode.isDark()) {
                context12 = this.mboundView14.getContext();
                i16 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context12 = this.mboundView14.getContext();
                i16 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView6, AppCompatResources.getDrawable(context12, i16));
            TotalKeyView totalKeyView7 = this.mboundView15;
            if (KeyboardUiMode.isDark()) {
                context13 = this.mboundView15.getContext();
                i17 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context13 = this.mboundView15.getContext();
                i17 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView7, AppCompatResources.getDrawable(context13, i17));
            TotalKeyView totalKeyView8 = this.mboundView16;
            if (KeyboardUiMode.isDark()) {
                context14 = this.mboundView16.getContext();
                i18 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context14 = this.mboundView16.getContext();
                i18 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView8, AppCompatResources.getDrawable(context14, i18));
            TotalKeyView totalKeyView9 = this.mboundView17;
            if (KeyboardUiMode.isDark()) {
                context15 = this.mboundView17.getContext();
                i19 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context15 = this.mboundView17.getContext();
                i19 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView9, AppCompatResources.getDrawable(context15, i19));
            TotalKeyView totalKeyView10 = this.mboundView18;
            if (KeyboardUiMode.isDark()) {
                context16 = this.mboundView18.getContext();
                i20 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context16 = this.mboundView18.getContext();
                i20 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView10, AppCompatResources.getDrawable(context16, i20));
            TotalKeyView totalKeyView11 = this.mboundView19;
            if (KeyboardUiMode.isDark()) {
                context17 = this.mboundView19.getContext();
                i21 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context17 = this.mboundView19.getContext();
                i21 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView11, AppCompatResources.getDrawable(context17, i21));
            TotalKeyView totalKeyView12 = this.mboundView2;
            if (KeyboardUiMode.isDark()) {
                context18 = this.mboundView2.getContext();
                i22 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context18 = this.mboundView2.getContext();
                i22 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView12, AppCompatResources.getDrawable(context18, i22));
            TotalKeyView totalKeyView13 = this.mboundView21;
            if (KeyboardUiMode.isDark()) {
                context19 = this.mboundView21.getContext();
                i23 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context19 = this.mboundView21.getContext();
                i23 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView13, AppCompatResources.getDrawable(context19, i23));
            TotalKeyView totalKeyView14 = this.mboundView22;
            if (KeyboardUiMode.isDark()) {
                context20 = this.mboundView22.getContext();
                i24 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context20 = this.mboundView22.getContext();
                i24 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView14, AppCompatResources.getDrawable(context20, i24));
            TotalKeyView totalKeyView15 = this.mboundView23;
            if (KeyboardUiMode.isDark()) {
                context21 = this.mboundView23.getContext();
                i25 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context21 = this.mboundView23.getContext();
                i25 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView15, AppCompatResources.getDrawable(context21, i25));
            TotalKeyView totalKeyView16 = this.mboundView24;
            if (KeyboardUiMode.isDark()) {
                context22 = this.mboundView24.getContext();
                i26 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context22 = this.mboundView24.getContext();
                i26 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView16, AppCompatResources.getDrawable(context22, i26));
            TotalKeyView totalKeyView17 = this.mboundView25;
            if (KeyboardUiMode.isDark()) {
                context23 = this.mboundView25.getContext();
                i27 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context23 = this.mboundView25.getContext();
                i27 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView17, AppCompatResources.getDrawable(context23, i27));
            TotalKeyView totalKeyView18 = this.mboundView26;
            if (KeyboardUiMode.isDark()) {
                context24 = this.mboundView26.getContext();
                i28 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context24 = this.mboundView26.getContext();
                i28 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView18, AppCompatResources.getDrawable(context24, i28));
            TotalKeyView totalKeyView19 = this.mboundView27;
            if (KeyboardUiMode.isDark()) {
                context25 = this.mboundView27.getContext();
                i29 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context25 = this.mboundView27.getContext();
                i29 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView19, AppCompatResources.getDrawable(context25, i29));
            TotalKeyView totalKeyView20 = this.mboundView3;
            if (KeyboardUiMode.isDark()) {
                context26 = this.mboundView3.getContext();
                i30 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context26 = this.mboundView3.getContext();
                i30 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView20, AppCompatResources.getDrawable(context26, i30));
            TotalKeyView totalKeyView21 = this.mboundView4;
            if (KeyboardUiMode.isDark()) {
                context27 = this.mboundView4.getContext();
                i31 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context27 = this.mboundView4.getContext();
                i31 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView21, AppCompatResources.getDrawable(context27, i31));
            TotalKeyView totalKeyView22 = this.mboundView5;
            if (KeyboardUiMode.isDark()) {
                context28 = this.mboundView5.getContext();
                i32 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context28 = this.mboundView5.getContext();
                i32 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView22, AppCompatResources.getDrawable(context28, i32));
            TotalKeyView totalKeyView23 = this.mboundView6;
            if (KeyboardUiMode.isDark()) {
                context29 = this.mboundView6.getContext();
                i33 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context29 = this.mboundView6.getContext();
                i33 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView23, AppCompatResources.getDrawable(context29, i33));
            TotalKeyView totalKeyView24 = this.mboundView7;
            if (KeyboardUiMode.isDark()) {
                context30 = this.mboundView7.getContext();
                i34 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context30 = this.mboundView7.getContext();
                i34 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView24, AppCompatResources.getDrawable(context30, i34));
            TotalKeyView totalKeyView25 = this.mboundView8;
            if (KeyboardUiMode.isDark()) {
                context31 = this.mboundView8.getContext();
                i35 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context31 = this.mboundView8.getContext();
                i35 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView25, AppCompatResources.getDrawable(context31, i35));
            TotalKeyView totalKeyView26 = this.mboundView9;
            if (KeyboardUiMode.isDark()) {
                context32 = this.mboundView9.getContext();
                i36 = R.drawable.security_total_key_bg_selector_dark;
            } else {
                context32 = this.mboundView9.getContext();
                i36 = R.drawable.security_total_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(totalKeyView26, AppCompatResources.getDrawable(context32, i36));
        }
    }
