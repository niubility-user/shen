...
public class OfflineService {
        ...
        */
        public void g() {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: com.jd.libs.hybrid.offlineload.loader.OfflineService.DownloadFileProcessor.g():void");
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private com.jd.libs.hybrid.offlineload.OfflineLoadController.ChangeEntityLists<com.jd.libs.hybrid.offlineload.entity.OfflineEntity> I(java.util.List<com.jd.libs.hybrid.offlineload.entity.OfflineEntity> r20, java.util.List<com.jd.libs.hybrid.offlineload.entity.OfflineEntity> r21, java.util.List<com.jd.libs.hybrid.offlineload.entity.OfflineEntity> r22) {
        /*
            Method dump skipped, instructions count: 702
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jd.libs.hybrid.offlineload.loader.OfflineService.I(java.util.List, java.util.List, java.util.List):com.jd.libs.hybrid.offlineload.OfflineLoadController$ChangeEntityLists");
    }
