...
public abstract class BaseRequest<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:36:0x002d A[RETURN, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:37:0x002f A[ORIG_RETURN, RETURN] */
    /*
    ...
    */
    private final boolean isAllowBody() {
        ...
        L30:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jd.jdcache.service.impl.net.BaseRequest.isAllowBody():boolean");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object notifyProgress(long r5, long r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r4 = this;
        ...
        L39:
            kotlin.ResultKt.throwOnFailure(r9)
            kotlinx.coroutines.flow.FlowCollector<? super com.jd.jdcache.service.base.NetState<T>> r9 = r4.flowCollector
            if (r9 == 0) goto L54
        ...
        L54:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jd.jdcache.service.impl.net.BaseRequest.notifyProgress(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
