...
public class FileRepo extends JDCacheFileRepoDelegate {
    ...
    /* JADX WARN: Removed duplicated region for block: B:36:0x0010  */
    /* JADX WARN: Removed duplicated region for block: B:38:0x0015  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String concretePath(java.lang.String r8) {
        /*
            r7 = this;
            r0 = 0
            r1 = 1
        ...
        Le:
            if (r2 == 0) goto L15
            java.lang.String r8 = r7.getRootDirPath()
            return r8
        L15:
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
            java.lang.String r3 = r7.getRootDirPath()
            r2.append(r3)
        ...
        L48:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jd.jdcache.service.impl.FileRepo.concretePath(java.lang.String):java.lang.String");
    }
        ...
        if (netDelegate != null) {
            ...
            if (connectFlow$default != null) {
                return new Flow<InputStreamState>() { // from class: com.jd.jdcache.service.impl.FileRepo$getInputStreamFromNetFlow$$inlined$map$1
                    ...
                    @Nullable
                    public Object collect(@NotNull final FlowCollector<? super InputStreamState> flowCollector, @NotNull Continuation continuation) {
        ...
        if (netDelegate != null) {
            ...
            if (downloadFlow != null) {
                return new Flow<FileState>() { // from class: com.jd.jdcache.service.impl.FileRepo$saveFileFromNetFlow$$inlined$map$1
                    @Override // kotlinx.coroutines.flow.Flow
                    @Nullable
                    public Object collect(@NotNull final FlowCollector<? super FileState> flowCollector, @NotNull Continuation continuation) {
                        Object coroutine_suspended;
