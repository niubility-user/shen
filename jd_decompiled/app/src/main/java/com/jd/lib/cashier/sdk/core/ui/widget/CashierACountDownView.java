...
public final class CashierACountDownView extends AbsCountdownView {
    ...
    public static final class b extends CountDownTimer {
        ...
        public void onFinish() {
            AbsCountdownView.a onCountdownListener = CashierACountDownView.this.getOnCountdownListener();
            if (onCountdownListener != null) {
                onCountdownListener.onFinish();
            }
            CashierACountDownView.this.n(null);
        }
        ...
        public void onTick(long j2) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                isShown = CashierACountDownView.this.isShown() && CashierACountDownView.this.isAttachedToWindow();
            } else {
                isShown = CashierACountDownView.this.isShown();
            }
            if (isShown) {
                CashierACountDownView.this.q(j2 / 1000);
            }
        }
    }

    public CashierACountDownView(@NotNull Context context) {
        super(context);
    }
    ...
    public AbsCountDownStatelessView c(@NotNull Context context) {
        return new CashierACountDownStatelessView(context);
    }
    ...
    public Triple<String, String, String> e(long duration) {
        a aVar = a.INSTANCE;
        long j2 = (long) R2.color.c_f2f3f3;
        long j3 = duration / j2;
        long j4 = 60;
        return new Triple<>(aVar.invoke((a) Long.valueOf(j3)), aVar.invoke((a) Long.valueOf((duration - (j2 * j3)) / j4)), aVar.invoke((a) Long.valueOf(duration % j4)));
    }

    @Override // com.jd.lib.cashier.sdk.core.ui.widget.AbsCountdownView
    public void j(long duration) {
        l(new b(duration, duration, 1000L));
    }

    public CashierACountDownView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public CashierACountDownView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i2) {
