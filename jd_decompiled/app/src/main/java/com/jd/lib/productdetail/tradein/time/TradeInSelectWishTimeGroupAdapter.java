...
public class TradeInSelectWishTimeGroupAdapter extends RecyclerView.Adapter<a> {
    ...
    public /* synthetic */ void l(TradeInSelectWishTimesResp.Data.PromiseDateItem promiseDateItem, View view) {
        Iterator<TradeInSelectWishTimesResp.Data.PromiseDateItem> it = this.a.iterator();
        while (it.hasNext()) {
    ...
    public void onBindViewHolder(@NonNull a aVar, int i2) {
        ...
        if (promiseDateItem.selected == 1) {
            aVar.a.setBackgroundResource(R.drawable.tradein_select_wish_time_group_item_bg);
        ...
        aVar.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.jd.lib.productdetail.tradein.time.h
            ...
            public final void onClick(View view) {
                TradeInSelectWishTimeGroupAdapter.this.l(promiseDateItem, view);
            }
        });
    }
