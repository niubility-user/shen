...
public class Wrap {
    ...
    public String getPrice(Context context) {
        return TextUtils.isEmpty(this.discountedPrice) ? context.getString(R.string.lib_pd_core_product_detail_comments) : context.getString(R.string.lib_pd_core_pg_home_jdpirce, this.discountedPrice);
    }
