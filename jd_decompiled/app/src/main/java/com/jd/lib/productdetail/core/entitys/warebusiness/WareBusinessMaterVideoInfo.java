...
public class WareBusinessMaterVideoInfo implements Parcelable {
    public static final Parcelable.Creator<WareBusinessMaterVideoInfo> CREATOR = new Parcelable.Creator<WareBusinessMaterVideoInfo>() { // from class: com.jd.lib.productdetail.core.entitys.warebusiness.WareBusinessMaterVideoInfo.1
