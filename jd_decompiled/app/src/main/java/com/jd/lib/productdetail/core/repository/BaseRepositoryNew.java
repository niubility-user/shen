...
public abstract class BaseRepositoryNew<T> {
    ...
    private class HttpGroupListener implements HttpGroup.OnAllListener {
        ...
        public void onEnd(HttpResponse httpResponse) {
            ...
            if (TextUtils.isEmpty(string)) {
                BaseRepositoryNew.this.reporter.reportHttpBusinessException(httpResponse);
                return;
            }
            BaseRepositoryNew baseRepositoryNew = BaseRepositoryNew.this;
            baseRepositoryNew.parseResponse(string, baseRepositoryNew.reporter);
        }

        @Override // com.jingdong.jdsdk.network.toolbox.HttpGroup.OnErrorListener
        public void onError(HttpError httpError) {
            BaseRepositoryNew.this.parseError(httpError);
        }
    ...
    public abstract LiveData<T> getRepository();
    ...
    public BaseRepositoryNew(String str) {
        this.mEventKey = str;
    }
}
