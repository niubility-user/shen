...
import com.jd.lib.productdetail.core.entitys.WareBusinessHwShareInfoAgreement;
import java.util.List;

/* loaded from: classes15.dex */
public class WareBusinessHwShareInfo implements Parcelable {
    public static final Parcelable.Creator<WareBusinessHwShareInfo> CREATOR = new Parcelable.Creator<WareBusinessHwShareInfo>() { // from class: com.jd.lib.productdetail.core.entitys.warebusiness.WareBusinessHwShareInfo.1
