    ...
    */
    public static boolean mateXEasyClientNew(android.content.Context r5) {
        /*
            ...
            r1 = 0
            com.jd.lib.un.utils.config.UnUtilsConfig r2 = com.jd.lib.un.utils.config.UnUtilsConfig.getInstance()     // Catch: java.lang.Exception -> L6e
            android.content.res.Configuration r2 = r2.getConfiguration(r5)     // Catch: java.lang.Exception -> L6e
            java.lang.String r2 = r2.toString()     // Catch: java.lang.Exception -> L6e
            boolean r3 = com.jd.lib.un.utils.UnLog.D     // Catch: java.lang.Exception -> L6e
            if (r3 == 0) goto L47
            ...
            com.jd.lib.un.utils.UnLog.d(r0, r3)     // Catch: java.lang.Exception -> L6e
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch: java.lang.Exception -> L6e
            r3.<init>()     // Catch: java.lang.Exception -> L6e
            ...
            com.jd.lib.un.utils.UnLog.d(r0, r5)     // Catch: java.lang.Exception -> L6e
        L47:
            ...
            boolean r5 = r2.contains(r5)     // Catch: java.lang.Exception -> L6e
            if (r5 != 0) goto L6b
            boolean r5 = com.jd.lib.un.utils.fold.FoldableUtils.isSplitScreenInOppo(r2)     // Catch: java.lang.Exception -> L6e
            if (r5 != 0) goto L6b
            boolean r5 = com.jd.lib.un.utils.fold.FoldableUtils.isSplitScreenInVivo(r2)     // Catch: java.lang.Exception -> L6e
            if (r5 == 0) goto L72
        L6b:
            r5 = 1
            r1 = 1
