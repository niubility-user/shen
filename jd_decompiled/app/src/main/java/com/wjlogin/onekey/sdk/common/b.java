...
public class b implements ResultListener {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public b(OneKeyLoginHelper oneKeyLoginHelper, OnResponseCallback onResponseCallback) {
    ...
    public void onResult(String str) {
        try {
            ...
            if (LogUtil.enableLog) {
                LogUtil.LogE("WJLogin.OneKey.OneKeyLoginHelper", "preGetMobileCU UnicomExp: " + e2);
            }
            this.b.a(this.a, com.wjlogin.onekey.sdk.util.a.a("-2", Constans.responseError, "CU"));
        }
    }
