...
public class SocialOperation extends BaseApi {
        ...
        if (TextUtils.isEmpty(a)) {
            ...
            DefaultUiListener defaultUiListener = new DefaultUiListener() { // from class: com.tencent.open.SocialOperation.3
                ...
                public void onComplete(Object obj) {
                    ...
                    } else if (((JSONObject) obj).optInt(IExceptionHandler.DynamicExceptionData.TYPE_BIND) != 1) {
                        try {
            ...
            HttpUtils.requestAsync(this.f16153c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", a2, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void joinGroup(final Activity activity, String str, final IUiListener iUiListener) {
        ...
        if (activity == null) {
            ...
            HttpUtils.requestAsync(this.f16153c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", a, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void makeFriend(Activity activity, Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            e.a().a(this.f16153c.getOpenId(), this.f16153c.getAppId(), Constants.VIA_MAKE_FRIEND, "14", "18", "1");
            return;
        }
        ...
        if (!m.f(activity, "5.1.0")) {
            ...
            try {
                ...
                e.a().a(this.f16153c.getOpenId(), this.f16153c.getAppId(), Constants.VIA_MAKE_FRIEND, "14", "18", "0");
            } catch (Exception e2) {
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        if (context == null) {
            ...
            a.putString("appid", appId);
            a.putString("orgid", str);
            HttpUtils.requestAsync(this.f16153c, context, "https://openmobile.qq.com/cgi-bin/qunopensdk/unbind", a, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    private void a(Activity activity, String str) {
        new TDialog(activity, "", a(str), null, this.f16153c).show();
    }
}
