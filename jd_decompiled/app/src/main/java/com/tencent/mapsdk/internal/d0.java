...
public class d0 implements be, c9, g8, k5, ne {
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x0039 A[Catch: Exception -> 0x0060, TryCatch #0 {Exception -> 0x0060, blocks: (B:25:0x0000, B:27:0x0014, B:28:0x0016, B:32:0x002b, B:34:0x0039, B:35:0x0041, B:37:0x004f, B:38:0x0057, B:29:0x001a, B:31:0x0028), top: B:43:0x0000 }] */
    /* JADX WARN: Removed duplicated region for block: B:37:0x004f A[Catch: Exception -> 0x0060, TryCatch #0 {Exception -> 0x0060, blocks: (B:25:0x0000, B:27:0x0014, B:28:0x0016, B:32:0x002b, B:34:0x0039, B:35:0x0041, B:37:0x004f, B:38:0x0057, B:29:0x001a, B:31:0x0028), top: B:43:0x0000 }] */
    /*
    ...
    */
    public void N() {
        /*
            r3 = this;
            java.util.Stack<com.tencent.mapsdk.internal.v> r0 = r3.v     // Catch: java.lang.Exception -> L60
            java.lang.Object r0 = r0.pop()     // Catch: java.lang.Exception -> L60
            com.tencent.mapsdk.internal.v r0 = (com.tencent.mapsdk.internal.v) r0     // Catch: java.lang.Exception -> L60
            int r1 = r0.q()     // Catch: java.lang.Exception -> L60
            com.tencent.mapsdk.internal.v r2 = r3.y     // Catch: java.lang.Exception -> L60
            int r2 = r2.q()     // Catch: java.lang.Exception -> L60
            if (r1 == r2) goto L1a
            com.tencent.mapsdk.internal.y5 r1 = com.tencent.mapsdk.internal.y5.SCALE_LEVEL_CHANGED     // Catch: java.lang.Exception -> L60
        L16:
            r3.a(r1)     // Catch: java.lang.Exception -> L60
            goto L2b
        L1a:
            float r1 = r0.p()     // Catch: java.lang.Exception -> L60
            com.tencent.mapsdk.internal.v r2 = r3.y     // Catch: java.lang.Exception -> L60
            float r2 = r2.p()     // Catch: java.lang.Exception -> L60
            int r1 = (r1 > r2 ? 1 : (r1 == r2 ? 0 : -1))
            if (r1 == 0) goto L2b
            com.tencent.mapsdk.internal.y5 r1 = com.tencent.mapsdk.internal.y5.SCALE_CHANGED     // Catch: java.lang.Exception -> L60
            goto L16
        L2b:
            float r1 = r0.m()     // Catch: java.lang.Exception -> L60
            com.tencent.mapsdk.internal.v r2 = r3.y     // Catch: java.lang.Exception -> L60
            float r2 = r2.m()     // Catch: java.lang.Exception -> L60
            int r1 = (r1 > r2 ? 1 : (r1 == r2 ? 0 : -1))
            if (r1 == 0) goto L41
            float r1 = r0.m()     // Catch: java.lang.Exception -> L60
            double r1 = (double) r1     // Catch: java.lang.Exception -> L60
            r3.h(r1)     // Catch: java.lang.Exception -> L60
        L41:
            float r1 = r0.s()     // Catch: java.lang.Exception -> L60
            com.tencent.mapsdk.internal.v r2 = r3.y     // Catch: java.lang.Exception -> L60
            float r2 = r2.s()     // Catch: java.lang.Exception -> L60
            int r1 = (r1 > r2 ? 1 : (r1 == r2 ? 0 : -1))
            if (r1 == 0) goto L57
            float r1 = r0.s()     // Catch: java.lang.Exception -> L60
            double r1 = (double) r1     // Catch: java.lang.Exception -> L60
            r3.i(r1)     // Catch: java.lang.Exception -> L60
        L57:
            com.tencent.mapsdk.internal.v r1 = r3.y     // Catch: java.lang.Exception -> L60
            r1.a(r0)     // Catch: java.lang.Exception -> L60
            r3.D()     // Catch: java.lang.Exception -> L60
            goto L64
        L60:
            r0 = move-exception
            r0.printStackTrace()
    ...
    */
    public void a(com.tencent.map.lib.models.GeoPoint r11, android.graphics.Rect r12) {
        /*
            r10 = this;
            com.tencent.mapsdk.internal.s4 r0 = r10.z
    ...
    */
    public void a(com.tencent.map.lib.models.GeoPoint r12, com.tencent.mapsdk.internal.i8 r13) {
        ...
        L15:
            ...
            r3 = 1
            if (r0 != 0) goto L8b
            com.tencent.mapsdk.internal.v r0 = r11.y
            com.tencent.map.lib.models.GeoPoint r0 = r0.a()
            com.tencent.mapsdk.internal.s4 r4 = r11.z
            com.tencent.mapsdk.internal.o5 r4 = r4.a(r0)
            com.tencent.mapsdk.internal.s4 r5 = r11.z
