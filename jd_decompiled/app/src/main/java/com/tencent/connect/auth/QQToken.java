...
public class QQToken {
    ...
    /* renamed from: g */
    private static SharedPreferences f16107g;
    private String a;
    private String b;
    ...
    /* renamed from: e */
    private long f16109e = -1;

    /* renamed from: f */
    private com.tencent.open.utils.a f16110f;
    ...
    private static synchronized SharedPreferences a() {
        ...
        synchronized (QQToken.class) {
            if (f16107g == null) {
                f16107g = g.a().getSharedPreferences("token_info_file", 0);
            }
            sharedPreferences = f16107g;
        }
    ...
    public boolean isSessionValid() {
        return this.b != null && System.currentTimeMillis() < this.f16109e;
    }

    public JSONObject loadSession(String str) {
        try {
            if (this.f16110f == null) {
                this.f16110f = new com.tencent.open.utils.a(g.a());
            }
            return a(str, this.f16110f);
        } catch (Exception e2) {
    ...
    public boolean saveSession(JSONObject jSONObject) {
        try {
            ...
            return a(this.a, jSONObject, this.f16110f);
        } catch (Exception e2) {
    ...
    public void setAccessToken(String str, String str2) throws NumberFormatException {
        ...
        this.f16109e = 0L;
        if (str2 != null) {
            this.f16109e = System.currentTimeMillis() + (Long.parseLong(str2) * 1000);
        }
    }
