...
public class PushManager {
    ...
    public static void checkNotificationMessage(Context context) {
        ...
        try {
            ...
            DebugLogger.e(TAG, "start check notification message service error " + e2.getMessage());
        }
    }

    public static void checkPush(Context context, String str, String str2, String str3) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).g(str, str2, context.getPackageName(), str3);
        } else {
    ...
    public static void checkSubScribeAlias(Context context, String str, String str2, String str3) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).m(str, str2, context.getPackageName(), str3);
        } else {
    ...
    public static void checkSubScribeTags(Context context, String str, String str2, String str3) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).o(str, str2, context.getPackageName(), str3);
        } else {
    ...
    public static void clearNotification(Context context) {
        com.meizu.cloud.pushsdk.platform.c.b.b(context).d(context.getPackageName());
    }

    public static void clearNotification(Context context, int... iArr) {
        com.meizu.cloud.pushsdk.platform.c.b.b(context).k(context.getPackageName(), iArr);
    }

    public static void enableCacheRequest(Context context, boolean z) {
        com.meizu.cloud.pushsdk.platform.c.b.b(context).c(z);
    }

    public static String getPushId(Context context) {
        int D = com.meizu.cloud.pushsdk.util.b.D(context, context.getPackageName());
        if (D == 0 || System.currentTimeMillis() / 1000 <= D) {
            return com.meizu.cloud.pushsdk.util.b.B(context, context.getPackageName());
        }
        return null;
    }
    ...
    public static void register(Context context) {
        ...
        try {
            ...
            DebugLogger.e(TAG, "start register service error " + e2.getMessage());
            return;
        }
    ...
    public static void register(Context context, String str, String str2) {
        DebugLogger.init(context);
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).f(str, str2, context.getPackageName());
        } else {
            DebugLogger.e(TAG, "please invoke register on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void subScribeAlias(Context context, String str, String str2, String str3, String str4) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).i(str, str2, context.getPackageName(), str3, str4);
        } else {
    ...
    public static void subScribeTags(Context context, String str, String str2, String str3, String str4) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).n(str, str2, context.getPackageName(), str3, str4);
        } else {
    ...
    public static void switchPush(Context context, String str, String str2, String str3, int i2, boolean z) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).h(str, str2, context.getPackageName(), str3, i2, z);
        } else {
    ...
    public static void switchPush(Context context, String str, String str2, String str3, boolean z) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).j(str, str2, context.getPackageName(), str3, z);
        } else {
            DebugLogger.e(TAG, "please invoke switchPush on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void unRegister(Context context) {
        ...
        try {
            ...
            DebugLogger.e(TAG, "start unRegister service error " + e2.getMessage());
            return;
        }
        intent.setClassName(str, PushConstants.MZ_PUSH_SERVICE_NAME);
        intent.putExtra("sender", context.getPackageName());
    ...
    public static void unRegister(Context context, String str, String str2) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).l(str, str2, context.getPackageName());
        } else {
            DebugLogger.e(TAG, "please invoke unRegister on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void unSubScribeAlias(Context context, String str, String str2, String str3, String str4) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).p(str, str2, context.getPackageName(), str3, str4);
        } else {
    ...
    public static void unSubScribeAllTags(Context context, String str, String str2, String str3) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).q(str, str2, context.getPackageName(), str3);
        } else {
    ...
    public static void unSubScribeTags(Context context, String str, String str2, String str3, String str4) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.b(context).r(str, str2, context.getPackageName(), str3, str4);
        } else {
