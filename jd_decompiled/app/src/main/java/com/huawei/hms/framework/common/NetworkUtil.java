...
public class NetworkUtil {
    ...
    private static int getHwNetworkType(Context context) {
        ...
        if (!ReflectionUtils.checkCompatible(EmuiUtil.BUILDEX_VERSION) || context == null || (telephonyManager = (TelephonyManager) ContextCompat.getSystemService(context, SignUpTable.TB_COLUMN_PHONE)) == null) {
            return 0;
        }
        try {
    ...
    public static String getMNC(Context context) {
        if (context != null && isSimReady(context)) {
            Object systemService = ContextCompat.getSystemService(context, SignUpTable.TB_COLUMN_PHONE);
        ...
        if (context != null) {
            ...
            if (systemService instanceof WifiManager) {
                try {
                    ...
                    return (connectionInfo == null || BaseInfo.getWifiBSSID() == null) ? INVALID_RSSI : connectionInfo.getRssi();
                } catch (RuntimeException e2) {
