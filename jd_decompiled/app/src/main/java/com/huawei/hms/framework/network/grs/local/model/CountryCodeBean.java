...
public class CountryCodeBean {
    ...
    private void getLocaleCountryCode() {
        String str;
        String str2;
        if (SystemPropUtils.getProperty(IMantoServerRequester.GET, KEY_VERSION_EMUI, ANDRIOD_SYSTEMPROP, "").isEmpty()) {
    ...
    private void getProductCountryCode() {
        int lastIndexOf;
        this.countryCode = SystemPropUtils.getProperty(IMantoServerRequester.GET, LOCALE_REGION_COUNTRYSYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
        String str = TAG;
        ...
        if (TextUtils.isEmpty(this.countryCode) || "UNKNOWN".equals(this.countryCode)) {
            String property = SystemPropUtils.getProperty(IMantoServerRequester.GET, LOCALE_COUNTRYSYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
    ...
    private void getVendorCountryCode() {
        ...
        this.countryCode = SystemPropUtils.getProperty(IMantoServerRequester.GET, VENDORCOUNTRY_SYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
        String str = TAG;
