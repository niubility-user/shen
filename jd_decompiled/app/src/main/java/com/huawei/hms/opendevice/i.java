...
public class i extends PushPreferences {
    ...
    /* renamed from: c */
    private static final String f1424c = "i";
    private Context b;
    ...
    public String b(String str) {
        try {
            ...
            HMSLog.e(f1424c, "getSecureData" + e2.getMessage());
            return "";
        }
    }
    ...
    public boolean c(String str) {
        try {
            ...
            HMSLog.e(f1424c, "removeToken" + e2.getMessage());
            return false;
        }
    }
    ...
    public boolean a(String str, String str2) {
        ...
        try {
            ...
            HMSLog.e(f1424c, "saveSecureData" + e2.getMessage());
            return false;
        }
    }
