...
public class YogaNode implements Cloneable {
    ...
    /* renamed from: com.facebook.yoga2.YogaNode$1  reason: invalid class name */
    /* loaded from: classes12.dex */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$facebook$yoga2$YogaEdge;

        static {
            int[] iArr = new int[YogaEdge.values().length];
            $SwitchMap$com$facebook$yoga2$YogaEdge = iArr;
            try {
                iArr[YogaEdge.LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$facebook$yoga2$YogaEdge[YogaEdge.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$facebook$yoga2$YogaEdge[YogaEdge.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$facebook$yoga2$YogaEdge[YogaEdge.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$facebook$yoga2$YogaEdge[YogaEdge.START.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$com$facebook$yoga2$YogaEdge[YogaEdge.END.ordinal()] = 6;
    ...
    private native void jni_YGNodeClearChildren(long j2);
    ...
    private native void jni_YGNodeInsertSharedChild(long j2, long j3, int i2);
    ...
    private native void jni_YGNodeSetOwner(long j2, long j3);
    ...
    public void addSharedChildAt(YogaNode yogaNode, int i2) {
        if (this.mChildren == null) {
            this.mChildren = new ArrayList(4);
        }
        this.mChildren.add(i2, yogaNode);
        yogaNode.mOwner = null;
        jni_YGNodeInsertSharedChild(this.mNativePointer, yogaNode.mNativePointer, i2);
    }
    ...
    public float getLayoutBorder(YogaEdge yogaEdge) {
        switch (AnonymousClass1.$SwitchMap$com$facebook$yoga2$YogaEdge[yogaEdge.ordinal()]) {
            case 1:
        ...
        try {
            ...
            if (list != null) {
                for (YogaNode yogaNode2 : list) {
                    yogaNode2.jni_YGNodeSetOwner(yogaNode2.mNativePointer, 0L);
