...
public abstract class AbstractDraweeController<T, INFO> implements DraweeController, DeferredReleaser.Releasable, GestureDetector.ClickListener {
    ...
    */
    public void onNewResultInternal(java.lang.String r5, com.facebook.datasource.DataSource<T> r6, @javax.annotation.Nullable T r7, float r8, boolean r9, boolean r10, boolean r11) {
        /*
            r4 = this;
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()     // Catch: java.lang.Throwable -> Ld5
            if (r0 == 0) goto Lb
            java.lang.String r0 = "AbstractDraweeController#onNewResultInternal"
            com.facebook.imagepipeline.systrace.FrescoSystrace.beginSection(r0)     // Catch: java.lang.Throwable -> Ld5
        Lb:
            boolean r0 = r4.isExpectedDataSource(r5, r6)     // Catch: java.lang.Throwable -> Ld5
            if (r0 != 0) goto L26
            java.lang.String r5 = "ignore_old_datasource @ onNewResult"
            r4.logMessageAndImage(r5, r7)     // Catch: java.lang.Throwable -> Ld5
            r4.releaseImage(r7)     // Catch: java.lang.Throwable -> Ld5
        ...
        L25:
            return
        L26:
            com.facebook.drawee.components.DraweeEventTracker r0 = r4.mEventTracker     // Catch: java.lang.Throwable -> Ld5
            if (r9 == 0) goto L2d
            com.facebook.drawee.components.DraweeEventTracker$Event r1 = com.facebook.drawee.components.DraweeEventTracker.Event.ON_DATASOURCE_RESULT     // Catch: java.lang.Throwable -> Ld5
            goto L2f
        L2d:
            com.facebook.drawee.components.DraweeEventTracker$Event r1 = com.facebook.drawee.components.DraweeEventTracker.Event.ON_DATASOURCE_RESULT_INT     // Catch: java.lang.Throwable -> Ld5
        L2f:
            r0.recordEvent(r1)     // Catch: java.lang.Throwable -> Ld5
            android.graphics.drawable.Drawable r6 = r4.createDrawable(r7)     // Catch: java.lang.Exception -> Lbf java.lang.Throwable -> Ld5
            T r0 = r4.mFetchedImage     // Catch: java.lang.Throwable -> Ld5
            android.graphics.drawable.Drawable r1 = r4.mDrawable     // Catch: java.lang.Throwable -> Ld5
            r4.mFetchedImage = r7     // Catch: java.lang.Throwable -> Ld5
            r4.mDrawable = r6     // Catch: java.lang.Throwable -> Ld5
            java.lang.String r2 = "release_previous_result @ onNewResult"
            r3 = 1065353216(0x3f800000, float:1.0)
            if (r9 == 0) goto L62
            java.lang.String r8 = "set_final_result @ onNewResult"
            r4.logMessageAndImage(r8, r7)     // Catch: java.lang.Throwable -> L60
            r8 = 0
            r4.mDataSource = r8     // Catch: java.lang.Throwable -> L60
            com.facebook.drawee.interfaces.SettableDraweeHierarchy r8 = r4.mSettableDraweeHierarchy     // Catch: java.lang.Throwable -> L60
            r8.setImage(r6, r3, r10)     // Catch: java.lang.Throwable -> L60
            com.facebook.drawee.controller.ControllerListener r8 = r4.getControllerListener()     // Catch: java.lang.Throwable -> L60
            java.lang.Object r9 = r4.getImageInfo(r7)     // Catch: java.lang.Throwable -> L60
        L5b:
            android.graphics.drawable.Animatable r10 = r4.getAnimatable()     // Catch: java.lang.Throwable -> L60
            goto L78
        L60:
            r5 = move-exception
            goto Lad
        L62:
            ...
            goto L5b
        L78:
            r8.onFinalImageSet(r5, r9, r10, r6)     // Catch: java.lang.Throwable -> L60
            goto L92
        L7c:
            java.lang.String r9 = "set_intermediate_result @ onNewResult"
            r4.logMessageAndImage(r9, r7)     // Catch: java.lang.Throwable -> L60
            com.facebook.drawee.interfaces.SettableDraweeHierarchy r9 = r4.mSettableDraweeHierarchy     // Catch: java.lang.Throwable -> L60
            r9.setImage(r6, r8, r10)     // Catch: java.lang.Throwable -> L60
            com.facebook.drawee.controller.ControllerListener r8 = r4.getControllerListener()     // Catch: java.lang.Throwable -> L60
            java.lang.Object r9 = r4.getImageInfo(r7)     // Catch: java.lang.Throwable -> L60
            r8.onIntermediateImageSet(r5, r9)     // Catch: java.lang.Throwable -> L60
        L92:
            if (r1 == 0) goto L99
            if (r1 == r6) goto L99
            r4.releaseDrawable(r1)     // Catch: java.lang.Throwable -> Ld5
        L99:
            if (r0 == 0) goto La3
            if (r0 == r7) goto La3
            r4.logMessageAndImage(r2, r0)     // Catch: java.lang.Throwable -> Ld5
            r4.releaseImage(r0)     // Catch: java.lang.Throwable -> Ld5
        La3:
            boolean r5 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
            if (r5 == 0) goto Lac
            com.facebook.imagepipeline.systrace.FrescoSystrace.endSection()
        ...
        Lbf:
            ...
            r4.logMessageAndImage(r10, r7)     // Catch: java.lang.Throwable -> Ld5
            r4.releaseImage(r7)     // Catch: java.lang.Throwable -> Ld5
            r4.onFailureInternal(r5, r6, r8, r9)     // Catch: java.lang.Throwable -> Ld5
            boolean r5 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
            if (r5 == 0) goto Ld4
            com.facebook.imagepipeline.systrace.FrescoSystrace.endSection()
        Ld4:
        ...
        Le1:
            goto Le0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.drawee.controller.AbstractDraweeController.onNewResultInternal(java.lang.String, com.facebook.datasource.DataSource, java.lang.Object, float, boolean, boolean, boolean):void");
    }
