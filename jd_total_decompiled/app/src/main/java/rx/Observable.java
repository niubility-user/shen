...
public class Observable<T> {
    ...
    @Deprecated
    public static Observable<Long> timer(long j2, long j3, TimeUnit timeUnit) {
    ...
    public static <T> Observable<T> from(Future<? extends T> future, long j2, TimeUnit timeUnit) {
    ...
    @Deprecated
    public static Observable<Long> timer(long j2, long j3, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    public final <R> Observable<R> concatMapEager(Func1<? super T, ? extends Observable<? extends R>> func1, int i2) {
        if (i2 >= 1) {
            return lift(new OperatorEagerConcatMap(func1, i2, Integer.MAX_VALUE));
        }
    ...
    @Experimental
    public final Observable<T> onBackpressureBuffer(long j2, Action0 action0, BackpressureOverflow.Strategy strategy) {
        return (Observable<T>) lift(new OperatorOnBackpressureBuffer(j2, action0, strategy));
    }
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, int i2, long j2, TimeUnit timeUnit, Scheduler scheduler) {
        if (i2 >= 0) {
            return OperatorReplay.multicastSelector(InternalObservableUtils.createReplaySupplier(this, i2, j2, timeUnit, scheduler), func1);
        }
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, long j2, TimeUnit timeUnit, Scheduler scheduler) {
        return OperatorReplay.multicastSelector(InternalObservableUtils.createReplaySupplier(this, j2, timeUnit, scheduler), func1);
    }
