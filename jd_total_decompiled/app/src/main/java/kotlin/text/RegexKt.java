...
public final class RegexKt {
    ...
    public static final  range(@NotNull java.util.regex.MatchResult matchResult) {
         until;
    ...
    public static final  range(@NotNull java.util.regex.MatchResult matchResult, int i2) {
         until;
