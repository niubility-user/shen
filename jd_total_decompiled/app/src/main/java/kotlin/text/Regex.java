...
public final class Regex implements Serializable {
    ...
    */
    public Regex(@NotNull String str, @NotNull RegexOption regexOption) {
        this(r2);
        Pattern compile = Pattern.compile(str, INSTANCE.ensureUnicodeCase(regexOption.getValue()));
    ...
    */
    public Regex(@NotNull String str, @NotNull Set<? extends RegexOption> set) {
        ...
        i2 = RegexKt.toInt(set);
        Pattern compile = Pattern.compile(str, companion.ensureUnicodeCase(i2));
