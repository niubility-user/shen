            ...
            if (!jClass.isAnonymousClass()) {
                if (jClass.isLocalClass()) {
                    ...
                    if (enclosingConstructor != null) {
                        Intrinsics.checkExpressionValueIsNotNull(name, "name");
                        substringAfter$default = StringsKt__StringsKt.substringAfter$default(name, enclosingConstructor.getName() + "$", (String) null, 2, (Object) null);
                    ...
                    Intrinsics.checkExpressionValueIsNotNull(name, "name");
                    substringAfter$default2 = StringsKt__StringsKt.substringAfter$default(name, (char) Typography.dollar, (String) null, 2, (Object) null);
                    return substringAfter$default2;
                } else if (!jClass.isArray()) {
                    String str4 = (String)  .simpleNames.get(jClass.getName());
