...
public class AntiHookManager {
    ...
    */
    private static ArrayList<HookJavaMethod> getCameraMethodHookedList(ArrayList<JavaMethod> arrayList) {
        ArrayList<HookJavaMethod> arrayList2;
        if (arrayList != null) {
            try {
            ...
            if (arrayList.size() > 0) {
                ...
                for (int i2 = 0; i2 < arrayList.size(); i2++) {
                    arrayList2.add(new HookJavaMethod(arrayList.get(i2)));
                }
                if (arrayList2 != null) {
                    for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                        HookJavaMethod hookJavaMethod = arrayList2.get(i3);
        ...
        arrayList2 = g_camerahookArrayList;
        if (arrayList2 != null) {
        }
        return arrayList2;
    }
