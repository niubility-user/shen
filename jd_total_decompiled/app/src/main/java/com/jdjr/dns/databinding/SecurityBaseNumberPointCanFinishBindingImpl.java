...
public class SecurityBaseNumberPointCanFinishBindingImpl extends SecurityBaseNumberPointCanFinishBinding {
    @Nullable
    ...
    static {
        ...
        sparseIntArray.put(R.id.keyboard_buttons, 14);
        sparseIntArray.put(R.id.okLayout, 15);
        sparseIntArray.put(R.id.btnOk, 16);
    }

    public SecurityBaseNumberPointCanFinishBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    protected void executeBindings() {
        ...
        if (j5 != 0 && j5 != 0) {
            if (KeyboardUiMode.isDark()) {
                j3 = j2 | 4 | 16 | 64 | 256 | 1024 | 4096 | IjkMediaMeta.AV_CH_TOP_FRONT_RIGHT | IjkMediaMeta.AV_CH_TOP_BACK_CENTER | 262144 | 1048576 | 4194304 | 16777216 | 67108864 | 268435456 | IjkMediaMeta.AV_CH_STEREO_RIGHT | IjkMediaMeta.AV_CH_WIDE_RIGHT;
                j4 = IjkMediaMeta.AV_CH_SURROUND_DIRECT_RIGHT;
            } else {
                j3 = j2 | 2 | 8 | 32 | 128 | 512 | 2048 | IjkMediaMeta.AV_CH_TOP_FRONT_CENTER | IjkMediaMeta.AV_CH_TOP_BACK_LEFT | IjkMediaMeta.AV_CH_TOP_BACK_RIGHT | 524288 | 2097152 | 8388608 | 33554432 | 134217728 | IjkMediaMeta.AV_CH_STEREO_LEFT | IjkMediaMeta.AV_CH_WIDE_LEFT;
        ...
        if ((j2 & 1) != 0) {
            ...
            if (KeyboardUiMode.isDark()) {
                context6 = this.mboundView11.getContext();
            ...
            if (KeyboardUiMode.isDark()) {
                context15 = this.symbolKey.getContext();
                i17 = R.drawable.security_general_key_bg_selector_dark;
            } else {
                context15 = this.symbolKey.getContext();
                i17 = R.drawable.security_general_key_bg_selector;
            }
            ViewBindingAdapter.setBackground(imageButton5, AppCompatResources.getDrawable(context15, i17));
            ImageButton imageButton6 = this.symbolKey;
            if (KeyboardUiMode.isDark()) {
                context16 = this.symbolKey.getContext();
                i18 = R.drawable.security_general_point_key_dark;
            } else {
                context16 = this.symbolKey.getContext();
                i18 = R.drawable.security_general_point_key;
            }
            ImageViewBindingAdapter.setImageDrawable(imageButton6, AppCompatResources.getDrawable(context16, i18));
        }
    }
    ...
    private SecurityBaseNumberPointCanFinishBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (Button) objArr[16], (ImageButton) objArr[13], (ImageButton) objArr[12], (LinearLayout) objArr[14], (FrameLayout) objArr[15], (ImageButton) objArr[10]);
        this.mDirtyFlags = -1L;
        ...
        this.symbolKey.setTag(OrderISVUtil.MONEY_DECIMAL);
        setRootTag(view);
        invalidateAll();
    }
}
