...
public class SecurityLayoutFunctionalUnderlineActionBindingImpl extends SecurityLayoutFunctionalUnderlineActionBinding {
    ...
    public SecurityLayoutFunctionalUnderlineActionBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    private SecurityLayoutFunctionalUnderlineActionBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
