...
public class SecurityBaseNumberXCanFinishBindingImpl extends SecurityBaseNumberXCanFinishBinding {
    @Nullable
    ...
    public SecurityBaseNumberXCanFinishBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    protected void executeBindings() {
        ...
        if ((j2 & 1) != 0) {
            ...
            if (KeyboardUiMode.isDark()) {
                ...
                i18 = R.drawable.security_general_x_key_dark;
            } else {
                context16 = this.symbolKey.getContext();
                i18 = R.drawable.security_general_x_key;
            }
    ...
    private SecurityBaseNumberXCanFinishBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
