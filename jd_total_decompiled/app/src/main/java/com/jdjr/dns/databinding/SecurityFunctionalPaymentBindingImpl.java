...
public class SecurityFunctionalPaymentBindingImpl extends SecurityFunctionalPaymentBinding {
    @Nullable
    ...
    static {
        ...
        sparseIntArray.put(R.id.ll_input, 3);
        sparseIntArray.put(R.id.flexibleEditText, 4);
    }

    public SecurityFunctionalPaymentBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    private SecurityFunctionalPaymentBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FlexibleEditText) objArr[4], (LinearLayout) objArr[0], (LinearLayout) objArr[3], (TextView) objArr[1]);
        this.mDirtyFlags = -1L;
