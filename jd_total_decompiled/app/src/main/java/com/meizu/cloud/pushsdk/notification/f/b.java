...
public class b extends c {
    ...
    protected void j(Notification notification, MessageV3 messageV3, PendingIntent pendingIntent) {
        if (MinSdkChecker.isSupportNotificationBuild()) {
            RemoteViews remoteViews = new RemoteViews(this.a.getPackageName(), com.meizu.cloud.pushsdk.notification.g.c.h(this.a));
            ...
            if (messageV3.getNotificationStyle() != null && !TextUtils.isEmpty(messageV3.getNotificationStyle().getExpandableText())) {
                remoteViews.setViewVisibility(com.meizu.cloud.pushsdk.notification.g.c.a(this.a), 0);
                remoteViews.setTextViewText(com.meizu.cloud.pushsdk.notification.g.c.a(this.a), messageV3.getNotificationStyle().getExpandableText());
            }
