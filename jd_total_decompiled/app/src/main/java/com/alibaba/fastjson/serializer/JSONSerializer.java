...
public class JSONSerializer {
    ...
    public JSONSerializer() {
        this(new SerializeWriter(null, JDJSON.DEFAULT_GENERATE_FEATURE, SerializerFeature.EMPTY), SerializeConfig.globalInstance);
    }
    ...
    public static final void write(Writer writer, Object obj) {
        SerializeWriter serializeWriter = new SerializeWriter(null, JDJSON.DEFAULT_GENERATE_FEATURE, SerializerFeature.EMPTY);
        try {
            try {
    ...
    public JSONSerializer(SerializeConfig serializeConfig) {
        this(new SerializeWriter(null, JDJSON.DEFAULT_GENERATE_FEATURE, SerializerFeature.EMPTY), serializeConfig);
    }
