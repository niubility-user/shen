...
public class DynTimerTask implements Runnable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:133:0x006c, code lost:
        if (r10.equals("S") == false) goto L119;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private String a(int i2, long j2, long j3, long j4, long j5) {
        String str;
        int i3;
        StringBuilder sb;
        String str2;
        DynTimerTask dynTimerTask;
        int i4;
        long j6;
        long j7;
        long j8;
        ...
        int i5 = 0;
        int i6 = 0;
        while (i6 < this.f2055n.length()) {
            String valueOf = String.valueOf(this.f2055n.charAt(i6));
            char c2 = 1;
            String valueOf2 = sb5.length() > 0 ? String.valueOf(sb5.charAt(sb5.length() - 1)) : "";
            valueOf.hashCode();
            ...
            switch (c2) {
                ...
                case 4:
                    ...
                    break;
                default:
                    if (sb5.length() <= 0 || TextUtils.isEmpty(valueOf2) || TextUtils.equals(valueOf2, valueOf)) {
                        i3 = i6;
                        str3 = valueOf;
                    } else {
                        i3 = i6;
                        sb4.append(b(i2, j2, j3, j4, j5, sb5.length(), valueOf2));
            ...
            dynTimerTask.c(str2, i4, j6, j7, j8, j9, sb2, sb3, str);
            i6 = i3 + 1;
            sb5 = sb;
            i5 = 0;
        }
