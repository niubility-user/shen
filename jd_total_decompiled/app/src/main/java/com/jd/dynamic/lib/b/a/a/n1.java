...
public class n1 extends e1 {
    ...
    */
    private void o(JSONObject jSONObject, final int i2) {
        Object obj;
        String optString = jSONObject.optString(DeepLinkFillOrderHelper.FROM_KEY);
        try {
            if (!TextUtils.isEmpty(optString)) {
                obj = com.jd.dynamic.b.a.b.o().e() ? this.mEngine.getCachePool().getDataObj(optString) : this.mEngine.getCachePool().getData(optString);
                ...
                final JSONObject jSONObject2 = obj instanceof JSONObject ? obj : null;
                Runnable runnable = new Runnable() { // from class: com.jd.dynamic.lib.b.a.a.z0
                    @Override // java.lang.Runnable
                    public final void run() {
                        n1.this.r(jSONObject2, i2);
                    }
                };
                if (com.jd.dynamic.lib.utils.m.D()) {
                    AndroidSchedulers.mainThread().createWorker().schedule(new com.jd.dynamic.lib.b.a.a.a(runnable));
            ...
            Runnable runnable2 = new Runnable() { // from class: com.jd.dynamic.lib.b.a.a.z0
                @Override // java.lang.Runnable
                public final void run() {
                    n1.this.r(jSONObject2, i2);
                }
