...
public class DynamicTemplateEngine implements IDarkChangeListener {
    ...
    /* JADX WARN: Removed duplicated region for block: B:474:0x02fe  */
    /* JADX WARN: Removed duplicated region for block: B:483:0x033a  */
    /* JADX WARN: Removed duplicated region for block: B:495:0x037e  */
    /* JADX WARN: Removed duplicated region for block: B:496:0x038b  */
    /* JADX WARN: Removed duplicated region for block: B:509:0x02b1 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public boolean H(JSONObject jSONObject, double d) {
        long j2;
        long j3;
        long j4;
        long j5;
        ...
        String str;
        BaseFrameLayout baseFrameLayout2;
        int i3;
        ...
        if (com.jd.dynamic.lib.utils.m.K(optJSONArray)) {
            ...
            BaseFrameLayout rootContainer = getRootContainer();
            long j10 = 0;
            if (rootContainer == null || !com.jd.dynamic.lib.utils.m.E(this.f1889k)) {
                j2 = nanoTime;
                j3 = 0;
                j4 = 0;
                j5 = 0;
                ...
                while (i4 < optJSONArray.length()) {
                    ...
                    View b = b(optInt);
                    if (b == null) {
                        b = rootContainer.findViewById(optInt);
                    }
                    final View view = b;
                    if (view == null) {
                        return false;
                    ...
                    int i5 = R.id.dynamic_view_need_rebind;
                    view.setTag(i5, null);
                    if (this.F == null) {
                        this.F = new Gson();
                    }
                    long j15 = j11;
                    HashMap<String, String> hashMap3 = (HashMap) this.F.fromJson(optJSONObject2.toString(), HashMap.class);
                    if (com.jd.dynamic.lib.utils.m.J(hashMap3)) {
                        String str6 = hashMap3.get("visibility");
                        j7 = j12;
                        HashMap<String, String> hashMap4 = this.f1889k.get(optInt);
                        String str7 = hashMap4.get(DYConstants.DYN_KEEP_ATTRS);
                        if (com.jd.dynamic.lib.utils.m.J(hashMap4)) {
                            jSONArray = optJSONArray;
                            String str8 = "$dark(";
                            if (com.jd.dynamic.b.a.b.o().y()) {
                                String str9 = hashMap4.get("visibility");
                                if (((!TextUtils.isEmpty(str9) && !str9.contains("$dark(")) || (!TextUtils.isEmpty(str7) && !str7.contains("visibility"))) && TextUtils.equals(str6, "2")) {
                                    com.jd.dynamic.lib.utils.m.r(view, 8);
                                    if (view.getParent() instanceof YogaLayout) {
                                        ((YogaLayout) view.getParent()).invalidate(view);
                                    }
                                    view.setTag(i5, com.jd.dynamic.b.c.a.b);
                                    if (this.isAttached) {
                                        com.jd.dynamic.lib.utils.m.A(hashMap3, view);
                                    }
                                    if (getRootContainer() != null) {
                                        getRootContainer().post(new Runnable() { // from class: com.jd.dynamic.base.z0
                                            {
                                                DynamicTemplateEngine.this = this;
                                            }
                                            ...
                                            @Override // java.lang.Runnable
                                            public final void run() {
                                                DynamicTemplateEngine.this.L(view);
                                            }
                                        });
                                    } else {
                                        com.jd.dynamic.lib.utils.m.s(view, this);
                                    }
                                    com.jd.dynamic.lib.utils.t.e("ViewRefresh", "bindView cache", "only refresh Gone child = " + view.getId() + " size = " + hashMap3.size() + " continue");
                                    j8 = nanoTime;
                            ...
                            for (Map.Entry<String, String> entry2 : hashMap3.entrySet()) {
                                ...
                                if (com.jd.dynamic.lib.utils.m.J(hashMap4)) {
                                    hashMap = hashMap4;
                                    String str10 = hashMap4.get(key);
                                    X(str10);
                                    long nanoTime2 = System.nanoTime();
                                    if (TextUtils.isEmpty(str10) || !str10.contains(str8) || DynamicSdk.getEngine().getDynamicDark() == null) {
                                        str3 = str7;
                                        j9 = nanoTime;
                                        str = str8;
                                        baseFrameLayout2 = rootContainer;
                                        i3 = i4;
                                        entry = entry2;
                                        hashMap2 = hashMap3;
                                        ...
                                        str = str8;
                                        sb.append("_dark");
                                        String optString = optJSONObject2.optString(sb.toString());
                                        boolean isDarkMode = DynamicSdk.getEngine().getDynamicDark().isDarkMode();
                                        j15 += System.nanoTime() - nanoTime3;
                                        try {
                                            JSONObject jSONObject3 = !TextUtils.isEmpty(optString) ? new JSONObject(optString) : new JSONObject();
                                            String str11 = isDarkMode ? CustomThemeConstance.NAVI_IMAGE_DARK_TAG : "unDark";
                                            ...
                                            if (str5 == null) {
                                                ...
                                                jSONObject2 = optJSONObject2;
                                                try {
                                                    newBindDataWithELWithView(viewNode, jSONObject, str10, key, view);
                                                    str4 = key;
                                                } catch (Exception e2) {
                                                    e = e2;
                                                    str4 = key;
                                                ...
                                                try {
                                                    String remove = viewNode.getELAttributes().remove(str4);
                                                    jSONObject3.put(str12, remove);
                                                    jSONObject2.put(str4 + "_dark", jSONObject3.toString());
                                                    str5 = remove;
                                                } catch (Exception e3) {
                                                    e = e3;
                                                    e.printStackTrace();
                                                    ...
                                                    hashMap4 = hashMap;
                                                    str8 = str;
                                                    rootContainer = baseFrameLayout2;
                                                    nanoTime = j9;
                                                    i4 = i3;
                                                }
                                            } else {
                                    ...
                                    if (TextUtils.isEmpty(str3)) {
                                        try {
                                            str2 = str3;
                                            try {
                                                ArrayList arrayList = (ArrayList) this.F.fromJson(new JSONArray(str2).toString(), ArrayList.class);
                                                if (com.jd.dynamic.lib.utils.m.I(arrayList) && arrayList.contains(str4)) {
                                                    ViewNode viewNode2 = new ViewNode();
                                                    newBindDataWithELWithView(viewNode2, jSONObject, str10, str4, view);
                                                    String remove2 = viewNode2.getELAttributes().remove(str4);
                                                    if (remove2 == null) {
                                                        remove2 = "";
                                                    }
                                                    entry.setValue(remove2);
                                                }
                                            } catch (Exception e5) {
                                                e = e5;
                                                e.printStackTrace();
                            ...
                            j12 = j7;
                            if (this.isAttached) {
                                com.jd.dynamic.lib.utils.m.A(hashMap5, view);
                            }
                            long nanoTime5 = System.nanoTime();
                            vVar.a(hashMap5, view);
                            ...
                            j13 += System.nanoTime() - nanoTime5;
                            if (getRootContainer() == null) {
                                getRootContainer().post(new Runnable() { // from class: com.jd.dynamic.base.b1
                                    {
                                        DynamicTemplateEngine.this = this;
                                    }
                                    ...
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        DynamicTemplateEngine.this.j(view);
                                    }
                                });
                            } else {
                                com.jd.dynamic.lib.utils.m.s(view, this);
                            }
                            j3 += System.nanoTime() - nanoTime6;
                            i4 = i2 + 1;
                            optJSONArray = jSONArray;
                            rootContainer = baseFrameLayout;
                            nanoTime = j8;
                    ...
                    j13 += System.nanoTime() - nanoTime52;
                    if (getRootContainer() == null) {
                    }
                    j3 += System.nanoTime() - nanoTime62;
                    i4 = i2 + 1;
                    optJSONArray = jSONArray;
                    rootContainer = baseFrameLayout;
                    nanoTime = j8;
            ...
            com.jd.dynamic.lib.utils.t.e("bindViewUseCache", "isAttached = " + this.isAttached, "all time = " + DynamicMtaUtil.getCurMicroseconds(System.nanoTime() - j2), " bind time = " + DynamicMtaUtil.getCurMicroseconds(j10), " event time = " + DynamicMtaUtil.getCurMicroseconds(j3), " dark time = " + DynamicMtaUtil.getCurMicroseconds(j4), " newJson time = " + DynamicMtaUtil.getCurMicroseconds(j5), " putJson time = " + DynamicMtaUtil.getCurMicroseconds(j6));
            return true;
        }
        return false;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:228:0x015b A[Catch: Exception -> 0x01a0, TryCatch #0 {Exception -> 0x01a0, blocks: (B:197:0x0078, B:203:0x0088, B:206:0x008d, B:209:0x009e, B:211:0x00ac, B:220:0x0107, B:225:0x014d, B:226:0x0155, B:228:0x015b, B:230:0x0167, B:232:0x0173, B:233:0x017b, B:234:0x018b, B:200:0x0080), top: B:240:0x0078 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void newRefreshView(JSONObject jSONObject) {
        ...
        Object obj = null;
        if (this.O) {
            calculateVisibilityFromRoot(this.N, c0, null, this);
        ...
        for (Map.Entry<ViewNode, HashMap<String, String>> entry : this.f1888j.entrySet()) {
            ...
            if (key != null && key.getAttributes() != null && (i2 = key.viewId) != 0) {
                try {
                    View b = b(i2);
                    findViewById = b != null ? b : rootContainer.findViewById(i2);
                } catch (Exception e2) {
                    e = e2;
                }
                if (findViewById != null && !key.unNeedInitBind) {
                    ...
                    if (com.jd.dynamic.b.a.b.o().y()) {
                        ...
                        if (!TextUtils.isEmpty(str3)) {
                            ...
                            try {
                                newBindDataWithELWithView(key, c0, str3, "visibility", findViewById);
                                str2 = key.getELAttributes().get(str);
                            } catch (Exception e3) {
                                e = e3;
                                DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_BIND, "DynamicTemplateEngine newRefreshView error", com.jd.dynamic.lib.utils.m.j(this), com.jd.dynamic.lib.utils.m.O(this), e);
                                obj = null;
                            }
                            if (TextUtils.equals(str2, "2")) {
                                com.jd.dynamic.lib.utils.m.r(view2, 8);
                                if (view2.getParent() instanceof YogaLayout) {
                                    ((YogaLayout) view2.getParent()).invalidate(view2);
                                }
                                view2.setTag(i3, com.jd.dynamic.b.c.a.b);
                                R(key.getAttributes(), view2);
                                A(key.getAttributes(), view2);
                                Object[] objArr = new Object[4];
                                objArr[0] = "ViewRefreshBindData";
                                objArr[1] = "newRefreshView";
                                objArr[2] = "only change gone child = " + view2.getId();
                                objArr[3] = "map size = " + value.size();
                                com.jd.dynamic.lib.utils.t.e(objArr);
                                obj = null;
                            } else {
                                view = view2;
                                for (Map.Entry<String, String> entry2 : value.entrySet()) {
                                    if (TextUtils.isEmpty(str2) || !TextUtils.equals(entry2.getKey(), str)) {
                                        newBindDataWithEL(key, c0, entry2.getValue(), entry2.getKey());
                                    } else {
                                        key.getELAttributes().put(str, str2);
                                    }
                                }
                                this.x = DynamicXParser.getWidth();
                                P(new Runnable() { // from class: com.jd.dynamic.base.x0
                                    {
                                        DynamicTemplateEngine.this = this;
                                    }
                                    ...
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        DynamicTemplateEngine.this.O(vVar, key, view, d);
                                    }
                                });
                                obj = null;
                            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:231:0x013d A[Catch: Exception -> 0x0182, TryCatch #1 {Exception -> 0x0182, blocks: (B:220:0x00a5, B:222:0x00ba, B:224:0x00c9, B:225:0x00d2, B:228:0x012f, B:229:0x0137, B:231:0x013d, B:233:0x0149, B:235:0x0155, B:236:0x015d, B:237:0x016d), top: B:248:0x00a5 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void rebindDataRefreshView(JSONObject jSONObject) {
        ...
        Object obj = null;
        if (this.O) {
            calculateVisibilityFromRoot(this.N, jSONObject, null, this);
        }
        BaseFrameLayout rootContainer = getRootContainer();
        if (rootContainer == null || this.f1888j == null) {
            return;
                ...
                if (findViewById != null && !key.unNeedInitBind) {
                    ...
                    if (com.jd.dynamic.b.a.b.o().y()) {
                        ...
                        if (!TextUtils.isEmpty(str3)) {
                            ...
                            View view2 = findViewById;
                            try {
                                newBindDataWithELWithView(key, jSONObject, str3, "visibility", findViewById);
                                str2 = key.getELAttributes().get(str);
                            } catch (Exception e3) {
                                e = e3;
                                DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_BIND, "DynamicTemplateEngine newRefreshView error", com.jd.dynamic.lib.utils.m.j(this), com.jd.dynamic.lib.utils.m.O(this), e);
                            ...
                            if (TextUtils.equals(str2, "2")) {
                                ...
                                R(key.getAttributes(), view2);
                                A(key.getAttributes(), view2);
                                com.jd.dynamic.lib.utils.t.e("ViewRefreshBindData", "newRefreshView", "only change gone child = " + view2.getId(), "map size = " + value.size());
                                rootContainer = baseFrameLayout;
                                obj = null;
                            } else {
                                view = view2;
                                ...
                                this.x = DynamicXParser.getWidth();
                                P(new Runnable() { // from class: com.jd.dynamic.base.t0
                                    {
                                        DynamicTemplateEngine.this = this;
                                    }
                                    ...
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        DynamicTemplateEngine.this.x(vVar, key, view, d);
                                    }
                                });
                                rootContainer = baseFrameLayout;
                                obj = null;
    ...
    /* JADX WARN: Removed duplicated region for block: B:151:0x0088 A[Catch: Exception -> 0x00aa, LOOP:1: B:149:0x0082->B:151:0x0088, LOOP_END, TryCatch #0 {Exception -> 0x00aa, blocks: (B:144:0x006a, B:148:0x0076, B:149:0x0082, B:151:0x0088, B:154:0x00a1, B:147:0x0072), top: B:159:0x006a }] */
    /* JADX WARN: Removed duplicated region for block: B:167:0x00a1 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:168:0x00a0 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void refreshView(JSONObject jSONObject, int i2, View view) {
        Map<ViewNode, HashMap<String, String>> map;
        int i3;
        ...
        com.jd.dynamic.lib.utils.t.e("refreshView", "layoutId = " + i2);
        int a = com.jd.dynamic.lib.dynamic.parser.h.a(this, String.valueOf(i2));
        BaseFrameLayout rootContainer = getRootContainer();
        if (rootContainer == null || (map = this.f1888j) == null) {
            return;
        }
        for (Map.Entry<ViewNode, HashMap<String, String>> entry : map.entrySet()) {
            HashMap<String, String> value = entry.getValue();
            ViewNode key = entry.getKey();
            if (key != null && key.getAttributes() != null && (i3 = key.viewId) != 0 && i3 == a && !key.unNeedInitBind) {
                if (view != null) {
                    try {
                        if (view.getId() == a) {
                            findViewById = view;
                            ...
                            if (findViewById == null) {
                                P(new Runnable() { // from class: com.jd.dynamic.base.l0
                                    {
                                        DynamicTemplateEngine.this = this;
                                    }
                                    ...
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        DynamicTemplateEngine.this.s(m18clone, findViewById);
                                    }
                                });
                            }
                        }
                    } catch (Exception e2) {
                        DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_BIND, "DynamicTemplateEngine refreshView2 error", com.jd.dynamic.lib.utils.m.j(this), com.jd.dynamic.lib.utils.m.O(this), e2);
                    }
                }
                findViewById = rootContainer.findViewById(a);
                final ViewNode m18clone2 = key.m18clone();
                while (r3.hasNext()) {
                }
                if (findViewById == null) {
                }
    ...
    */
    public void releaseJS() {
        long j2;
        DYConstants.DYLog("XPJ  release js : " + this.H + " context : " + this.q);
        if (this.q == null) {
            return;
        }
        com.jd.dynamic.a.i iVar = this.H;
        if (iVar != null) {
            iVar.p();
            this.H.q();
            this.H = null;
        }
        com.jd.dynamic.a.i iVar2 = this.I;
        if (iVar2 != null) {
            iVar2.p();
            this.I.q();
            this.I = null;
        }
        if (com.jd.dynamic.b.a.b.o().n() && getActivity() != null) {
            DynamicSdk.getDriver().removeContext(getActivity(), this.q.h());
            if (DynamicSdk.getDriver().getContextCacheSize(getActivity()) == 0) {
                j2 = DynamicSdk.getDriver().removeContextGroup(getActivity());
                DynamicSdk.getDriver().cleanContextCache(getActivity());
                this.q.i();
                this.q = null;
                if (j2 == -1) {
                    com.jd.dynamic.lib.utils.t.e("destroyJSContextGroup");
                    JavaScriptRuntime.destroyJSContextGroup(j2);
                    return;
                }
                return;
            }
