    ...
    public static final class Engine {
        ...
        public void fetchTemplates(final DynamicFetcher.GlobalConfigListener globalConfigListener, boolean z, String... strArr) {
            ...
            if (TextUtils.equals(dynamicStatus, "0")) {
                ...
                Observable.from(strArr).filter(e0.f1960g).forEach(new c1(arrayList), h0.f1969g);
                ...
                while (it.hasNext()) {
                    ...
                    L2c:
                        ...
                        com.jd.dynamic.base.e0 r6 = com.jd.dynamic.base.e0.f1960g
                        rx.Observable r5 = r5.filter(r6)
                        com.jd.dynamic.base.c1 r6 = new com.jd.dynamic.base.c1
                        r6.<init>(r2)
                        com.jd.dynamic.base.h0 r7 = com.jd.dynamic.base.h0.f1969g
                        r5.forEach(r6, r7)
                        int r10 = r2.size()
                        if (r10 != 0) goto L84
                        int r2 = r0.length
                ...
                public void newFetchTemplates(final NewDynamicFetcher.GlobalConfigListener globalConfigListener, boolean z, String... strArr) {
                    ...
                    if (TextUtils.equals(dynamicStatus, "0")) {
                        ...
                        ArrayList arrayList = new ArrayList();
                        Observable.from(strArr).filter(i0.f1973g).forEach(new c1(arrayList), g0.f1966g);
                        final int size = arrayList.size();
                        if (size == 0) {
                            int length2 = strArr.length;
                            while (i2 < length2) {
                        ...
                        while (it.hasNext()) {
                            ...
                            L2c:
                                ...
                                r2.<init>()
                                rx.Observable r5 = rx.Observable.from(r19)
                                com.jd.dynamic.base.i0 r6 = com.jd.dynamic.base.i0.f1973g
                                rx.Observable r5 = r5.filter(r6)
                                com.jd.dynamic.base.c1 r6 = new com.jd.dynamic.base.c1
                                r6.<init>(r2)
                                com.jd.dynamic.base.g0 r7 = com.jd.dynamic.base.g0.f1966g
                                r5.forEach(r6, r7)
                                int r10 = r2.size()
                                if (r10 != 0) goto L84
                                int r2 = r0.length
