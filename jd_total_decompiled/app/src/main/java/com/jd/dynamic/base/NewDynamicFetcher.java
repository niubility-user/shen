    ...
    */
        ...
        if (com.jd.dynamic.b.i.a.e(templateRequest.systemCode, templateRequest.getBizField())) {
            ...
            if (com.jd.dynamic.lib.utils.m.F(a)) {
                try {
                    ...
                    DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_LOCAL_BACKUP, i2 + "-\u4f7f\u7528App\u5185\u7f6e\u6a21\u677f\u8fdb\u884c\u52a0\u8f7d", templateRequest.getBizField(), templateRequest.systemCode, i2, new RuntimeException(), com.jd.dynamic.lib.utils.m.m(a, null));
                    ...
                    if (listener != null) {
                        callOnEnd(listener, a, templateRequest.mtaId);
                    }
                    z = true;
                } catch (Exception e3) {
                    exc = e3;
                    z = true;
                    DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_LOCAL_BACKUP_ERROR, i2 + "-App\u5185\u7f6e\u6a21\u677f\u52a0\u8f7d\u5f02\u5e38", templateRequest.getBizField(), templateRequest.systemCode, i2, exc, com.jd.dynamic.lib.utils.m.q(templateRequest.getZipVersion(), null));
                    if (!z) {
                    }
                    return z;
                }
                if (!z) {
                    if (TextUtils.isEmpty(templateRequest.localTemp)) {
                        ...
                        if (inputStream != null && (templateFromLocal = getTemplateFromLocal(inputStream, templateRequest.systemCode, templateRequest.getBizField(), templateRequest.mtaId)) != null && !TextUtils.isEmpty(templateFromLocal.getViewName())) {
                            ...
                            DynamicMtaUtil.appendDownloadTypeMtaStat(templateRequest.mtaId, 4);
                            DynamicFetcher.Listener listener2 = templateRequest.listener;
                            if (listener2 != null) {
                                listener2.onEnd(templateFromLocal, templateRequest.mtaId);
                                return true;
                            }
                            return true;
                        }
                    } else {
                        ResultEntity parseBinaryToResultEntity = NewDynamicXParser.parseBinaryToResultEntity(templateRequest.localTemp, true, templateRequest.getBizField(), templateRequest.systemCode, templateRequest.mtaId);
                        if (parseBinaryToResultEntity != null && (viewNode = parseBinaryToResultEntity.viewNode) != null && !TextUtils.isEmpty(viewNode.getViewName())) {
                            parseBinaryToResultEntity.isBackup = true;
                            com.jd.dynamic.lib.utils.t.g("getTemplateFromAssets()  use local default template!!!", templateRequest.localTemp);
                            DynamicMtaUtil.appendDownloadTypeMtaStat(templateRequest.mtaId, 4);
                            DynamicFetcher.Listener listener3 = templateRequest.listener;
                            if (listener3 != null) {
                                callOnEnd(listener3, parseBinaryToResultEntity, templateRequest.mtaId);
                                return true;
                            }
                            return true;
                        }
            ...
            DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_LOCAL_BACKUP_ERROR, i2 + "-App\u5185\u7f6e\u6a21\u677f\u52a0\u8f7d\u5931\u8d25", templateRequest.getBizField(), templateRequest.systemCode, i2, new RuntimeException(), com.jd.dynamic.lib.utils.m.q(templateRequest.getZipVersion(), null));
        }
        z = false;
        if (!z) {
        }
    ...
    private static void getTemplateFromNet(final TemplateRequest templateRequest) {
        ...
        DynamicSdk.getEngine().getRequest().downloadFile(downloadUrl, com.jd.dynamic.b.e.a.b.n(templateRequest.systemCode, templateRequest.getBusinessCode()), k2, new INetWorkRequest.DownloadCallBack() { // from class: com.jd.dynamic.base.NewDynamicFetcher.4
            ...
            /* JADX WARN: Removed duplicated region for block: B:168:0x0146 A[Catch: Exception -> 0x01bb, TryCatch #0 {Exception -> 0x01bb, blocks: (B:141:0x0020, B:143:0x002a, B:145:0x0037, B:149:0x0060, B:151:0x0098, B:153:0x00df, B:165:0x0118, B:166:0x0134, B:168:0x0146, B:169:0x0152, B:179:0x0191, B:181:0x01a3, B:183:0x01a7, B:185:0x01b1, B:170:0x0156, B:172:0x015a, B:173:0x0167, B:175:0x0171, B:176:0x017e, B:178:0x0184, B:144:0x0033), top: B:200:0x0020 }] */
            /* JADX WARN: Removed duplicated region for block: B:170:0x0156 A[Catch: Exception -> 0x01bb, TryCatch #0 {Exception -> 0x01bb, blocks: (B:141:0x0020, B:143:0x002a, B:145:0x0037, B:149:0x0060, B:151:0x0098, B:153:0x00df, B:165:0x0118, B:166:0x0134, B:168:0x0146, B:169:0x0152, B:179:0x0191, B:181:0x01a3, B:183:0x01a7, B:185:0x01b1, B:170:0x0156, B:172:0x015a, B:173:0x0167, B:175:0x0171, B:176:0x017e, B:178:0x0184, B:144:0x0033), top: B:200:0x0020 }] */
            /* JADX WARN: Removed duplicated region for block: B:181:0x01a3 A[Catch: Exception -> 0x01bb, TryCatch #0 {Exception -> 0x01bb, blocks: (B:141:0x0020, B:143:0x002a, B:145:0x0037, B:149:0x0060, B:151:0x0098, B:153:0x00df, B:165:0x0118, B:166:0x0134, B:168:0x0146, B:169:0x0152, B:179:0x0191, B:181:0x01a3, B:183:0x01a7, B:185:0x01b1, B:170:0x0156, B:172:0x015a, B:173:0x0167, B:175:0x0171, B:176:0x017e, B:178:0x0184, B:144:0x0033), top: B:200:0x0020 }] */
            ...
            */
            public void onSuccess(File file) {
                TemplateRequest templateRequest2;
                String absolutePath;
                ...
                this.b = nanoTime;
                TemplateRequest templateRequest3 = templateRequest;
                DynamicMtaUtil.uploadDownloadTempMta(templateRequest3.systemCode, templateRequest3.template, nanoTime - this.a, true);
                ResultEntity resultEntity = new ResultEntity();
                boolean z = false;
                try {
                    absolutePath = com.jd.dynamic.b.a.b.o().I() ? com.jd.dynamic.lib.utils.m.N(file).getAbsolutePath() : file.getAbsolutePath();
                    u = com.jd.dynamic.b.e.a.b.u(absolutePath, templateRequest.template.getMd5());
                    ...
                    objArr[3] = "compute md5:" + com.jd.dynamic.lib.utils.p.c(absolutePath);
                    com.jd.dynamic.lib.utils.t.c(objArr);
                } catch (Exception e2) {
                    String str3 = templateRequest.getBizField() + "-" + templateRequest.getVersion();
                    TemplateRequest templateRequest4 = templateRequest;
                    DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_PARSE, "getTemplateFromNet catched exception", str3, templateRequest4.systemCode, R2.attr.liteMode, e2, com.jd.dynamic.lib.utils.m.q(templateRequest4.getZipVersion(), null));
                    com.jd.dynamic.lib.utils.t.e(NewDynamicFetcher.TAG, "getTemplateFromNet(),faild to parse dynamic binary");
                }
                if (!((Boolean) u.first).booleanValue()) {
                    com.jd.dynamic.lib.utils.m.H(absolutePath);
                    NewDynamicFetcher.tryLoadAssetsTemp(templateRequest, "getTemplateFromNet(),verify dynamic binary file md5 failed!", 307, 1006);
                    DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_STORAGE, "getTemplateFromNet verified fail  reason: " + ((String) u.second) + " url:" + templateRequest.template.getDownloadUrl(), templateRequest.getBizField(), templateRequest.systemCode, (int) R2.attr.layout_constraintHeight, (Exception) null);
                    return;
                }
                if (templateRequest.template.isDownloadZip()) {
                    try {
                        long nanoTime2 = System.nanoTime();
                        String i2 = com.jd.dynamic.lib.utils.o.i(absolutePath);
                        List<File> c2 = com.jd.dynamic.lib.utils.o.c(absolutePath, i2);
                        com.jd.dynamic.lib.utils.m.H(absolutePath);
                        try {
                            long nanoTime3 = System.nanoTime();
                            TemplateRequest templateRequest5 = templateRequest;
                            DynamicMtaUtil.uploadUnZipTempMta(templateRequest5.systemCode, templateRequest5.template, nanoTime3 - nanoTime2, c2 != null, false);
                            absolutePath = i2;
                        } catch (Exception e3) {
                            e = e3;
                            absolutePath = i2;
                            DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_UNZIP, "unzip catched exception", templateRequest.getBizField(), templateRequest.systemCode, e);
                            com.jd.dynamic.lib.utils.t.e(NewDynamicFetcher.TAG, "getTemplateFromNet(),faild to unzip");
                            String bizField2 = templateRequest.getBizField();
                            TemplateRequest templateRequest6 = templateRequest;
                            resultEntity = NewDynamicXParser.parseBinaryToResultEntity(absolutePath, bizField2, templateRequest6.systemCode, templateRequest6.mtaId);
                            if (resultEntity != null) {
                            }
                            DynamicFetcher.reportParseFileError(str, bizField, str2);
                            DynamicMtaUtil.appendDownloadTypeMtaStat(templateRequest.mtaId, 3);
                            TemplateRequest templateRequest7 = templateRequest;
                            com.jd.dynamic.b.e.a.b.e(templateRequest7.systemCode, templateRequest7.template);
                            z = resultEntity == null && (viewNode = resultEntity.viewNode) != null && !TextUtils.isEmpty(viewNode.getViewName()) && resultEntity.viewNode.parseSuccess;
                            if (z) {
                            }
                            templateRequest2 = templateRequest;
                            if (templateRequest2.isProvideLowVersion) {
                            }
                        }
                    } catch (Exception e4) {
                        e = e4;
                ...
                String bizField22 = templateRequest.getBizField();
                TemplateRequest templateRequest62 = templateRequest;
                resultEntity = NewDynamicXParser.parseBinaryToResultEntity(absolutePath, bizField22, templateRequest62.systemCode, templateRequest62.mtaId);
                if (resultEntity != null) {
                    str = "entity is null";
                    bizField = templateRequest.getBizField();
                    str2 = templateRequest.systemCode;
                } else {
                    ViewNode viewNode2 = resultEntity.viewNode;
                    if (viewNode2 == null) {
                        str = "entity view node is null";
                        bizField = templateRequest.getBizField();
                        str2 = templateRequest.systemCode;
                    } else if (!TextUtils.isEmpty(viewNode2.getViewName())) {
                        if (!resultEntity.viewNode.parseSuccess) {
                            str = "entity view node parse error ";
                            bizField = templateRequest.getBizField();
                            str2 = templateRequest.systemCode;
                        }
                        DynamicMtaUtil.appendDownloadTypeMtaStat(templateRequest.mtaId, 3);
                        TemplateRequest templateRequest72 = templateRequest;
                        com.jd.dynamic.b.e.a.b.e(templateRequest72.systemCode, templateRequest72.template);
                        z = resultEntity == null && (viewNode = resultEntity.viewNode) != null && !TextUtils.isEmpty(viewNode.getViewName()) && resultEntity.viewNode.parseSuccess;
                        if (z) {
                            TemplateRequest templateRequest8 = templateRequest;
                            if (!templateRequest8.isProvideLowVersion) {
                                NewDynamicFetcher.callOnEnd(templateRequest8.listener, resultEntity, templateRequest8.mtaId);
                                return;
                            }
                        }
                        templateRequest2 = templateRequest;
                        ...
                        NewDynamicFetcher.tryLoadAssetsTemp(templateRequest2, "getTemplateFromNet(),faild to parse dynamic binary", 305, 1007);
                        return;
                    } else {
                        str = "entity view node name is empty ";
                        bizField = templateRequest.getBizField();
                        str2 = templateRequest.systemCode;
                    }
                }
                DynamicFetcher.reportParseFileError(str, bizField, str2);
                DynamicMtaUtil.appendDownloadTypeMtaStat(templateRequest.mtaId, 3);
                TemplateRequest templateRequest722 = templateRequest;
                com.jd.dynamic.b.e.a.b.e(templateRequest722.systemCode, templateRequest722.template);
                z = resultEntity == null && (viewNode = resultEntity.viewNode) != null && !TextUtils.isEmpty(viewNode.getViewName()) && resultEntity.viewNode.parseSuccess;
                if (z) {
                }
                templateRequest2 = templateRequest;
            ...
            if (TextUtils.equals(g2.b, "0") && !g2.b(str2) && !g2.e(str2)) {
                ...
                try {
                    ...
                    templateRequest.task = sExecutor.submit(new Callable<Object>() { // from class: com.jd.dynamic.base.NewDynamicFetcher.2
                        /* JADX WARN: Removed duplicated region for block: B:124:0x004b A[Catch: all -> 0x0102, TryCatch #1 {Exception -> 0x010b, blocks: (B:110:0x0008, B:112:0x0012, B:113:0x0016, B:150:0x0105, B:114:0x0017, B:116:0x0031, B:118:0x003b, B:124:0x004b, B:126:0x0066, B:128:0x006c, B:144:0x00fb, B:145:0x0100, B:131:0x0076, B:133:0x0091, B:135:0x00a5, B:137:0x00be, B:139:0x00ca, B:141:0x00dc, B:143:0x00de, B:136:0x00ab), top: B:155:0x0008 }] */
                        /* JADX WARN: Removed duplicated region for block: B:133:0x0091 A[Catch: all -> 0x0102, TryCatch #1 {Exception -> 0x010b, blocks: (B:110:0x0008, B:112:0x0012, B:113:0x0016, B:150:0x0105, B:114:0x0017, B:116:0x0031, B:118:0x003b, B:124:0x004b, B:126:0x0066, B:128:0x006c, B:144:0x00fb, B:145:0x0100, B:131:0x0076, B:133:0x0091, B:135:0x00a5, B:137:0x00be, B:139:0x00ca, B:141:0x00dc, B:143:0x00de, B:136:0x00ab), top: B:155:0x0008 }] */
                        /* JADX WARN: Removed duplicated region for block: B:136:0x00ab A[Catch: all -> 0x0102, TryCatch #1 {Exception -> 0x010b, blocks: (B:110:0x0008, B:112:0x0012, B:113:0x0016, B:150:0x0105, B:114:0x0017, B:116:0x0031, B:118:0x003b, B:124:0x004b, B:126:0x0066, B:128:0x006c, B:144:0x00fb, B:145:0x0100, B:131:0x0076, B:133:0x0091, B:135:0x00a5, B:137:0x00be, B:139:0x00ca, B:141:0x00dc, B:143:0x00de, B:136:0x00ab), top: B:155:0x0008 }] */
                        ...
                        */
                        public Object call() {
                            ...
                            try {
                                if (DynamicSdk.getEngine().isFetchAtFirstRequest()) {
                                    synchronized (NewDynamicFetcher.objLock1) {
                                        Boolean bool = (Boolean) NewDynamicFetcher.sFirstRequestMap.get(str);
                                        if (TextUtils.equals("1", g2.b) && !g2.d(str2) && !g2.e(str2)) {
                                            ...
                                            if ((bool == null && bool.booleanValue() && !com.jd.dynamic.b.e.a.b.l(str)) || z2) {
                                                NewDynamicFetcher.internalRequestCommon(templateRequest);
                                            } else {
                                                ...
                                                if (NewDynamicFetcher.pendingTempReqList.containsKey(str)) {
                                                    ArrayList arrayList = new ArrayList();
                                                    arrayList.add(templateRequest);
                                                    NewDynamicFetcher.pendingTempReqList.put(str, arrayList);
                                                } else {
                                                    ArrayList arrayList2 = (ArrayList) NewDynamicFetcher.pendingTempReqList.get(str);
                                                    if (!arrayList2.contains(templateRequest)) {
                                                        arrayList2.add(templateRequest);
                                                    }
                                                }
                                                if (!NewDynamicFetcher.sBunchRequestStatus.containsKey(str) && ((Boolean) NewDynamicFetcher.sBunchRequestStatus.get(str)).booleanValue()) {
                                                    return null;
                                                }
                                                NewDynamicFetcher.sBunchRequestStatus.put(str, bool2);
                                                DynamicSdk.getEngine().newFetchTemplates(NewDynamicFetcher.getGlobalConfigListener(str), false, str);
                                            }
                                        }
                                        z2 = true;
                                        if (z2) {
                                        ...
                                        templateRequest.fromNet = true;
                                        ConcurrentHashMap concurrentHashMap2 = NewDynamicFetcher.sFirstRequestMap;
                                        String str92 = str;
                                        Boolean bool22 = Boolean.TRUE;
                                        concurrentHashMap2.put(str92, bool22);
                                        if (NewDynamicFetcher.pendingTempReqList.containsKey(str)) {
                                        }
                                        if (!NewDynamicFetcher.sBunchRequestStatus.containsKey(str)) {
                                        }
                                        NewDynamicFetcher.sBunchRequestStatus.put(str, bool22);
                                        DynamicSdk.getEngine().newFetchTemplates(NewDynamicFetcher.getGlobalConfigListener(str), false, str);
                                    }
                                } else {
                                    NewDynamicFetcher.internalRequestCommon(templateRequest);
                                ...
                                NewDynamicFetcher.tryLoadAssetsTemp(templateRequest, "requestDynamicConfigCommon onError,load assets failed again!!!", 300, 1000);
                            }
                            return null;
                        }
                    });
