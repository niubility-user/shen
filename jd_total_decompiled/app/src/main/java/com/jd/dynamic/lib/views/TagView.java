...
public class TagView extends ViewGroup implements IDarkChangeListener, IRecycleListener {
    ...
    /* JADX WARN: Removed duplicated region for block: B:184:0x0096 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:186:0x00f8 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
    ...
    */
    public void setAdapter() {
        ...
        int i2;
        ArrayList<TagViewAdapter.ItemViewHolder> arrayList;
        TagViewAdapter.ItemViewHolder itemViewHolder;
        JSONArray jSONArray = this.f2513g;
        if (jSONArray == null || jSONArray.length() < 1) {
            com.jd.dynamic.lib.utils.m.r(this, 8);
            this.v = false;
            return;
        }
        this.v = true;
        com.jd.dynamic.lib.utils.m.r(this, 0);
        if (!com.jd.dynamic.b.a.b.o().v() || ((((dynamicTemplateEngine = this.t) == null || !dynamicTemplateEngine.useTagViewOptimize) && !com.jd.dynamic.b.a.b.o().x()) || this.q == null)) {
            com.jd.dynamic.lib.utils.t.e("TagView setAdapter", "no use cache mAdapter = " + this.q);
            TagViewAdapter tagViewAdapter = this.q;
            if (tagViewAdapter == null) {
                this.q = new TagViewAdapter(getContext(), this);
                if (this.r == null) {
                    DataChangeObserver dataChangeObserver = new DataChangeObserver();
                    this.r = dataChangeObserver;
                    this.q.registerDataSetObserver(dataChangeObserver);
                }
                c();
            } else {
                tagViewAdapter.resetData(this.f2513g);
            }
            g();
            return;
        }
        com.jd.dynamic.lib.utils.t.e("TagView setAdapter", "use cache");
        this.q.updateData(this.f2513g);
        removeAllViews();
        HashMap hashMap = new HashMap();
        for (int i3 = 0; i3 < this.f2513g.length(); i3++) {
            ...
            if (hashMap.containsKey(Integer.valueOf(itemViewType))) {
                ...
                if (num != null) {
                    i2 = num.intValue();
                    arrayList = this.w.get(itemViewType);
                    if (!com.jd.dynamic.lib.utils.m.I(arrayList)) {
                        try {
                            itemViewHolder = arrayList.get(i2);
                        } catch (Exception unused) {
                        }
                        if (itemViewHolder == null) {
                            com.jd.dynamic.lib.utils.t.e("TagView setAdapter", "view=null reCreate = " + i3);
                            RecyclerView.ViewHolder viewHolder = this.q.getViewHolder(null, null, i3);
                            if (viewHolder instanceof TagViewAdapter.ItemViewHolder) {
                                viewHolder.itemView.setTag(R.id.dynamic_tag_view_item, com.jd.dynamic.b.c.a.b);
                                this.q.bindViewHolder(i3, viewHolder);
                                View view = viewHolder.itemView;
                                view.setTag(R.id.dynamic_item_view_visibility, Integer.valueOf(view.getVisibility()));
                                addView(viewHolder.itemView);
                                arrayList.add((TagViewAdapter.ItemViewHolder) viewHolder);
                            }
                        } else {
                            try {
                                View view2 = itemViewHolder.itemView;
                                view2.setVisibility(((Integer) view2.getTag(R.id.dynamic_item_view_visibility)).intValue());
                                itemViewHolder.setIsBind(false);
                                itemViewHolder.setIndex(i3);
                                this.q.bindViewHolder(i3, itemViewHolder);
                                addView(itemViewHolder.itemView);
                            } catch (Throwable unused2) {
                            }
                        }
                        hashMap.put(Integer.valueOf(itemViewType), Integer.valueOf(i2 + 1));
                    } else if (arrayList == null) {
                        arrayList = new ArrayList<>();
                        this.w.put(itemViewType, arrayList);
                    }
                    itemViewHolder = null;
                    if (itemViewHolder == null) {
                    }
                ...
                hashMap.put(Integer.valueOf(itemViewType), 0);
            }
            i2 = 0;
            arrayList = this.w.get(itemViewType);
            if (!com.jd.dynamic.lib.utils.m.I(arrayList)) {
