...
public final class DynamicContainer extends FrameLayout {
    ...
    public static final class AsyncCreateViewTask extends AsyncTask<DYContainerConfig, Void, View> {
        ...
        */
        public void onPostExecute(@Nullable View view) {
            IViewCreateListener iViewCreateListener;
            if (view == null) {
                IViewCreateListener iViewCreateListener2 = this.b;
                if (iViewCreateListener2 != null) {
                    iViewCreateListener2.onError(new DynamicException("dynamic view is null"));
                    return;
                }
                return;
            }
            long nanoTime = System.nanoTime();
            BaseFrameLayout baseFrameLayout = (BaseFrameLayout) view.findViewById(R.id.dynamic_root_view);
            if (baseFrameLayout != null) {
                baseFrameLayout.addLifecycleObserver();
            }
            t.e("createView", "addLifecycleObserver time = " + DynamicMtaUtil.getCurMicroseconds(System.nanoTime() - nanoTime));
            long nanoTime2 = System.nanoTime();
            if (this.a.isAsyncCreateView) {
                view.setVisibility(4);
            }
            if (view instanceof YogaLayout) {
                YogaLayout yogaLayout = (YogaLayout) view;
                if (yogaLayout.getYogaLayoutLayoutParams() != null) {
                    this.a.addView(view, new FrameLayout.LayoutParams((ViewGroup.MarginLayoutParams) yogaLayout.getYogaLayoutLayoutParams()));
                    t.e("createView", "addView time = " + DynamicMtaUtil.getCurMicroseconds(System.nanoTime() - nanoTime2));
                    iViewCreateListener = this.b;
                    if (iViewCreateListener == null) {
                        iViewCreateListener.onDynamicViewCreate();
                        return;
                    }
                    return;
                }
    ...
    public final void createViewWithNetwork(@Nullable final IViewCreateListener r8) {
        ...
        public final void load(@NotNull final IContainerCallback iContainerCallback) {
            ...
            /* JADX WARN: Code restructure failed: missing block: B:424:0x0117, code lost:
                if (r8 == null) goto L425;
             */
            /* JADX WARN: Code restructure failed: missing block: B:425:0x0119, code lost:
                kotlin.jvm.internal.Intrinsics.throwNpe();
             */
            /* JADX WARN: Code restructure failed: missing block: B:426:0x011c, code lost:
                ...
                r3 = r8;
             */
            /* JADX WARN: Code restructure failed: missing block: B:516:0x0272, code lost:
                if (r8 == null) goto L425;
             */
            /*
                Code decompiled incorrectly, please refer to instructions dump.
            */
            public final boolean load() {
                ...
                DYContainerConfig dYContainerConfig2 = this.containerConfig;
                DynamicMtaUtil.reportAPIEnter(module2, dYContainerConfig2 != null ? dYContainerConfig2.getTemplateId() : null, TrackLoadSettingsAtom.TYPE);
                ...
                if (o.N()) {
                    ...
                    DYContainerConfig dYContainerConfig7 = this.containerConfig;
                    if (com.jd.dynamic.b.e.a.b.w(module4, dYContainerConfig7 != null ? dYContainerConfig7.getTemplateId() : null)) {
                        DYContainerConfig dYContainerConfig8 = this.containerConfig;
                        String module5 = dYContainerConfig8 != null ? dYContainerConfig8.getModule() : null;
                        DYContainerConfig dYContainerConfig9 = this.containerConfig;
                        DynamicMtaUtil.startGetTemplate(module5, dYContainerConfig9 != null ? dYContainerConfig9.getTemplateId() : null, startMtaStat);
                        DYContainerConfig dYContainerConfig10 = this.containerConfig;
                        String module6 = dYContainerConfig10 != null ? dYContainerConfig10.getModule() : null;
                        DYContainerConfig dYContainerConfig11 = this.containerConfig;
                        b = a.b(module6, dYContainerConfig11 != null ? dYContainerConfig11.getTemplateId() : null, R2.attr.layout_constraintHeight, startMtaStat, false, 16, null);
                        if (m.F(b)) {
                            DYContainerConfig dYContainerConfig12 = this.containerConfig;
                            String templateId2 = dYContainerConfig12 != null ? dYContainerConfig12.getTemplateId() : null;
                            DYContainerConfig dYContainerConfig13 = this.containerConfig;
                            DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_LOCAL_BACKUP, "DynamicContainer.load() \u5f3a\u5236\u4f7f\u7528\u515c\u5e95", templateId2, dYContainerConfig13 != null ? dYContainerConfig13.getModule() : null, -1000, null, m.m(b, null));
                        }
                        return false;
                    }
                }
                DYContainerConfig dYContainerConfig14 = this.containerConfig;
                String module7 = dYContainerConfig14 != null ? dYContainerConfig14.getModule() : null;
                DYContainerConfig dYContainerConfig15 = this.containerConfig;
                if (!com.jd.dynamic.b.e.a.b.t(module7, dYContainerConfig15 != null ? dYContainerConfig15.getTemplateId() : null)) {
                    DYContainerConfig dYContainerConfig16 = this.containerConfig;
                    if (dYContainerConfig16 != null && (module = dYContainerConfig16.getModule()) != null) {
                        DynamicSdk.getDriver().prepare(module, "");
                    }
                    DYContainerConfig dYContainerConfig17 = this.containerConfig;
                    String module8 = dYContainerConfig17 != null ? dYContainerConfig17.getModule() : null;
                    DYContainerConfig dYContainerConfig18 = this.containerConfig;
                    if (com.jd.dynamic.b.e.a.b.w(module8, dYContainerConfig18 != null ? dYContainerConfig18.getTemplateId() : null)) {
                        DYContainerConfig dYContainerConfig19 = this.containerConfig;
                        String module9 = dYContainerConfig19 != null ? dYContainerConfig19.getModule() : null;
                        DYContainerConfig dYContainerConfig20 = this.containerConfig;
                        DynamicMtaUtil.startGetTemplate(module9, dYContainerConfig20 != null ? dYContainerConfig20.getTemplateId() : null, startMtaStat);
                        DYContainerConfig dYContainerConfig21 = this.containerConfig;
                        String module10 = dYContainerConfig21 != null ? dYContainerConfig21.getModule() : null;
                        DYContainerConfig dYContainerConfig22 = this.containerConfig;
                        b = a.b(module10, dYContainerConfig22 != null ? dYContainerConfig22.getTemplateId() : null, R2.attr.layout_constraintHeight, startMtaStat, false, 16, null);
                        if (m.F(b)) {
                            DYContainerConfig dYContainerConfig23 = this.containerConfig;
                            String templateId3 = dYContainerConfig23 != null ? dYContainerConfig23.getTemplateId() : null;
                            DYContainerConfig dYContainerConfig24 = this.containerConfig;
                            DynamicSdk.handException(IExceptionHandler.DynamicExceptionData.TYPE_LOCAL_BACKUP, "DynamicContainer.load() \u52a0\u8f7d\u515c\u5e95", templateId3, dYContainerConfig24 != null ? dYContainerConfig24.getModule() : null, -1009, null, m.m(b, null));
                        }
                    }
                    return false;
                }
                DYContainerConfig dYContainerConfig25 = this.containerConfig;
                String module11 = dYContainerConfig25 != null ? dYContainerConfig25.getModule() : null;
                DYContainerConfig dYContainerConfig26 = this.containerConfig;
                Template a = com.jd.dynamic.b.e.a.b.a(module11, dYContainerConfig26 != null ? dYContainerConfig26.getTemplateId() : null);
                if (a != null) {
                    DynamicMtaUtil.updateTemplate(startMtaStat, a);
                    String b2 = p.b(a.getDownloadUrl(), a.getDownloadFileName());
                    StringBuilder sb = new StringBuilder();
                    DYContainerConfig dYContainerConfig27 = this.containerConfig;
                    sb.append(com.jd.dynamic.b.e.a.b.m(dYContainerConfig27 != null ? dYContainerConfig27.getModule() : null));
                    sb.append(File.separator);
                    sb.append(a.businessCode);
                    File file = new File(sb.toString(), b2);
                    if (file.exists()) {
                        DYContainerConfig dYContainerConfig28 = this.containerConfig;
                        String module12 = dYContainerConfig28 != null ? dYContainerConfig28.getModule() : null;
                        DYContainerConfig dYContainerConfig29 = this.containerConfig;
                        DynamicMtaUtil.startGetTemplate(module12, dYContainerConfig29 != null ? dYContainerConfig29.getTemplateId() : null, startMtaStat);
                        String absolutePath = file.getAbsolutePath();
                        DYContainerConfig dYContainerConfig30 = this.containerConfig;
                        String templateId4 = dYContainerConfig30 != null ? dYContainerConfig30.getTemplateId() : null;
                        DYContainerConfig dYContainerConfig31 = this.containerConfig;
                        ResultEntity parseBinaryToResultEntity = NewDynamicXParser.parseBinaryToResultEntity(absolutePath, false, templateId4, dYContainerConfig31 != null ? dYContainerConfig31.getModule() : null, startMtaStat);
                        if (m.F(parseBinaryToResultEntity)) {
                            ViewNode viewNode = parseBinaryToResultEntity.viewNode;
                            Intrinsics.checkExpressionValueIsNotNull(viewNode, "entity.viewNode");
                            DynamicContainer dynamicContainer = this;
                            String str = startMtaStat;
                            ResultEntity resultEntity = parseBinaryToResultEntity;
                            String str2 = "diskCache";
                            dynamicContainer.showViewNode(viewNode, str, resultEntity, str2, nanoTime);
                            return true;
                        }
                    }
                }
