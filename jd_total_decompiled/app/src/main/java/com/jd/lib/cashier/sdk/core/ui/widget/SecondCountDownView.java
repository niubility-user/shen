...
public final class SecondCountDownView extends AbsCountdownView {
    ...
    public static final class b extends CountDownTimer {
        ...
        public void onFinish() {
            AbsCountdownView.a onCountdownListener = SecondCountDownView.this.getOnCountdownListener();
            if (onCountdownListener != null) {
                onCountdownListener.onFinish();
            }
            SecondCountDownView.this.n(null);
        }
        ...
        public void onTick(long j2) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                isShown = SecondCountDownView.this.isShown() && SecondCountDownView.this.isAttachedToWindow();
            } else {
                isShown = SecondCountDownView.this.isShown();
            }
            if (isShown) {
                SecondCountDownView.this.q(j2 / 1000);
            }
        }
    }

    public SecondCountDownView(@NotNull Context context) {
        super(context);
    }
    ...
    public AbsCountDownStatelessView c(@NotNull Context context) {
        return new SecondCountDownStatelessView(context);
    }
    ...
    public SecondCountDownView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public SecondCountDownView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i2) {
