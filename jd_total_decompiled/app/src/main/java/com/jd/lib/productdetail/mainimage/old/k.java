            ...
            if (actionMasked == 0) {
                ...
                if (actionMasked != 1) {
                    if (actionMasked == 2) {
                        ...
                        float rawY = motionEvent.getRawY();
                        k kVar = k.this;
                        float f2 = rawY - kVar.t;
                        kVar.s = motionEvent.getRawX();
                        k.this.t = motionEvent.getRawY();
                        if (Math.abs(rawX) > 8.0f || Math.abs(f2) > 8.0f) {
                            float x = k.this.a.getX() + rawX;
                            float y = k.this.a.getY() + f2;
                            k.this.I = Float.valueOf(x).intValue();
                            k.this.J = Float.valueOf(y).intValue();
                            k.this.a.setX(x);
                            k.this.a.setY(y);
                            k.this.H = true;
                        }
                ...
                if (!kVar2.H) {
                    ...
                    int i2 = kVar3.I;
                    if (i2 > kVar3.y) {
                        k.this.K.add(ObjectAnimator.ofFloat(kVar3.a, "X", i2, kVar3.x));
                    } else {
                        k.this.K.add(ObjectAnimator.ofFloat(kVar3.a, "X", i2, kVar3.w));
                    }
                    k kVar4 = k.this;
                    int i3 = kVar4.J;
                    int i4 = kVar4.u;
                    if (i3 < i4) {
                        k.this.K.add(ObjectAnimator.ofFloat(kVar4.a, "Y", i3, i4));
                    } else {
                        int i5 = kVar4.v;
                        if (i3 > i5) {
                            k.this.K.add(ObjectAnimator.ofFloat(kVar4.a, "Y", i3, i5));
                        }
                    }
                    AnimatorSet animatorSet = new AnimatorSet();
                    animatorSet.playTogether(k.this.K);
