    ...
    */
    private void p(View view) {
        ...
        if (view.isLayoutRequested()) {
            view.measure(AdapterView.getChildMeasureSpec(b(), getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), AdapterView.getChildMeasureSpec(a(), getPaddingTop() + getPaddingBottom() + layoutParams.topMargin + layoutParams.bottomMargin, layoutParams.height));
        } else {
        ...
        int absoluteGravity = Gravity.getAbsoluteGravity(i6, Build.VERSION.SDK_INT > 16 ? getLayoutDirection() : 0);
        int i7 = i6 & 112;
