...
import com.jd.lib.cashier.sdk.pay.aac.livedata.a.c;
...
public final class BaiTiaoPayPlanLiveData extends LiveData<c> {
    public final void a(@Nullable p requestParamsContainer, @Nullable BaiTiaoPayPlanResponse baiTiaoPayPlanResponse) {
        ...
        if (baiTiaoPayPlanResponse != null) {
            postValue(new c(requestParamsContainer, baiTiaoPayPlanResponse));
        }
    }
}
