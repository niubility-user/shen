...
public class SimpleRefreshLayout extends ViewGroup implements com.jd.lib.un.basewidget.widget.simple.c.f, NestedScrollingParent {
    ...
    public class j implements Runnable {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:114:0x0038, code lost:
            if (r0.n0(r0.y) != false) goto L115;
         */
        /* JADX WARN: Code restructure failed: missing block: B:122:0x005e, code lost:
            if (r0.n0(r0.y) != false) goto L123;
         */
        /* JADX WARN: Code restructure failed: missing block: B:124:0x006d, code lost:
            if (com.jd.lib.un.basewidget.widget.simple.SimpleRefreshLayout.this.d0 >= (-com.jd.lib.un.basewidget.widget.simple.SimpleRefreshLayout.this.f5739i)) goto L125;
         */
        /* JADX WARN: Code restructure failed: missing block: B:128:0x0085, code lost:
            if (com.jd.lib.un.basewidget.widget.simple.SimpleRefreshLayout.this.d0 > com.jd.lib.un.basewidget.widget.simple.SimpleRefreshLayout.this.f5737g) goto L129;
         */
        /* JADX WARN: Code restructure failed: missing block: B:139:0x00df, code lost:
            if (r2 > com.jd.lib.un.basewidget.widget.simple.SimpleRefreshLayout.this.f5737g) goto L144;
         */
        /* JADX WARN: Code restructure failed: missing block: B:143:0x00f0, code lost:
            if (r2 < (-com.jd.lib.un.basewidget.widget.simple.SimpleRefreshLayout.this.f5739i)) goto L144;
         */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public Runnable b() {
            if (SimpleRefreshLayout.this.C0.isFinishing) {
                return null;
            }
            if (SimpleRefreshLayout.this.d0 != 0) {
                if (!SimpleRefreshLayout.this.C0.isOpening) {
                    if (SimpleRefreshLayout.this.R && SimpleRefreshLayout.this.H) {
                        SimpleRefreshLayout simpleRefreshLayout = SimpleRefreshLayout.this;
                    }
                    int i2 = 0;
                    int i3 = SimpleRefreshLayout.this.d0;
                    int i4 = SimpleRefreshLayout.this.d0;
                    float f2 = this.f5767i;
                    while (true) {
                        if (i4 * i3 <= 0) {
                            break;
                        }
                        double d = f2;
                        i2++;
                        double pow = Math.pow(this.f5768j, (this.f5766h * i2) / 10);
                        Double.isNaN(d);
                        f2 = (float) (d * pow);
                        float f3 = ((this.f5766h * 1.0f) / 1000.0f) * f2;
                        if (Math.abs(f3) < 1.0f) {
                            if (SimpleRefreshLayout.this.C0.isOpening) {
                                com.jd.lib.un.basewidget.widget.simple.a.c cVar = SimpleRefreshLayout.this.C0;
                                com.jd.lib.un.basewidget.widget.simple.a.c cVar2 = com.jd.lib.un.basewidget.widget.simple.a.c.Refreshing;
                                if (cVar == cVar2) {
                                }
                                if (SimpleRefreshLayout.this.C0 != cVar2) {
                                }
                            }
                            return null;
                        }
            ...
            this.f5769k = AnimationUtils.currentAnimationTimeMillis();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:455:0x007f, code lost:
        if (r2.isFinishing == false) goto L458;
     */
    /* JADX WARN: Code restructure failed: missing block: B:457:0x0083, code lost:
        if (r2.isHeader == false) goto L458;
     */
    /* JADX WARN: Code restructure failed: missing block: B:463:0x0091, code lost:
        if (r2.isFinishing == false) goto L467;
     */
    /* JADX WARN: Code restructure failed: missing block: B:465:0x0095, code lost:
        if (r2.isFooter == false) goto L467;
     */
    /* JADX WARN: Code restructure failed: missing block: B:485:0x00c0, code lost:
        if (r6 != 3) goto L609;
     */
    ...
    */
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float f5 = f2 / f4;
        float f6 = f3 / f4;
        if ((actionMasked == 6 || actionMasked == 5) && this.k0) {
            this.h0 += f6 - this.j0;
        }
        this.i0 = f5;
        this.j0 = f6;
        ...
        if (isEnabled() && (n0(this.x) || n0(this.y) || this.J)) {
            if (this.H0) {
                com.jd.lib.un.basewidget.widget.simple.a.c cVar2 = this.C0;
                if (!cVar2.isOpening) {
                }
            ...
            if (!m0(actionMasked)) {
                com.jd.lib.un.basewidget.widget.simple.a.c cVar4 = this.C0;
                if (!cVar4.isFinishing && ((cVar4 != (cVar = com.jd.lib.un.basewidget.widget.simple.a.c.Loading) || !this.Q) && (cVar4 != com.jd.lib.un.basewidget.widget.simple.a.c.Refreshing || !this.P))) {
                    if (actionMasked != 0) {
                        if (actionMasked == 1) {
                            this.n0.addMovement(motionEvent);
                            this.n0.computeCurrentVelocity(1000, this.f5743m);
                            this.f5744n = (int) this.n0.getYVelocity();
                            C0(null);
                        } else {
                            if (actionMasked == 2) {
                                float f7 = f5 - this.g0;
                                float f8 = f6 - this.h0;
                                this.n0.addMovement(motionEvent);
                                if (!this.k0 && this.x0 != null && (this.K0 == 'v' || (Math.abs(f8) >= this.f5741k && Math.abs(f7) < Math.abs(f8)))) {
                                    this.K0 = 'v';
                                    if (f8 > 0.0f && (this.d0 < 0 || ((this.J || n0(this.x)) && this.x0.e()))) {
                                        this.k0 = true;
                                        this.h0 = f6 - this.f5741k;
                                    } else if (f8 < 0.0f && (this.d0 > 0 || ((this.J || n0(this.y)) && ((this.C0 == cVar && this.J0) || this.x0.i())))) {
                                        this.k0 = true;
                                        this.h0 = this.f5741k + f6;
                                    }
                                    if (this.k0) {
                                        f8 = f6 - this.h0;
                                        if (this.l0) {
                                ...
                                if (this.k0) {
                                    int i5 = ((int) f8) + this.f0;
                                    com.jd.lib.un.basewidget.widget.simple.a.c cVar5 = this.D0;
                                    if ((cVar5.isHeader && (i5 < 0 || this.e0 < 0)) || (cVar5.isFooter && (i5 > 0 || this.e0 > 0))) {
                                        this.e0 = i5;
                                        long eventTime = motionEvent.getEventTime();
                                        if (this.M0 == null) {
                                            MotionEvent obtain = MotionEvent.obtain(eventTime, eventTime, 0, this.g0 + f7, this.h0, 0);
                                            this.M0 = obtain;
                                            super.dispatchTouchEvent(obtain);
                                        }
                                        MotionEvent obtain2 = MotionEvent.obtain(eventTime, eventTime, 2, this.g0 + f7, this.h0 + i5, 0);
                                        super.dispatchTouchEvent(obtain2);
                                        if (this.J0 && f8 > this.f5741k && this.d0 < 0) {
                                            this.J0 = false;
                                        }
                                        if (i5 > 0 && ((this.J || n0(this.x)) && this.x0.e())) {
                                            this.j0 = f6;
                                            this.h0 = f6;
                                            this.f0 = 0;
                                            this.A0.d(com.jd.lib.un.basewidget.widget.simple.a.c.PullDownToRefresh);
                                        } else if (i5 >= 0 || !((this.J || n0(this.y)) && this.x0.i())) {
                                            i2 = i5;
                                        } else {
                                            this.j0 = f6;
                                            this.h0 = f6;
                                        ...
                                        com.jd.lib.un.basewidget.widget.simple.a.c cVar6 = this.D0;
                                        if ((cVar6.isHeader && i2 < 0) || (cVar6.isFooter && i2 > 0)) {
                                            if (this.d0 != 0) {
                                                p0(0.0f);
                                            }
                                            return true;
                                    ...
                                    p0(i5);
                                    return true;
                                } else if (this.J0 && f8 > this.f5741k && this.d0 < 0) {
                                    this.J0 = false;
                                }
                            }
                            return super.dispatchTouchEvent(motionEvent);
                        ...
                        if (motionEvent2 != null) {
                            ...
                            MotionEvent obtain3 = MotionEvent.obtain(eventTime2, eventTime2, actionMasked, this.g0, f6, 0);
                    ...
                    this.f0 = this.d0;
                    this.k0 = false;
                    this.l0 = super.dispatchTouchEvent(motionEvent);
    ...
    */
    protected void onFinishInflate() {
        ...
        while (true) {
            ...
            if (com.jd.lib.un.basewidget.widget.simple.e.b.c(childAt) && (c2 < 2 || i5 == 1)) {
                i6 = i5;
                c2 = 2;
            } else if (!(childAt instanceof com.jd.lib.un.basewidget.widget.simple.c.d) && c2 < 1) {
                c2 = i5 > 0 ? (char) 1 : (char) 0;
                i6 = i5;
            }
            i5++;
        }
        if (i6 >= 0) {
            this.x0 = new com.jd.lib.un.basewidget.widget.simple.wrapper.a(super.getChildAt(i6));
            if (i6 == 1) {
                if (childCount == 3) {
                    i3 = 0;
                } else {
            ...
            for (i4 = 0; i4 < childCount; i4++) {
                ...
                if (i4 != i3 && (i4 == i2 || i3 != -1 || this.v0 != null || !(childAt2 instanceof com.jd.lib.un.basewidget.widget.simple.c.c))) {
                    if (i4 == i2 || (i2 == -1 && (childAt2 instanceof com.jd.lib.un.basewidget.widget.simple.c.b))) {
                        this.y = this.y || !this.S;
                        this.w0 = childAt2 instanceof com.jd.lib.un.basewidget.widget.simple.c.b ? (com.jd.lib.un.basewidget.widget.simple.c.b) childAt2 : new RefreshFooterWrapper(childAt2);
                    }
                } else {
                    this.v0 = childAt2 instanceof com.jd.lib.un.basewidget.widget.simple.c.c ? (com.jd.lib.un.basewidget.widget.simple.c.c) childAt2 : new RefreshHeaderWrapper(childAt2);
                }
            }
        }
        i3 = -1;
    ...
    */
    protected void onMeasure(int i2, int i3) {
        int i4;
        com.jd.lib.un.basewidget.widget.simple.a.a aVar;
        int childCount = super.getChildCount();
        int i5 = 0;
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (dVar != null && dVar.getView() == childAt) {
                ...
                int i7 = this.f5737g;
                if (this.f5738h.ordinal() < com.jd.lib.un.basewidget.widget.simple.a.a.XmlLayoutUnNotify.ordinal()) {
                    int i8 = ((ViewGroup.MarginLayoutParams) layoutParams).height;
                    if (i8 > 0) {
                        i7 = i8 + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
                        com.jd.lib.un.basewidget.widget.simple.a.a aVar2 = this.f5738h;
                        com.jd.lib.un.basewidget.widget.simple.a.a aVar3 = com.jd.lib.un.basewidget.widget.simple.a.a.XmlExactUnNotify;
                        if (aVar2.canReplaceWith(aVar3)) {
                            this.f5737g = ((ViewGroup.MarginLayoutParams) layoutParams).height + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
                            this.f5738h = aVar3;
                        }
                    } else if (i8 == -2 && (this.v0.i() != com.jd.lib.un.basewidget.widget.simple.a.b.MATCH_LAYOUT || !this.f5738h.notified)) {
                        ...
                        if (measuredHeight > 0) {
                            if (measuredHeight != max) {
                                com.jd.lib.un.basewidget.widget.simple.a.a aVar4 = this.f5738h;
                                com.jd.lib.un.basewidget.widget.simple.a.a aVar5 = com.jd.lib.un.basewidget.widget.simple.a.a.XmlWrapUnNotify;
                                if (aVar4.canReplaceWith(aVar5)) {
                                    this.f5737g = measuredHeight + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
                                    this.f5738h = aVar5;
                                }
                            }
                            i7 = -1;
                ...
                if (this.v0.i() == com.jd.lib.un.basewidget.widget.simple.a.b.MATCH_LAYOUT) {
                    i7 = View.MeasureSpec.getSize(i3);
                } else if (this.v0.i() == com.jd.lib.un.basewidget.widget.simple.a.b.SCALE) {
                    i7 = Math.max(0, n0(this.x) ? this.d0 : 0);
                }
                if (i7 != -1) {
                    view.measure(childMeasureSpec, View.MeasureSpec.makeMeasureSpec(Math.max((i7 - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin) - ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, 0), 1073741824));
                }
                com.jd.lib.un.basewidget.widget.simple.a.a aVar6 = this.f5738h;
                if (!aVar6.notified) {
                    this.f5738h = aVar6.notified();
                    com.jd.lib.un.basewidget.widget.simple.c.d dVar2 = this.v0;
                    com.jd.lib.un.basewidget.widget.simple.c.e eVar = this.A0;
                    int i9 = this.f5737g;
                    dVar2.d(eVar, i9, (int) (this.t * i9));
                }
            }
            com.jd.lib.un.basewidget.widget.simple.c.d dVar3 = this.w0;
            if (dVar3 != null && dVar3.getView() == childAt) {
                ...
                int i10 = this.f5739i;
                if (this.f5740j.ordinal() < com.jd.lib.un.basewidget.widget.simple.a.a.XmlLayoutUnNotify.ordinal()) {
                    int i11 = ((ViewGroup.MarginLayoutParams) layoutParams2).height;
                    if (i11 > 0) {
                        i4 = ((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin + i11 + ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin;
                        com.jd.lib.un.basewidget.widget.simple.a.a aVar7 = this.f5740j;
                        com.jd.lib.un.basewidget.widget.simple.a.a aVar8 = com.jd.lib.un.basewidget.widget.simple.a.a.XmlExactUnNotify;
                        if (aVar7.canReplaceWith(aVar8)) {
                            this.f5739i = ((ViewGroup.MarginLayoutParams) layoutParams2).height + ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin;
                            this.f5740j = aVar8;
                        }
                    } else if (i11 == -2 && (this.w0.i() != com.jd.lib.un.basewidget.widget.simple.a.b.MATCH_LAYOUT || !this.f5740j.notified)) {
                        ...
                        if (measuredHeight2 > 0) {
                            if (measuredHeight2 != max2) {
                                com.jd.lib.un.basewidget.widget.simple.a.a aVar9 = this.f5740j;
                                com.jd.lib.un.basewidget.widget.simple.a.a aVar10 = com.jd.lib.un.basewidget.widget.simple.a.a.XmlWrapUnNotify;
                                if (aVar9.canReplaceWith(aVar10)) {
                                    this.f5739i = measuredHeight2 + ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin;
                                    this.f5740j = aVar10;
                                }
                            }
                            i4 = -1;
                    ...
                    if (this.w0.i() != com.jd.lib.un.basewidget.widget.simple.a.b.MATCH_LAYOUT) {
                        i4 = View.MeasureSpec.getSize(i3);
                    } else if (this.w0.i() == com.jd.lib.un.basewidget.widget.simple.a.b.SCALE) {
                        i4 = Math.max(0, n0(this.y) ? -this.d0 : 0);
                    }
                    if (i4 != -1) {
                        view2.measure(childMeasureSpec2, View.MeasureSpec.makeMeasureSpec(Math.max((i4 - ((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin) - ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin, 0), 1073741824));
                    }
                    aVar = this.f5740j;
                    if (!aVar.notified) {
                        this.f5740j = aVar.notified();
                        com.jd.lib.un.basewidget.widget.simple.c.d dVar4 = this.w0;
                        com.jd.lib.un.basewidget.widget.simple.c.e eVar2 = this.A0;
                        int i12 = this.f5739i;
                        dVar4.d(eVar2, i12, (int) (this.u * i12));
                    }
                }
                i4 = i10;
                if (this.w0.i() != com.jd.lib.un.basewidget.widget.simple.a.b.MATCH_LAYOUT) {
            ...
            com.jd.lib.un.basewidget.widget.simple.c.a aVar11 = this.x0;
            if (aVar11 != null && aVar11.getView() == childAt) {
