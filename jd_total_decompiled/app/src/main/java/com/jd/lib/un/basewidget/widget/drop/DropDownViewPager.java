        ...
        if (this.f5691m) {
            ...
            if (action != 0) {
                if (action != 1) {
                    if (action == 2) {
                        N(motionEvent);
                        int rawY = (int) (motionEvent.getRawY() - this.f5689k);
                        if (rawY <= 50 && this.f5686h != 1) {
                            return super.onTouchEvent(motionEvent);
                        }
                        if (this.f5687i != 1 && (rawY > 50 || this.f5686h == 1)) {
                ...
                if (O() < 500.0f && Math.abs(rawY2 - this.f5689k) <= DpiUtil.getHeight(getContext()) / 4) {
                    U(rawX, rawY2);
                } else if (this.f5692n != null) {
                    Q("2");
                }
            } else {
                this.f5688j = motionEvent.getRawX();
