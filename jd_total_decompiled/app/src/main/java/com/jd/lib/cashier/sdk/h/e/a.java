...
public class a {
    ...
    */
    public void U(FragmentActivity fragmentActivity, String str, String str2, String str3, String str4, String str5, String str6, String str7) {
        String str8;
        this.b.clear();
        this.b.put("clerk", str2);
        ...
        this.b.put("newuser", str6);
        if (this.f3526c == null) {
            this.f3526c = new com.jd.lib.cashier.sdk.b.b.a();
        }
        this.f3526c.clear();
        this.f3526c.put("event_type", "2");
        this.f3526c.put("recom_info", str5);
        ...
        if (g0.a(fragmentActivity)) {
            CashierPayViewModel cashierPayViewModel = (CashierPayViewModel) ViewModelProviders.of(fragmentActivity).get(CashierPayViewModel.class);
            if (cashierPayViewModel.b().K != null) {
                str8 = cashierPayViewModel.b().K.checkIsNewUser();
                this.b.put("isnew", str8);
                String b2 = o.b(this.b);
                this.f3527e.clear();
                if (str7 == null) {
                    str7 = "";
                }
                this.f3527e.put("touchstone_expids", str7);
                com.jd.lib.cashier.sdk.d.e.a.k(fragmentActivity, 1000, "JDCashierNew_Home_SettlementBackExpo", "", b, b2, this.f3527e);
            }
        }
        str8 = "";
        this.b.put("isnew", str8);
        String b22 = o.b(this.b);
        this.f3527e.clear();
        if (str7 == null) {
        }
        this.f3527e.put("touchstone_expids", str7);
        com.jd.lib.cashier.sdk.d.e.a.k(fragmentActivity, 1000, "JDCashierNew_Home_SettlementBackExpo", "", b, b22, this.f3527e);
    }
