...
import com.jd.lib.cashier.sdk.core.ui.widget.CashierACountDownView;
...
public final class CashierPayHeaderImpl implements Object, Observer<r>, com.jd.lib.cashier.sdk.d.d.a, com.jd.lib.cashier.sdk.core.aac.e, Observer {
    ...
    */
    private final void E(r httpEvent) {
        Long l2;
        long longValue;
        ...
        try {
            ...
            longRef.element = Float.parseFloat(r4) * ((float) 1000);
            if (TextUtils.isEmpty(topFloor.triggerCountdownTime)) {
                Long l3 = com.jd.lib.cashier.sdk.d.b.a.b;
                Intrinsics.checkExpressionValueIsNotNull(l3, "CashierConstant.CONSTANT_VALUE_10_MIN");
                ...
                try {
                    ...
                    l2 = com.jd.lib.cashier.sdk.d.b.a.b;
                }
            ...
            if (j2 > longValue * 1000) {
                ...
                String str2 = topFloor.subsidyCountDownTip;
                List split$default = (str2 == null || replace$default == null) ? null : StringsKt__StringsKt.split$default((CharSequence) replace$default, new String[]{DYConstants.DY_REGEX_VERTICAL_LINE}, false, 0, 6, (Object) null);
                ViewGroup viewGroup = this.mCountDownViewContainer;
                if (viewGroup != null) {
                    viewGroup.removeAllViews();
                }
                if (!(split$default == null || split$default.isEmpty())) {
                    TextView r = r((String) split$default.get(0), false);
                ...
                MSCountDownView mSCountDownView = new MSCountDownView(this.mCashierPayActivity);
                this.mCountDownView = mSCountDownView;
                if (mSCountDownView != null) {
                    mSCountDownView.n(new e(cashierPopConfig, longRef));
                    mSCountDownView.m(longRef.element);
                }
                ...
                if (!(split$default == null || split$default.isEmpty()) && split$default.size() >= 2) {
                    TextView s = s((String) split$default.get(1), false);
                    this.mSuffixTextView = s;
                    ViewGroup viewGroup4 = this.mCountDownViewContainer;
                    if (viewGroup4 != null) {
                        viewGroup4.addView(s);
                    }
                }
    ...
    */
    private final void q() {
        ...
        try {
            if (!TextUtils.equals("2", m.f().j()) && !TextUtils.equals("3", m.f().j())) {
                ...
                TextView textView6 = this.mTvPayPriceUnit;
                if (textView6 != null) {
                    textView6.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_F2270C));
                }
                TextView textView7 = this.mTvPriceExtend;
                if (textView7 != null) {
                    textView7.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_F2270C));
                }
                textView = this.mTvPriceSubTitle;
                if (textView != null) {
                    textView.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_F2270C));
                }
                textView2 = this.mGradualTitle;
                if (textView2 != null) {
                    textView2.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_8C8C8C));
                }
                textView3 = this.mChargeNumberView;
                if (textView3 != null) {
                    textView3.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_8C8C8C));
                }
                view = this.mRootView;
                if (view != null) {
                    view.setBackgroundColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_F5F5F5, JDDarkUtil.COLOR_141212));
                }
                textView4 = this.mPrefixTextView;
                if (textView4 != null) {
                    textView4.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_1A1A1A));
                }
                textView5 = this.mSuffixTextView;
                if (textView5 != null) {
                    textView5.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_1A1A1A));
                }
                absCountdownView = this.mCountDownView;
                if (absCountdownView == null) {
                    absCountdownView.onChangeSkin();
                    return;
                }
            ...
            RollingDigitTextView rollingDigitTextView2 = this.mPayPriceView;
            if (rollingDigitTextView2 != null) {
                rollingDigitTextView2.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_1A1A1A));
            }
            TextView textView8 = this.mTvPayPriceUnit;
            if (textView8 != null) {
                textView8.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_1A1A1A));
            }
            TextView textView9 = this.mTvPriceExtend;
            if (textView9 != null) {
                textView9.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_1A1A1A));
            }
            textView = this.mTvPriceSubTitle;
            if (textView != null) {
            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final void v(r httpEvent) {
        Long l2;
        long longValue;
        String replace$default;
        TopFloor topFloor = httpEvent.a;
        ...
        try {
            ...
            if (j2 > longValue * 1000) {
                ...
                if (!(split$default == null || split$default.isEmpty())) {
                    TextView r = r((String) split$default.get(0), true);
                    this.mPrefixTextView = r;
                    ViewGroup viewGroup2 = this.mCountDownViewContainer;
                    if (viewGroup2 != null) {
                        viewGroup2.addView(r);
                ...
                CashierACountDownView cashierACountDownView = new CashierACountDownView(this.mCashierPayActivity);
                this.mCountDownView = cashierACountDownView;
                if (cashierACountDownView != null) {
                    cashierACountDownView.n(new a(cashierPopConfig, longRef));
                    cashierACountDownView.m(longRef.element);
                }
                ViewGroup viewGroup3 = this.mCountDownViewContainer;
                if (viewGroup3 != null) {
                    viewGroup3.addView(this.mCountDownView);
                ...
                if (!(split$default == null || split$default.isEmpty()) && split$default.size() >= 2) {
                    TextView s = s((String) split$default.get(1), true);
                    this.mSuffixTextView = s;
                    ViewGroup viewGroup4 = this.mCountDownViewContainer;
                    if (viewGroup4 != null) {
                        viewGroup4.addView(s);
