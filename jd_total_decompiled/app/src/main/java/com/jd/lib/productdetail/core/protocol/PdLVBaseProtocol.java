    ...
    public HttpSetting request() {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x000d: CONSTRUCTOR (r1v1 'onAllListener' com.jingdong.jdsdk.network.toolbox.HttpGroup$OnAllListener) = 
              (r3v0 'this' com.jd.lib.productdetail.core.protocol.PdLVBaseProtocol A[IMMUTABLE_TYPE, THIS])
              (r0 I:com.jingdong.jdsdk.network.toolbox.ExceptionReporter A[DONT_GENERATE, DONT_INLINE, REMOVE])
             A[DECLARE_VAR, MD:(com.jd.lib.productdetail.core.protocol.PdLVBaseProtocol, com.jingdong.jdsdk.network.toolbox.ExceptionReporter):void (m)] (LINE:3) call: com.jd.lib.productdetail.core.protocol.PdLVBaseProtocol.1.<init>(com.jd.lib.productdetail.core.protocol.PdLVBaseProtocol, com.jingdong.jdsdk.network.toolbox.ExceptionReporter):void type: CONSTRUCTOR in method: com.jd.lib.productdetail.core.protocol.PdLVBaseProtocol.request():com.jingdong.jdsdk.network.toolbox.HttpSetting, file: classes15.dex
        ...
        /*
            ...
            r1 = 0
            r0.<init>(r1)
            com.jd.lib.productdetail.core.protocol.PdLVBaseProtocol$1 r1 = new com.jd.lib.productdetail.core.protocol.PdLVBaseProtocol$1
            r1.<init>()
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jd.lib.productdetail.core.protocol.PdLVBaseProtocol.request():com.jingdong.jdsdk.network.toolbox.HttpSetting");
    }
