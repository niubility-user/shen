...
import com.jd.lib.productdetail.core.entitys.giftshopping.PdTrickContentEntity;
import java.util.List;

/* loaded from: classes15.dex */
public class PdGiftShopEntity implements Parcelable {
    public static final Parcelable.Creator<PdGiftShopEntity> CREATOR = new Parcelable.Creator<PdGiftShopEntity>() { // from class: com.jd.lib.productdetail.core.entitys.warebusiness.PdGiftShopEntity.1
    ...
    public static class Buttons implements Parcelable {
        public static final Parcelable.Creator<Buttons> CREATOR = new Parcelable.Creator<Buttons>() { // from class: com.jd.lib.productdetail.core.entitys.warebusiness.PdGiftShopEntity.Buttons.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
