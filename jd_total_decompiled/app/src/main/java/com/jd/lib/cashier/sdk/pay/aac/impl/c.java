...
public class c implements com.jd.lib.cashier.sdk.d.d.a {
    ...
    /* JADX WARN: Removed duplicated region for block: B:49:0x001b A[Catch: Exception -> 0x002b, TryCatch #0 {Exception -> 0x002b, blocks: (B:41:0x0001, B:43:0x000b, B:49:0x001b, B:50:0x0024), top: B:55:0x0001 }] */
    /* JADX WARN: Removed duplicated region for block: B:50:0x0024 A[Catch: Exception -> 0x002b, TRY_LEAVE, TryCatch #0 {Exception -> 0x002b, blocks: (B:41:0x0001, B:43:0x000b, B:49:0x001b, B:50:0x0024), top: B:55:0x0001 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private int a(Payment payment) {
        boolean z;
        try {
            if (!"5".equals(payment.status) && !"1".equals(payment.status)) {
                z = false;
                if (!z) {
                    return f(payment.availableBalance, payment.investorDoc);
                }
                return h(payment.regulatorCantUseDesc);
            }
            z = true;
            if (!z) {
            }
