...
final class e extends RecyclerView.ViewHolder {
    ...
    private final View f3867e;

    /* renamed from: f  reason: collision with root package name */
    private final CheckBox f3868f;
    @NotNull

    /* renamed from: g  reason: collision with root package name */
    private final View f3869g;
    ...
    public e(@NotNull View view) {
        ...
        this.f3866c = (TextView) findViewById3;
        ...
        this.f3868f = (CheckBox) findViewById6;
    }
    ...
    public final void f() {
        ...
        this.f3866c.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_CCCCCC));
        this.d.setTextColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_CCCCCC));
        this.f3867e.setBackgroundColor(JDDarkUtil.getDarkColor(JDDarkUtil.COLOR_F2F2F2));
        this.f3868f.setBackgroundResource(JDDarkUtil.isDarkMode() ? R.drawable.lib_cashier_sdk_button_i_new_03_dark : R.drawable.lib_cashier_sdk_button_i_new_03);
    }

    public final void g() {
        if (Build.VERSION.SDK_INT >= 16) {
            this.f3869g.setImportantForAccessibility(2);
        } else {
            this.f3869g.setContentDescription(null);
        }
    }

    public final void h(int i2, int i3) {
        this.f3867e.setVisibility(i2 == i3 + (-1) ? 8 : 0);
    }
}
