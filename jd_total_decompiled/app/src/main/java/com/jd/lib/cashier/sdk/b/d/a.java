...
public class a {
    ...
    */
    public static void l(CashierPayActivity cashierPayActivity, CashierCommonPopConfig cashierCommonPopConfig, String str, String str2, String str3) {
        String str4;
        String str5;
        String str6;
        ...
        PopBusinessMap popBusinessMap = cashierCommonPopConfig.businessMap;
        if (popBusinessMap == null || (prismResult = popBusinessMap.abTest) == null) {
            str4 = "";
        } else {
            str4 = !TextUtils.isEmpty(prismResult.touchstone_expids) ? cashierCommonPopConfig.businessMap.abTest.touchstone_expids : "";
        }
        com.jd.lib.cashier.sdk.h.c.a b2 = ((CashierPayViewModel) ViewModelProviders.of(cashierPayActivity).get(CashierPayViewModel.class)).b();
        String str11 = cashierCommonPopConfig.highLightString;
        PopBusinessMap popBusinessMap2 = cashierCommonPopConfig.businessMap;
        String str12 = popBusinessMap2 != null ? popBusinessMap2.leaveto : "";
        String str13 = popBusinessMap2 != null ? popBusinessMap2.popType : "";
        String str14 = popBusinessMap2 != null ? popBusinessMap2.touchstoneExpIds : "";
        String str15 = popBusinessMap2 != null ? popBusinessMap2.recomInfo : "";
        String str16 = popBusinessMap2 != null ? popBusinessMap2.newUserGeneralized : "";
        String str17 = b2.f3511e;
        if (!TextUtils.isEmpty(cashierCommonPopConfig.message) && cashierCommonPopConfig.message.contains("{$cancelTime}")) {
            String[] split = cashierCommonPopConfig.message.replace("{$cancelTime}", "|").split(DYConstants.DY_REGEX_VERTICAL_LINE);
            if (split.length >= 2) {
                str6 = split[0];
                str5 = split[1];
            ...
            MSCountDownView mSCountDownView = null;
            View inflate = LayoutInflater.from(cashierPayActivity).inflate(R.layout.lib_cashier_sdk_dialog_exit_cashier_custom_layout, (ViewGroup) null, false);
            TextView textView = (TextView) inflate.findViewById(R.id.lib_cashier_dialog_exit_cashier_message_first);
            linearLayout = (LinearLayout) inflate.findViewById(R.id.lib_cashier_dialog_exit_cashier_countdown_container);
            TextView textView2 = (TextView) inflate.findViewById(R.id.lib_cashier_dialog_exit_cashier_message_second);
            TextView textView3 = (TextView) inflate.findViewById(R.id.lib_cashier_dialog_exit_cashier_message_third);
            cashierPayEntity = b2.K;
                    ...
                    try {
                        if (!TextUtils.isEmpty(topFloor.countdownTime)) {
                            ...
                            try {
                                str8 = str17;
                                try {
                                    long parseFloat = (Float.parseFloat(topFloor.countdownTime) * 1000) - (SystemClock.elapsedRealtime() - b2.J);
                                    if (parseFloat <= 0) {
                                        j0.b(linearLayout);
                                    }
                                    ...
                                    MSCountDownView mSCountDownView2 = new MSCountDownView(cashierPayActivity);
                                    try {
                                        linearLayout.addView(mSCountDownView2);
                                        mSCountDownView2.m(parseFloat);
                                        mSCountDownView2.o();
                                        mSCountDownView = mSCountDownView2;
                                    } catch (Exception e2) {
                                        e = e2;
                                        mSCountDownView = mSCountDownView2;
                                        e.printStackTrace();
                                        MSCountDownView mSCountDownView3 = mSCountDownView;
                                        textView.setText(!TextUtils.isEmpty(str7) ? "" : str7);
                                        if (TextUtils.isEmpty(str5)) {
                                        }
                                        textView2.setText(str5);
                                        textView3.setText(TextUtils.isEmpty(cashierCommonPopConfig.messageTwo) ? "" : cashierCommonPopConfig.messageTwo);
                                        if (!y.p()) {
                                        }
                                        i2 = com.jd.lib.cashier.sdk.core.utils.j.i(cashierPayActivity, cashierCommonPopConfig.title, "", inflate, 1, cashierCommonPopConfig.cancelBtn, cashierCommonPopConfig.confirmBtn);
                                        if (i2 == null) {
                                        }
                                        com.jd.lib.cashier.sdk.h.e.a.d().U(cashierPayActivity, str10, str9, str13, str14, str15, str16, str4);
                                    }
                                } catch (Exception e3) {
                                    e = e3;
                                    e.printStackTrace();
                                    MSCountDownView mSCountDownView32 = mSCountDownView;
                                    textView.setText(!TextUtils.isEmpty(str7) ? "" : str7);
                                    if (TextUtils.isEmpty(str5)) {
                                    }
                                    textView2.setText(str5);
            ...
            MSCountDownView mSCountDownView322 = mSCountDownView;
            textView.setText(!TextUtils.isEmpty(str7) ? "" : str7);
            if (TextUtils.isEmpty(str5)) {
                str5 = "";
            }
            ...
            textView3.setText(TextUtils.isEmpty(cashierCommonPopConfig.messageTwo) ? "" : cashierCommonPopConfig.messageTwo);
            if (!y.p()) {
                textView.setTextColor(Color.parseColor(JDDarkUtil.COLOR_ECECEC));
                textView2.setTextColor(Color.parseColor(JDDarkUtil.COLOR_ECECEC));
                textView3.setTextColor(Color.parseColor(JDDarkUtil.COLOR_ECECEC));
            } else {
                textView.setTextColor(Color.parseColor(JDDarkUtil.COLOR_1A1A1A));
                textView2.setTextColor(Color.parseColor(JDDarkUtil.COLOR_1A1A1A));
                textView3.setTextColor(Color.parseColor(JDDarkUtil.COLOR_1A1A1A));
            }
            i2 = com.jd.lib.cashier.sdk.core.utils.j.i(cashierPayActivity, cashierCommonPopConfig.title, "", inflate, 1, cashierCommonPopConfig.cancelBtn, cashierCommonPopConfig.confirmBtn);
            if (i2 == null) {
                i2.setCancelable(false);
                if (mSCountDownView322 != null) {
                    mSCountDownView322.n(new q(i2));
                }
                str10 = str8;
                com.jd.lib.cashier.sdk.core.utils.j.k(i2, new r(mSCountDownView322, i2, cashierPayActivity, str8, str, str13, str11, str14, str15, str16, str4));
                str9 = str11;
                com.jd.lib.cashier.sdk.core.utils.j.l(i2, new s(mSCountDownView322, i2, cashierPayActivity, str10, str, str2, str3, str11, str13, str14, str15, str16, str12, str4, cashierCommonPopConfig));
                i2.show();
            } else {
                str9 = str11;
                str10 = str8;
        ...
        str5 = "";
        str6 = str5;
        MSCountDownView mSCountDownView4 = null;
        View inflate2 = LayoutInflater.from(cashierPayActivity).inflate(R.layout.lib_cashier_sdk_dialog_exit_cashier_custom_layout, (ViewGroup) null, false);
        TextView textView4 = (TextView) inflate2.findViewById(R.id.lib_cashier_dialog_exit_cashier_message_first);
        linearLayout = (LinearLayout) inflate2.findViewById(R.id.lib_cashier_dialog_exit_cashier_countdown_container);
        TextView textView22 = (TextView) inflate2.findViewById(R.id.lib_cashier_dialog_exit_cashier_message_second);
        TextView textView32 = (TextView) inflate2.findViewById(R.id.lib_cashier_dialog_exit_cashier_message_third);
        cashierPayEntity = b2.K;
        ...
        str8 = str17;
        j0.b(linearLayout);
        MSCountDownView mSCountDownView3222 = mSCountDownView4;
        textView4.setText(!TextUtils.isEmpty(str7) ? "" : str7);
        if (TextUtils.isEmpty(str5)) {
        }
        textView22.setText(str5);
        textView32.setText(TextUtils.isEmpty(cashierCommonPopConfig.messageTwo) ? "" : cashierCommonPopConfig.messageTwo);
        if (!y.p()) {
        }
        i2 = com.jd.lib.cashier.sdk.core.utils.j.i(cashierPayActivity, cashierCommonPopConfig.title, "", inflate2, 1, cashierCommonPopConfig.cancelBtn, cashierCommonPopConfig.confirmBtn);
        if (i2 == null) {
        }
        com.jd.lib.cashier.sdk.h.e.a.d().U(cashierPayActivity, str10, str9, str13, str14, str15, str16, str4);
    }
