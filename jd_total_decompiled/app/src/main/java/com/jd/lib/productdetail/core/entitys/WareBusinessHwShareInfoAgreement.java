...
public class WareBusinessHwShareInfoAgreement implements Parcelable {
    public static final Parcelable.Creator<WareBusinessHwShareInfoAgreement> CREATOR = new Parcelable.Creator<WareBusinessHwShareInfoAgreement>() { // from class: com.jd.lib.productdetail.core.entitys.WareBusinessHwShareInfoAgreement.1
