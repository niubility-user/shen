...
public final class XBridge implements com.jd.xbridge.base.d {
    ...
    */
    public final void _callNative(@Nullable String obj) {
        a a;
        if (obj != null) {
            try {
                a = com.jd.xbridge.b.a(new JSONObject(obj));
            } catch (JSONException e2) {
                j(e2);
                a("CallNative, cannot convert " + obj + " to json, e: " + e2.getMessage());
            }
            if (a == null) {
                String e3 = a.e();
                String a2 = a.a();
                Object d2 = a.d();
                String c2 = a.c();
                i("_callNative -> plugin:" + e3 + ", action:" + a2 + ", callbackId:" + c2 + ", params:" + d2);
                try {
                    IBridgePlugin g2 = g(e3);
                    if (g2 == null) {
                        i("_callNative -> No native plugin found can process this calling of " + e3);
                        o(this, c2, "-2", null, "Target plugin not found.", false, 16, null);
                        return;
                    }
                    if (g2.execute(this.webView, a2, d2 != null ? d2.toString() : null, new c(c2))) {
                        return;
                    }
                    i("_callNative -> Native plugin returns false for action = " + a2);
                    o(this, c2, "-2", "", "Target action not found.", false, 16, null);
                    return;
                } catch (Exception e4) {
                    o(this, c2, "1", null, "Execute plugin throws., e: " + e4.getMessage(), false, 16, null);
                    j(e4);
                    a("CallNative Error, err = " + e4.getMessage());
                    return;
                }
            }
            return;
    ...
    /* JADX WARN: Removed duplicated region for block: B:64:0x004c A[Catch: Exception -> 0x0047, TryCatch #0 {Exception -> 0x0047, blocks: (B:56:0x003e, B:64:0x004c, B:65:0x0057, B:67:0x005d, B:69:0x007d, B:71:0x008a), top: B:75:0x003e }] */
    /* JADX WARN: Removed duplicated region for block: B:67:0x005d A[Catch: Exception -> 0x0047, TryCatch #0 {Exception -> 0x0047, blocks: (B:56:0x003e, B:64:0x004c, B:65:0x0057, B:67:0x005d, B:69:0x007d, B:71:0x008a), top: B:75:0x003e }] */
    /* JADX WARN: Removed duplicated region for block: B:69:0x007d A[Catch: Exception -> 0x0047, TryCatch #0 {Exception -> 0x0047, blocks: (B:56:0x003e, B:64:0x004c, B:65:0x0057, B:67:0x005d, B:69:0x007d, B:71:0x008a), top: B:75:0x003e }] */
    @Deprecated(message = "Deprecated method, do not use.")
    @JavascriptInterface
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void callNative(@Nullable String pluginName, @Nullable String action, @Nullable String params, @Nullable String callbackName, @Nullable String callbackId) {
        boolean z;
        IBridgePlugin g2;
        i("callNative(Old) -> pluginName:" + pluginName + ", action:" + action + ", callbackName:" + callbackName + ", callbackId:" + callbackId + ", params:" + params);
        if (action != null) {
            try {
                if (action.length() != 0) {
                    z = false;
                    if (z) {
                        b(callbackName, callbackId, "-2", null, "Target action not found.");
                    }
                    g2 = g(pluginName);
                    if (g2 != null) {
                        i("_callNative -> No native plugin found can process this calling of " + pluginName);
                        b(callbackName, callbackId, "-2", null, "Target plugin not found.");
                        return;
                    } else if (g2.execute(this.webView, action, params, new e(callbackName, callbackId))) {
                        return;
                    } else {
                        i("_callNative -> Native plugin returns false for action = " + action);
                        b(callbackName, callbackId, "-2", "", "Target action not found.");
                        return;
                    }
                }
            } catch (Exception e2) {
                b(callbackName, callbackId, "1", null, "Execute plugin throws., e: " + e2.getMessage());
                j(e2);
                a("CallNative Error, err = " + e2.getMessage());
                return;
            }
        }
        z = true;
