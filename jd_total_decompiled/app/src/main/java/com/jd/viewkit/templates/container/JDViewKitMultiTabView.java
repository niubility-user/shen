...
public class JDViewKitMultiTabView extends JDViewKitBaseLayout<JDViewKitVirtualView> {
    ...
    */
    public static String getMultiMabLoadStr(JDViewKitFloorModel jDViewKitFloorModel) {
        ...
        String str3;
        String str4;
        if (jDViewKitFloorModel != null && jDViewKitFloorModel.getRootVirtualView() != null && jDViewKitFloorModel.getRootVirtualView().getServiceModel() != null && jDViewKitFloorModel.getRootVirtualView().getServiceModel().getEventService() != null) {
            try {
                str = jDViewKitFloorModel.getRootVirtualView().getServiceModel().getEventService().getI18nString();
            } catch (Throwable unused) {
            }
            if (StringTool.isNotEmpty(str)) {
                if (str.equals("th")) {
                    str2 = "\u0e44\u0e21\u0e48\u0e1e\u0e1a\u0e02\u0e49\u0e2d\u0e21\u0e39\u0e25\u0e43\u0e19\u0e02\u0e13\u0e30\u0e19\u0e35\u0e49";
                    str3 = "\u0e01\u0e32\u0e23\u0e42\u0e2b\u0e25\u0e14\u0e25\u0e49\u0e21\u0e40\u0e2b\u0e25\u0e27 \u0e42\u0e1b\u0e23\u0e14\u0e25\u0e2d\u0e07\u0e43\u0e2b\u0e21\u0e48\u0e2d\u0e35\u0e01\u0e04\u0e23\u0e31\u0e49\u0e07";
                    str4 = "\u0e01\u0e33\u0e25\u0e31\u0e07\u0e42\u0e2b\u0e25\u0e14";
                    ...
                    str2 = "Tidak ada data untuk saat ini.";
                    str3 = "Mamuat gagal, Silakan klik untuk mengulang.";
                    str4 = "Memuat\u2026";
                }
                return "{\n  \"dslMap\": {\n    \"multiTabLoadingDsl\": {\n      \"type\": \"view\",\n      \"children\": [\n        {\n          \"type\": \"text\",\n          \"style\": {\n            \"textAlign\":\"center\",\n            \"verticalAlign\":\"center\",\n            \"bold\":0,\n            \"frame\": \"0,0,1125,168\",\n            \"lines\": 0,\n            \"fontSize\": 42,\n            \"color\": \"#9b9b9b\",\n            \"bgColor\": \"#FFFFFF\"\n          },\n          \"valueRefer\": \"$msg\"\n        }\n      ],\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    },\n    \"multiTabFailDsl\": {\n      \"type\": \"view\",\n      \"event\": [\n        {\n          \"type\": \"click\",\n          \"eventKey\": \"666666666\",\n          \"action\": \"MultiTabFail_ActionId\",\n          \"param\": {\n            \"valueRefer\": \"\"\n          }\n        }\n      ],\n      \"children\": [\n        {\n          \"type\": \"text\",\n          \"style\": {\n            \"textAlign\":\"center\",\n            \"verticalAlign\":\"center\",\n            \"bold\":0,\n            \"frame\": \"0,0,1125,168\",\n            \"lines\": 0,\n            \"fontSize\": 42,\n            \"color\": \"#9b9b9b\",\n            \"bgColor\": \"#FFFFFF\"\n          },\n          \"valueRefer\": \"$msg\"\n        }\n      ],\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    },\n    \"multiTabFlatView\":{\n      \"id\": \"flatId\",\n      \"type\": \"flatView\",\n      \"valueRefer\": \"$flatData\",\n      \"dslId\":\"multiTabFlatView\",\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    }\n  },\n  \"loadingFloor\":{\n    \"dslData\": {\n      \"flatData\": [\n        {\n          \"dslId\": \"multiTabLoadingDsl\",\n          \"msg\": \"&loadingMsg&\"\n        }\n      ]\n    },\n    \"dslRoot\": {\n      \"id\": \"flatId\",\n      \"type\": \"flatView\",\n      \"valueRefer\": \"$flatData\",\n      \"dslId\":\"multiTabFlatView\",\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    }\n  },\n  \"noMoreFloor\":{\n    \"dslData\": {\n      \"flatData\": [\n        {\n          \"dslId\": \"multiTabLoadingDsl\",\n          \"msg\": \"&noMoreMsg&\"\n        }\n      ]\n    },\n    \"dslRoot\": {\n      \"id\": \"flatId\",\n      \"type\": \"flatView\",\n      \"valueRefer\": \"$flatData\",\n      \"dslId\":\"multiTabFlatView\",\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    }\n  },\n  \"errorFloor\":{\n    \"dslData\": {\n      \"flatData\": [\n        {\n          \"jumpMap\": {\n            \"666666666\": {\n              \"eventId\": \"MultiTabFail_EventId\"\n            }\n          },\n\n          \"dslId\": \"multiTabFailDsl\",\n          \"msg\": \"&errorMsg&\"\n        }\n      ]\n    },\n    \"dslRoot\": {\n      \"id\": \"flatId\",\n      \"type\": \"flatView\",\n      \"valueRefer\": \"$flatData\",\n      \"dslId\":\"multiTabFlatView\",\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    }\n  }\n}".replace("&loadingMsg&", str4).replace("&noMoreMsg&", str2).replace("&errorMsg&", str3);
            }
            str2 = "There is no data available at the moment.";
            str3 = "Loading failed, please try again";
            str4 = "Loading";
            return "{\n  \"dslMap\": {\n    \"multiTabLoadingDsl\": {\n      \"type\": \"view\",\n      \"children\": [\n        {\n          \"type\": \"text\",\n          \"style\": {\n            \"textAlign\":\"center\",\n            \"verticalAlign\":\"center\",\n            \"bold\":0,\n            \"frame\": \"0,0,1125,168\",\n            \"lines\": 0,\n            \"fontSize\": 42,\n            \"color\": \"#9b9b9b\",\n            \"bgColor\": \"#FFFFFF\"\n          },\n          \"valueRefer\": \"$msg\"\n        }\n      ],\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    },\n    \"multiTabFailDsl\": {\n      \"type\": \"view\",\n      \"event\": [\n        {\n          \"type\": \"click\",\n          \"eventKey\": \"666666666\",\n          \"action\": \"MultiTabFail_ActionId\",\n          \"param\": {\n            \"valueRefer\": \"\"\n          }\n        }\n      ],\n      \"children\": [\n        {\n          \"type\": \"text\",\n          \"style\": {\n            \"textAlign\":\"center\",\n            \"verticalAlign\":\"center\",\n            \"bold\":0,\n            \"frame\": \"0,0,1125,168\",\n            \"lines\": 0,\n            \"fontSize\": 42,\n            \"color\": \"#9b9b9b\",\n            \"bgColor\": \"#FFFFFF\"\n          },\n          \"valueRefer\": \"$msg\"\n        }\n      ],\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    },\n    \"multiTabFlatView\":{\n      \"id\": \"flatId\",\n      \"type\": \"flatView\",\n      \"valueRefer\": \"$flatData\",\n      \"dslId\":\"multiTabFlatView\",\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    }\n  },\n  \"loadingFloor\":{\n    \"dslData\": {\n      \"flatData\": [\n        {\n          \"dslId\": \"multiTabLoadingDsl\",\n          \"msg\": \"&loadingMsg&\"\n        }\n      ]\n    },\n    \"dslRoot\": {\n      \"id\": \"flatId\",\n      \"type\": \"flatView\",\n      \"valueRefer\": \"$flatData\",\n      \"dslId\":\"multiTabFlatView\",\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    }\n  },\n  \"noMoreFloor\":{\n    \"dslData\": {\n      \"flatData\": [\n        {\n          \"dslId\": \"multiTabLoadingDsl\",\n          \"msg\": \"&noMoreMsg&\"\n        }\n      ]\n    },\n    \"dslRoot\": {\n      \"id\": \"flatId\",\n      \"type\": \"flatView\",\n      \"valueRefer\": \"$flatData\",\n      \"dslId\":\"multiTabFlatView\",\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    }\n  },\n  \"errorFloor\":{\n    \"dslData\": {\n      \"flatData\": [\n        {\n          \"jumpMap\": {\n            \"666666666\": {\n              \"eventId\": \"MultiTabFail_EventId\"\n            }\n          },\n\n          \"dslId\": \"multiTabFailDsl\",\n          \"msg\": \"&errorMsg&\"\n        }\n      ]\n    },\n    \"dslRoot\": {\n      \"id\": \"flatId\",\n      \"type\": \"flatView\",\n      \"valueRefer\": \"$flatData\",\n      \"dslId\":\"multiTabFlatView\",\n      \"style\": {\n        \"frame\": \"0,0,1125,168\",\n        \"bgColor\": \"#FFFFFF\"\n      }\n    }\n  }\n}".replace("&loadingMsg&", str4).replace("&noMoreMsg&", str2).replace("&errorMsg&", str3);
        }
        str = null;
