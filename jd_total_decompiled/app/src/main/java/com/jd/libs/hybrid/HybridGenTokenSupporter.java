                ...
                */
                public void onSuccess(@NonNull String str3) {
                    ...
                    if (TextUtils.isEmpty(this.d)) {
                        ...
                        HybridGenTokenSupporter.callbackSuccess(this.f5881e, this.f5882f, str3);
                        return;
                    }
                    ...
                    try {
                        ...
                        try {
                            ...
                            e = e2;
                            OfflineExceptionUtils.reportGentokenError("gentoken_http_uri_fail", this.f5880c, "loadUrl=" + this.b + ", target=" + this.d + ", location=" + str3 + ", e = " + ExceptionUtils.getStackStringFromException(e));
                            ...
                            if (uri != null) {
                                OfflineExceptionUtils.reportGentokenError("gentoken_http_illegal_url", this.f5880c, "loadUrl=" + this.b + ", target=" + this.d + ", location=" + str3);
                            }
                            HybridGenTokenSupporter.callbackError(this.f5881e, this.f5882f, true, "fail to parse to uri or targetUrl/locationUrl is illegal.");
                        }
                    } catch (Exception e3) {
                        e = e3;
                        uri = null;
                    ...
                    if (TextUtils.isEmpty(host) && !TextUtils.isEmpty(host2)) {
                        if (HybridUrlUtils.uriMatchHostPath(uri, uri2)) {
                            Log.d(HybridGenTokenSupporter.TAG, String.format("target url matched. target = %s, matched url = %s", this.d, str3));
                            HybridGenTokenSupporter.callbackSuccess(this.f5881e, this.f5882f, str3);
                            return;
                        } else if (this.a < 5) {
                            ...
                            int i2 = this.a + 1;
                            this.a = i2;
                            Log.d(HybridGenTokenSupporter.TAG, String.format(locale, "target url not matched, continue to load, times = %d, target = %s, url = %s", Integer.valueOf(i2), this.d, str3));
                            this.b = str3;
                            UrlRedirectLoader.urlConnect(str3, this.f5883g, HybridBase.getInstance().getCookieString(str3), this);
                            return;
                        } else {
                            String format = String.format(Locale.getDefault(), "fail to reach target url, load-time(%d) is too many, target = %s, url = %s", Integer.valueOf(this.a), this.d, str3);
                            Log.e(HybridGenTokenSupporter.TAG, format);
                            OfflineExceptionUtils.reportGentokenError("gentoken_http_too_many", this.f5880c, "times=" + this.a + ", loadUrl=" + this.b + ", target=" + this.d + ", location=" + str3);
                            HybridGenTokenSupporter.callbackError(this.f5881e, this.f5882f, true, format);
                            return;
                        }
                    }
                    Log.e(HybridGenTokenSupporter.TAG, "fail to parse to uri or targetUrl/locationUrl is illegal.");
