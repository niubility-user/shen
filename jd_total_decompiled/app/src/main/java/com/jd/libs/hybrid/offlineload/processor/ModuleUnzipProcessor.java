...
public class ModuleUnzipProcessor<T extends Module> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:289:0x0167 A[Catch: Exception -> 0x022a, TryCatch #1 {Exception -> 0x022a, blocks: (B:286:0x0156, B:290:0x0171, B:292:0x017d, B:294:0x018e, B:296:0x01ca, B:298:0x01ce, B:300:0x01fa, B:301:0x0200, B:303:0x0226, B:289:0x0167), top: B:327:0x0156 }] */
    /* JADX WARN: Removed duplicated region for block: B:292:0x017d A[Catch: Exception -> 0x022a, TryCatch #1 {Exception -> 0x022a, blocks: (B:286:0x0156, B:290:0x0171, B:292:0x017d, B:294:0x018e, B:296:0x01ca, B:298:0x01ce, B:300:0x01fa, B:301:0x0200, B:303:0x0226, B:289:0x0167), top: B:327:0x0156 }] */
    /* JADX WARN: Removed duplicated region for block: B:301:0x0200 A[Catch: Exception -> 0x022a, TryCatch #1 {Exception -> 0x022a, blocks: (B:286:0x0156, B:290:0x0171, B:292:0x017d, B:294:0x018e, B:296:0x01ca, B:298:0x01ce, B:300:0x01fa, B:301:0x0200, B:303:0x0226, B:289:0x0167), top: B:327:0x0156 }] */
    /*
    ...
    */
    public void processZipFile() {
        ...
        if (t != null && t.getFileInfo() != null && (file = this.f6091c) != null && file.exists()) {
            if (TextUtils.isEmpty(this.f6094g)) {
                c(-1, this.d, "\u83b7\u53d6\u89e3\u538b\u8def\u5f84\u4e3a\u7a7a");
                OfflineExceptionUtils.reportDownloadError(OfflineExceptionUtils.ERR_MSG_UNZIP, "processDownloadFile", this.b, this.f6092e, "\u83b7\u53d6\u89e3\u538b\u8def\u5f84\u4e3a\u7a7a");
                Log.e("ModuleUnzipProcessor", "[Offline-file](unzip) unzip dest path is null/empty, will not try again until app next startup.");
                if (this.f6091c.exists()) {
                    FileUtils.deleteFile(this.f6091c);
                }
                ProcessCallback<T> processCallback = this.f6095h;
            ...
            try {
                if (this.f6093f) {
                    ...
                    FileUtils.deleteFile(this.f6091c);
                    if (file2 == null) {
                        ProcessCallback<T> processCallback2 = this.f6095h;
                        if (processCallback2 != null) {
                            processCallback2.onProcessFail(true, zArr[0], null);
                            return;
                        }
                        return;
                    }
                } else if (!this.a.getFileInfo().getUseZip()) {
                    ...
                    if (!equalsIgnoreCase) {
                        ...
                        if (file2 == null) {
                            ...
                            ProcessCallback<T> processCallback3 = this.f6095h;
                    ...
                    } else if (!this.f6093f && !b(new File(this.f6091c.getAbsolutePath()))) {
                        Log.e("ModuleUnzipProcessor", "[Offline-file](unzip) original unencrypted zip check failed. Id: " + this.a.getAppid());
                        c(-2, this.d, "\u539f\u59cb\u672a\u52a0\u5bc6\u5305\u6587\u4ef6\u6821\u9a8c\u5931\u8d25");
                        OfflineExceptionUtils.reportDownloadError(OfflineExceptionUtils.ERR_MSG_CHECK, "processZipFile", this.b, this.f6092e, "\u539f\u59cb\u672a\u52a0\u5bc6\u5305\u6587\u4ef6\u6821\u9a8c\u5931\u8d25");
                        if (this.f6091c.exists()) {
                            FileUtils.deleteFile(this.f6091c);
                        }
                        ProcessCallback<T> processCallback4 = this.f6095h;
                        if (processCallback4 != null) {
                            processCallback4.onProcessFail(true, true, null);
                            return;
                        }
                        return;
                    }
                    ...
                    sb.append(", id: ");
                    sb.append(this.a.getAppid());
                    Log.d("ModuleUnzipProcessor", sb.toString());
                    if (this.a.getFileInfo().getFileType().equalsIgnoreCase(OfflineEntityInfo.FILE_TYPE_ZIP2)) {
                        str = this.a.getFileInfo().getPassword();
                    }
                    if (!h(file2.getAbsolutePath(), this.f6094g, str)) {
                        File file3 = new File(this.f6094g);
                        String a = a(file3);
                        if (TextUtils.isEmpty(a)) {
                            c(-2, this.d, "\u79bb\u7ebf\u5305\u5185\u7f3a\u5c11\u6587\u4ef6");
                            OfflineExceptionUtils.reportDownloadError(OfflineExceptionUtils.ERR_MSG_CHECK, "processDownloadFile", this.b, this.f6092e, "\u7f3a\u5c11\u6587\u4ef6");
                            Log.e("ModuleUnzipProcessor", "[Offline-file](unzip) Download error: missing files. Zip: " + file2.getAbsolutePath() + ", unzip path: " + this.f6094g);
                            FileUtils.deleteFile(file2);
                            FileUtils.deleteFile(file3);
                            ProcessCallback<T> processCallback5 = this.f6095h;
                        ...
                        int versionCode = this.a.getFileInfo().getVersionCode();
                        this.a.setAvailable(true);
                        this.a.setUnzipFile(new FileDetail(file3, versionCode));
                        this.a.setLocalFileListJson(a);
                        this.a.setZipFile(new FileDetail(file2, versionCode));
                        ProcessCallback<T> processCallback6 = this.f6095h;
                        if (processCallback6 != null) {
                            processCallback6.onProcessSuccess(this.a);
                            return;
                        }
                        return;
                    }
                    ...
                    Log.e("ModuleUnzipProcessor", "[Offline-file](unzip) Unzip fail. Id: " + this.a.getAppid());
                    FileUtils.deleteFile(file2);
                    ProcessCallback<T> processCallback7 = this.f6095h;
                ...
                c(-1, this.d, "\u5185\u90e8\u9519\u8bef\uff0c" + e2.getMessage());
                OfflineExceptionUtils.reportDownloadCodeError("processDownloadFile", this.b, this.f6092e, e2);
                ...
                ProcessCallback<T> processCallback8 = this.f6095h;
                if (processCallback8 != null) {
                    processCallback8.onProcessFail(true, false, e2);
                    return;
                }
                return;
            }
            ...
            sb2.append("[Offline-file](unzip) Start to unzip");
            str = "";
            sb2.append(!equalsIgnoreCase ? " the second time" : "");
            sb2.append(", source zip file at ");
            sb2.append(file2.getAbsolutePath());
            sb2.append(", extract to ");
            sb2.append(this.f6094g);
            sb2.append(", id: ");
            sb2.append(this.a.getAppid());
            Log.d("ModuleUnzipProcessor", sb2.toString());
        } else {
            Log.e("ModuleUnzipProcessor", "[Offline-file](unzip) unzip fail because information needed is null.");
            c(-1, this.d, "\u914d\u7f6e\u4fe1\u606f\u4e3a\u7a7a\uff0c\u6216\u4e0b\u8f7d\u540e\u6587\u4ef6\u4e0d\u5b58\u5728");
            OfflineExceptionUtils.reportDownloadError(OfflineExceptionUtils.ERR_MSG_UNZIP, "processDownloadFile", this.b, this.f6092e, "\u914d\u7f6e\u4fe1\u606f\u4e3a\u7a7a\uff0c\u6216\u4e0b\u8f7d\u540e\u6587\u4ef6\u4e0d\u5b58\u5728");
            File file4 = this.f6091c;
            if (file4 != null && file4.exists()) {
                FileUtils.deleteFile(this.f6091c);
            }
            ProcessCallback<T> processCallback9 = this.f6095h;
