            ...
            while (query.moveToNext()) {
                try {
                    if (query.isNull(columnIndexOrThrow) && query.isNull(columnIndexOrThrow2) && query.isNull(columnIndexOrThrow3)) {
                        ...
                        commonEntity.setId(query.getString(columnIndexOrThrow4));
                        commonEntity.setUrl(query.getString(columnIndexOrThrow5));
                        commonEntity.setVersionCode(query.getInt(columnIndexOrThrow6));
                        commonEntity.setMd5(query.getString(columnIndexOrThrow7));
                        commonEntity.setBConfigCommon(query.getString(columnIndexOrThrow8));
                        commonEntity.setAvailable(query.getInt(columnIndexOrThrow9) == 0);
                        int i2 = columnIndexOrThrow2;
                        int i3 = columnIndexOrThrow3;
                        commonEntity.setCreateTimestamp(query.getLong(columnIndexOrThrow10));
                        commonEntity.setHeadersMap(this.f5956c.fromString(query.getString(columnIndexOrThrow11)));
