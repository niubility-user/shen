...
public class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public enum EntryFactory {
        STRONG { // from class: com.google.common.cache.LocalCache.EntryFactory.1
            ...
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
        ...
        abstract <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry);
    }
    ...
    public enum Strength {
        STRONG { // from class: com.google.common.cache.LocalCache.Strength.1
            ...
            @Override // com.google.common.cache.LocalCache.Strength
            <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v, int i2) {
        ...
        abstract <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v, int i2);
    }
    ...
    static final class StrongAccessEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongAccessEntry(K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
    ...
    static final class StrongAccessWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongAccessWriteEntry(K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(k2, i2, referenceEntry);
            this.accessTime = Long.MAX_VALUE;
            this.nextAccess = LocalCache.nullEntry();
            this.previousAccess = LocalCache.nullEntry();
    ...
    static class StrongEntry<K, V> extends AbstractReferenceEntry<K, V> {
        ...
        StrongEntry(K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            this.key = k2;
            this.hash = i2;
    ...
    static final class StrongWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongWriteEntry(K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(k2, i2, referenceEntry);
            this.writeTime = Long.MAX_VALUE;
            this.nextWrite = LocalCache.nullEntry();
            this.previousWrite = LocalCache.nullEntry();
    ...
    static final class WeakAccessEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakAccessEntry(ReferenceQueue<K> referenceQueue, K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
    ...
    static final class WeakAccessWriteEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakAccessWriteEntry(ReferenceQueue<K> referenceQueue, K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k2, i2, referenceEntry);
            this.accessTime = Long.MAX_VALUE;
            this.nextAccess = LocalCache.nullEntry();
            this.previousAccess = LocalCache.nullEntry();
    ...
    static class WeakEntry<K, V> extends WeakReference<K> implements ReferenceEntry<K, V> {
        ...
        WeakEntry(ReferenceQueue<K> referenceQueue, K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
    ...
    static final class WeakWriteEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakWriteEntry(ReferenceQueue<K> referenceQueue, K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k2, i2, referenceEntry);
            this.writeTime = Long.MAX_VALUE;
            this.nextWrite = LocalCache.nullEntry();
            this.previousWrite = LocalCache.nullEntry();
    ...
    Segment<K, V> createSegment(int i2, long j2, AbstractCache.StatsCounter statsCounter) {
    ...
    V getLiveValue(ReferenceEntry<K, V> referenceEntry, long j2) {
        V v;
        if (referenceEntry.getKey() == null || (v = referenceEntry.getValueReference().get()) == null || isExpired(referenceEntry, j2)) {
            return null;
        }
        return v;
    }
    ...
    */
    ...
    @VisibleForTesting
    ReferenceEntry<K, V> newEntry(K k2, int i2, @NullableDecl ReferenceEntry<K, V> referenceEntry) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @VisibleForTesting
    ValueReference<K, V> newValueReference(ReferenceEntry<K, V> referenceEntry, V v, int i2) {
    ...
    public static class Segment<K, V> extends ReentrantLock {
        ...
        @GuardedBy("this")
        void enqueueNotification(@NullableDecl K k2, int i2, @NullableDecl V v, int i3, RemovalCause removalCause) {
            this.totalWeight -= i3;
            if (removalCause.wasEvicted()) {
                this.statsCounter.recordEviction();
            }
            if (this.map.removalNotificationQueue != LocalCache.DISCARDING_QUEUE) {
                this.map.removalNotificationQueue.offer(RemovalNotification.create(k2, v, removalCause));
            }
        }
        ...
        V getAndRecordStats(K k2, int i2, LoadingValueReference<K, V> loadingValueReference, ListenableFuture<V> listenableFuture) throws ExecutionException {
            V v;
            try {
            ...
            try {
                if (v != null) {
                    ...
                    storeLoadedValue(k2, i2, loadingValueReference, v);
                    if (v == null) {
                ...
                throw new CacheLoader.InvalidCacheLoadException("CacheLoader returned null for key " + k2 + OrderISVUtil.MONEY_DECIMAL);
            } catch (Throwable th2) {
                th = th2;
                if (v == null) {
                    this.statsCounter.recordLoadException(loadingValueReference.elapsedNanos());
        ...
        @NullableDecl
        LoadingValueReference<K, V> insertLoadingValueReference(K k2, int i2, boolean z) {
            lock();
            try {
                long read = this.map.ticker.read();
                        ...
                        if (referenceEntry2.getHash() == i2 && key != null && this.map.keyEquivalence.equivalent(k2, key)) {
                            ...
                            if (v2 != null) {
                                if (z) {
                                    ...
                                    this.modCount++;
                                    enqueueNotification(k2, i2, v2, valueReference.getWeight(), RemovalCause.REPLACED);
                            ...
                            if (valueReference.isActive()) {
                                enqueueNotification(k2, i2, v2, valueReference.getWeight(), RemovalCause.COLLECTED);
                                setValue(referenceEntry2, k2, v, read);
                                i3 = this.count;
                            } else {
                                setValue(referenceEntry2, k2, v, read);
        ...
        V refresh(K k2, int i2, CacheLoader<? super K, V> cacheLoader, boolean z) {
            LoadingValueReference<K, V> insertLoadingValueReference = insertLoadingValueReference(k2, i2, z);
        ...
        */
        ...
        @NullableDecl
        @GuardedBy("this")
        ReferenceEntry<K, V> removeValueFromChain(ReferenceEntry<K, V> referenceEntry, ReferenceEntry<K, V> referenceEntry2, @NullableDecl K k2, int i2, V v, ValueReference<K, V> valueReference, RemovalCause removalCause) {
            enqueueNotification(k2, i2, v, valueReference.getWeight(), removalCause);
            this.writeQueue.remove(referenceEntry2);
            this.accessQueue.remove(referenceEntry2);
            if (valueReference.isLoading()) {
        ...
        */
            ...
            try {
                ...
                while (true) {
                    ...
                    if (referenceEntry2.getHash() == i2 && key != null) {
                        if (this.map.keyEquivalence.equivalent(k2, key)) {
                            ValueReference<K, V> valueReference = referenceEntry2.getValueReference();
                            V v3 = valueReference.get();
                            if (v3 == null) {
                                if (valueReference.isActive()) {
                                    this.modCount++;
                                    atomicReferenceArray.set(length, removeValueFromChain(referenceEntry, referenceEntry2, key, i2, v3, valueReference, RemovalCause.COLLECTED));
                                    this.count--;
                                }
                            } else if (this.map.valueEquivalence.equivalent(v, v3)) {
                                this.modCount++;
                                enqueueNotification(k2, i2, v3, valueReference.getWeight(), RemovalCause.REPLACED);
        ...
        V scheduleRefresh(ReferenceEntry<K, V> referenceEntry, K k2, int i2, V v, long j2, CacheLoader<? super K, V> cacheLoader) {
            V refresh;
            return (!this.map.refreshes() || j2 - referenceEntry.getWriteTime() <= this.map.refreshNanos || referenceEntry.getValueReference().isLoading() || (refresh = refresh(k2, i2, cacheLoader, true)) == null) ? v : refresh;
        }

        @GuardedBy("this")
        void setValue(ReferenceEntry<K, V> referenceEntry, K k2, V v, long j2) {
            ValueReference<K, V> valueReference = referenceEntry.getValueReference();
            int weigh = this.map.weigher.weigh(k2, v);
        ...
        boolean storeLoadedValue(K k2, int i2, LoadingValueReference<K, V> loadingValueReference, V v) {
            lock();
            try {
                long read = this.map.ticker.read();
                preWriteCleanup(read);
                ...
                while (true) {
                    if (referenceEntry2 != null) {
                        ...
                        if (referenceEntry2.getHash() == i2 && key != null && this.map.keyEquivalence.equivalent(k2, key)) {
                            ...
                            this.modCount++;
                            if (loadingValueReference.isActive()) {
                                enqueueNotification(k2, i2, v2, loadingValueReference.getWeight(), v2 == null ? RemovalCause.COLLECTED : RemovalCause.REPLACED);
                                i4--;
                            }
                            setValue(referenceEntry2, k2, v, read);
                            this.count = i4;
            ...
            try {
                if (this.count != 0) {
                    ...
                    if (v != null) {
                        ...
                        return scheduleRefresh(liveEntry, liveEntry.getKey(), i2, v, read, this.map.defaultLoader);
                    }
                    tryDrainReferenceQueues();
                }
                return null;
                    ...
                    if (referenceEntry2.getHash() == i2 && key != null) {
                        if (this.map.keyEquivalence.equivalent(k2, key)) {
                            ...
                            if (v2 == null) {
                                if (valueReference.isActive()) {
                                    this.modCount++;
                                    atomicReferenceArray.set(length, removeValueFromChain(referenceEntry, referenceEntry2, key, i2, v2, valueReference, RemovalCause.COLLECTED));
                                    this.count--;
                                }
                            } else {
                                this.modCount++;
