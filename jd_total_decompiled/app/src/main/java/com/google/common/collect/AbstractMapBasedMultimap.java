...
public abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
        ...
        public Iterator<K> iterator() {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0011: RETURN 
                  (wrap: java.util.Iterator<K> : 0x000e: CONSTRUCTOR 
                  (r2v0 'this' com.google.common.collect.AbstractMapBasedMultimap$KeySet A[IMMUTABLE_TYPE, THIS])
                  (r0 I:java.util.Iterator A[DONT_GENERATE, DONT_INLINE, REMOVE])
                 A[MD:(com.google.common.collect.AbstractMapBasedMultimap$KeySet, java.util.Iterator):void (m), WRAPPED] (LINE:2) call: com.google.common.collect.AbstractMapBasedMultimap.KeySet.1.<init>(com.google.common.collect.AbstractMapBasedMultimap$KeySet, java.util.Iterator):void type: CONSTRUCTOR)
                 (LINE:2) in method: com.google.common.collect.AbstractMapBasedMultimap.KeySet.iterator():java.util.Iterator<K>, file: classes12.dex
            ...
            /*
                ...
                com.google.common.collect.AbstractMapBasedMultimap$KeySet$1 r1 = new com.google.common.collect.AbstractMapBasedMultimap$KeySet$1
                r1.<init>()
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.AbstractMapBasedMultimap.KeySet.iterator():java.util.Iterator");
        }
    ...
    class NavigableAsMap extends AbstractMapBasedMultimap<K, V>.SortedAsMap implements NavigableMap<K, Collection<V>> {
        ...
        Map.Entry<K, Collection<V>> pollAsMapEntry(Iterator<Map.Entry<K, Collection<V>>> it) {
            if (it.hasNext()) {
                ...
                it.remove();
                return Maps.immutableEntry(next.getKey(), AbstractMapBasedMultimap.unmodifiableCollectionSubclass(createCollection));
            }
            return null;
        }
        ...
        public NavigableMap<K, Collection<V>> headMap(K k2, boolean z) {
            return new NavigableAsMap(sortedMap().headMap(k2, z));
        }
        ...
        public NavigableMap<K, Collection<V>> subMap(K k2, boolean z, K k3, boolean z2) {
            return new NavigableAsMap(sortedMap().subMap(k2, z, k3, z2));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, Collection<V>> tailMap(K k2, boolean z) {
            return new NavigableAsMap(sortedMap().tailMap(k2, z));
        }
    }
    ...
    public class NavigableKeySet extends AbstractMapBasedMultimap<K, V>.SortedKeySet implements NavigableSet<K> {
        ...
        public NavigableSet<K> headSet(K k2, boolean z) {
            return new NavigableKeySet(sortedMap().headMap(k2, z));
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> subSet(K k2, boolean z, K k3, boolean z2) {
            return new NavigableKeySet(sortedMap().subMap(k2, z, k3, z2));
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> tailSet(K k2, boolean z) {
            return new NavigableKeySet(sortedMap().tailMap(k2, z));
        }
    }
    ...
    public class WrappedNavigableSet extends AbstractMapBasedMultimap<K, V>.WrappedSortedSet implements NavigableSet<V> {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        WrappedNavigableSet(@NullableDecl K k2, NavigableSet<V> navigableSet, @NullableDecl AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    public class WrappedSet extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements Set<V> {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        WrappedSet(@NullableDecl K k2, Set<V> set) {
            super(k2, set, null);
    ...
    public class WrappedSortedSet extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements SortedSet<V> {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        WrappedSortedSet(@NullableDecl K k2, SortedSet<V> sortedSet, @NullableDecl AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    public List<V> wrapList(@NullableDecl K k2, List<V> list, @NullableDecl AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    Iterator<Map.Entry<K, V>> entryIterator() {
        return new AbstractMapBasedMultimap<K, V>.Itr<Map.Entry<K, V>>() { // from class: com.google.common.collect.AbstractMapBasedMultimap.2
            {
                AbstractMapBasedMultimap.this = this;
            }
    ...
    Collection<V> wrapCollection(@NullableDecl K k2, Collection<V> collection) {
        if (collection instanceof NavigableSet) {
            return new WrappedNavigableSet(k2, (NavigableSet) collection, null);
        }
        if (collection instanceof SortedSet) {
            return new WrappedSortedSet(k2, (SortedSet) collection, null);
        }
        if (collection instanceof Set) {
    ...
    public class WrappedCollection extends AbstractCollection<V> {
        ...
        WrappedCollection(@NullableDecl K k2, Collection<V> collection, @NullableDecl AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
            AbstractMapBasedMultimap.this = r1;
            this.key = k2;
        ...
        public class WrappedIterator implements Iterator<V> {
            ...
            WrappedIterator() {
                ...
                Collection<V> collection = r1.delegate;
    ...
    public class WrappedList extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements List<V> {
        ...
        private class WrappedListIterator extends AbstractMapBasedMultimap<K, V>.WrappedCollection.WrappedIterator implements ListIterator<V> {
            ...
            public WrappedListIterator(int i2) {
                super(r2.getListDelegate().listIterator(i2));
                WrappedList.this = r2;
            }
        }
