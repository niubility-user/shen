...
public abstract class Striped<L> {
    ...
    public static Striped<Lock> lock(int i2) {
        return new CompactStriped(i2, new Supplier<Lock>() { // from class: com.google.common.util.concurrent.Striped.1
            @Override // com.google.common.base.Supplier
            public Lock get() {
    ...
    public static Striped<ReadWriteLock> readWriteLock(int i2) {
        return new CompactStriped(i2, READ_WRITE_LOCK_SUPPLIER);
    }

    public static Striped<Semaphore> semaphore(int i2, final int i3) {
        return new CompactStriped(i2, new Supplier<Semaphore>() { // from class: com.google.common.util.concurrent.Striped.3
            @Override // com.google.common.base.Supplier
            public Semaphore get() {
