...
public class FlexboxLayout extends ViewGroup {
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private boolean isWrapRequired(int i2, int i3, int i4, int i5, LayoutParams layoutParams, int i6, int i7) {
        int i8;
        if (this.mFlexWrap == 0) {
            return false;
        }
        ...
        if (isMainAxisDirectionHorizontal(this.mFlexDirection)) {
            if (hasDividerBeforeChildAtAlongMainAxis(i6, i7)) {
                i5 += this.mDividerVerticalWidth;
            }
            if ((this.mShowDividerVertical & 4) > 0) {
        ...
        if (hasDividerBeforeChildAtAlongMainAxis(i6, i7)) {
            i5 += this.mDividerHorizontalHeight;
        }
    ...
    */
    private void layoutHorizontal(boolean z, int i2, int i3, int i4, int i5) {
        ...
        int i11 = 0;
        while (i11 < size) {
            FlexLine flexLine3 = this.mFlexLines.get(i11);
            ...
            if (i15 == 0) {
                ...
                f3 = i17 - paddingLeft;
                f2 = (i9 - i17) + paddingRight;
            } else if (i15 == 2) {
                int i18 = flexLine3.mMainSize;
                f2 = paddingLeft + ((i9 - i18) / 2.0f);
                f3 = (i9 - paddingRight) - ((i9 - i18) / 2.0f);
            } else {
                if (i15 == 3) {
                    f2 = paddingLeft;
                    int itemCountNotGone = flexLine3.getItemCountNotGone();
                    f4 = (i9 - flexLine3.mMainSize) / (itemCountNotGone != 1 ? (float) (itemCountNotGone - 1) : 1.0f);
                    f3 = i9 - paddingRight;
                } else if (i15 == 4) {
                    int itemCountNotGone2 = flexLine3.getItemCountNotGone();
                    f4 = itemCountNotGone2 != 0 ? (i9 - flexLine3.mMainSize) / itemCountNotGone2 : 0.0f;
                    float f5 = f4 / 2.0f;
                    f2 = paddingLeft + f5;
                    f3 = (i9 - paddingRight) - f5;
                } else {
                ...
                while (i6 < flexLine3.mItemCount) {
                    View reorderedChildAt = getReorderedChildAt(i19);
                    if (reorderedChildAt != null) {
                        if (reorderedChildAt.getVisibility() == 8) {
                            i19++;
                        } else {
                            ...
                            if (hasDividerBeforeChildAtAlongMainAxis(i19, i6)) {
                            ...
                            if (i21 != i16) {
                                ...
                                flexLine = flexLine3;
                                if (z) {
                                    layoutSingleChildHorizontal(reorderedChildAt, flexLine, i21, this.mAlignItems, Math.round(f9) - reorderedChildAt.getMeasuredWidth(), i14, Math.round(f9), i14 + reorderedChildAt.getMeasuredHeight());
                                } else {
                                    layoutSingleChildHorizontal(reorderedChildAt, flexLine, i21, this.mAlignItems, Math.round(f8), i14, Math.round(f8) + reorderedChildAt.getMeasuredWidth(), i14 + reorderedChildAt.getMeasuredHeight());
                                }
                            } else if (z) {
                                layoutParams = layoutParams2;
                                i7 = i6;
                                i8 = i19;
                                flexLine = flexLine3;
                                layoutSingleChildHorizontal(reorderedChildAt, flexLine3, i21, this.mAlignItems, Math.round(f9) - reorderedChildAt.getMeasuredWidth(), i13 - reorderedChildAt.getMeasuredHeight(), Math.round(f9), i13);
                            } else {
                                layoutParams = layoutParams2;
                                i7 = i6;
                                i8 = i19;
                                flexLine = flexLine3;
                                layoutSingleChildHorizontal(reorderedChildAt, flexLine, i21, this.mAlignItems, Math.round(f8), i13 - reorderedChildAt.getMeasuredHeight(), Math.round(f8) + reorderedChildAt.getMeasuredWidth(), i13);
                            }
                            i19 = i8 + 1;
                            flexLine2 = flexLine;
                            flexLine2.mLeft = Math.min(flexLine2.mLeft, reorderedChildAt.getLeft() - ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin);
                            flexLine2.mTop = Math.min(flexLine2.mTop, reorderedChildAt.getTop() - ((ViewGroup.MarginLayoutParams) layoutParams).topMargin);
                            flexLine2.mRight = Math.max(flexLine2.mRight, reorderedChildAt.getRight() + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                            flexLine2.mBottom = Math.max(flexLine2.mBottom, reorderedChildAt.getBottom() + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                            f2 = f8 + reorderedChildAt.getMeasuredWidth() + max + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin;
                            f3 = f9 - ((reorderedChildAt.getMeasuredWidth() + max) + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin);
                            i6 = i7 + 1;
                            flexLine3 = flexLine2;
                            i16 = 2;
                        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private void layoutVertical(boolean z, boolean z2, int i2, int i3, int i4, int i5) {
        float f2;
        float f3;
        float f4;
        int i6;
        ...
        while (i12 < size) {
            ...
            if (i16 == 0) {
                ...
                int i17 = flexLine3.mMainSize;
                f3 = i17 - paddingTop;
                f2 = (i9 - i17) + paddingBottom;
            } else if (i16 == 2) {
                int i18 = flexLine3.mMainSize;
                f2 = paddingTop + ((i9 - i18) / 2.0f);
                f3 = (i9 - paddingBottom) - ((i9 - i18) / 2.0f);
            } else {
                if (i16 == 3) {
                    f2 = paddingTop;
                    int itemCountNotGone = flexLine3.getItemCountNotGone();
                    ...
                    if (reorderedChildAt != null) {
                        if (reorderedChildAt.getVisibility() == 8) {
                            ...
                            if (!z) {
                                ...
                                flexLine = flexLine3;
                                if (z2) {
                                    layoutSingleChildVertical(reorderedChildAt, flexLine, false, this.mAlignItems, i14, Math.round(f9) - reorderedChildAt.getMeasuredHeight(), i14 + reorderedChildAt.getMeasuredWidth(), Math.round(f9));
                                } else {
                                    layoutSingleChildVertical(reorderedChildAt, flexLine, false, this.mAlignItems, i14, Math.round(f8), i14 + reorderedChildAt.getMeasuredWidth(), Math.round(f8) + reorderedChildAt.getMeasuredHeight());
                                }
                            } else if (z2) {
                                layoutParams = layoutParams2;
                                i7 = i6;
                                i8 = i19;
                                flexLine = flexLine3;
                                layoutSingleChildVertical(reorderedChildAt, flexLine3, true, this.mAlignItems, i15 - reorderedChildAt.getMeasuredWidth(), Math.round(f9) - reorderedChildAt.getMeasuredHeight(), i15, Math.round(f9));
                            } else {
                                layoutParams = layoutParams2;
                                i7 = i6;
                                i8 = i19;
                                flexLine = flexLine3;
                                layoutSingleChildVertical(reorderedChildAt, flexLine, true, this.mAlignItems, i15 - reorderedChildAt.getMeasuredWidth(), Math.round(f8), i15, Math.round(f8) + reorderedChildAt.getMeasuredHeight());
                            }
                            i19 = i8 + 1;
                            flexLine2 = flexLine;
                            flexLine2.mLeft = Math.min(flexLine2.mLeft, reorderedChildAt.getLeft() - ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin);
                            ...
                            flexLine2.mRight = Math.max(flexLine2.mRight, reorderedChildAt.getRight() + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                            flexLine2.mBottom = Math.max(flexLine2.mBottom, reorderedChildAt.getBottom() + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                            f2 = f8 + reorderedChildAt.getMeasuredHeight() + max + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin;
                            f3 = f9 - ((reorderedChildAt.getMeasuredHeight() + max) + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin);
                            i6 = i7 + 1;
                            flexLine3 = flexLine2;
                        }
                    }
            ...
            int i212 = flexLine3.mCrossSize;
            paddingLeft = i14 + i212;
            i10 = i15 - i212;
            i12++;
            i11 = i192;
        }
