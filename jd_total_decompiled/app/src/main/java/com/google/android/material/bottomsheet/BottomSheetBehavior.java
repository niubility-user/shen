                    ...
                    if (bottomSheetBehavior.hideable && bottomSheetBehavior.shouldHide(view, f3) && (view.getTop() > BottomSheetBehavior.this.collapsedOffset || Math.abs(f2) < Math.abs(f3))) {
                        ...
                        if (BottomSheetBehavior.this.fitToContents) {
                            ...
                            if (top2 < i6) {
                                ...
                                i4 = 3;
                            } else if (Math.abs(top2 - i6) < Math.abs(top2 - BottomSheetBehavior.this.collapsedOffset)) {
                                i3 = BottomSheetBehavior.this.halfExpandedOffset;
                            } else {
                                i3 = BottomSheetBehavior.this.collapsedOffset;
                            }
            ...
            public void onViewReleased(@NonNull View view, float f2, float f3) {
                ...
                if (f3 < 0.0f) {
                    if (BottomSheetBehavior.this.fitToContents) {
                        ...
                        i4 = 3;
                        if (BottomSheetBehavior.this.viewDragHelper.settleCapturedViewAt(view.getLeft(), i22)) {
                            BottomSheetBehavior.this.setStateInternal(2);
                            ViewCompat.postOnAnimation(view, new SettleRunnable(view, i4));
                            return;
                        }
