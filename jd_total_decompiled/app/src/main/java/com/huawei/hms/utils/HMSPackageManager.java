    ...
    */
    public int c() {
        ...
        synchronized (q) {
            ...
            if (this.f1521k != 3 && this.f1522l == packageFirstInstallTime) {
                z = false;
                if (z) {
                    HMSLog.i("HMSPackageManager", "quit checkHmsIsSpoof cached state: " + a(this.f1521k));
                    return this.f1521k;
                }
                this.f1521k = b() ? 2 : 1;
                this.f1522l = this.b.getPackageFirstInstallTime("com.huawei.hwid");
                HMSLog.i("HMSPackageManager", "quit checkHmsIsSpoof state: " + a(this.f1521k));
                return this.f1521k;
            }
            z = true;
            if (z) {
