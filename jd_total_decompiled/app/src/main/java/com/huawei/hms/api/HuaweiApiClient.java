...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        private final List<PermissionInfo> f1210c = new ArrayList();
        private final Map<Api<?>, Api.ApiOptions> d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        private OnConnectionFailedListener f1211e;

        /* renamed from: f  reason: collision with root package name */
        private ConnectionCallbacks f1212f;

        /* renamed from: g  reason: collision with root package name */
        private int f1213g;

        /* renamed from: h  reason: collision with root package name */
        private Activity f1214h;
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i2, OnConnectionFailedListener onConnectionFailedListener) {
            if (i2 >= 0) {
                this.f1213g = i2;
                this.f1214h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
                return this;
            }
        ...
        public HuaweiApiClient build() {
            ...
            huaweiApiClientImpl.setPermissionInfos(this.f1210c);
            huaweiApiClientImpl.setApiMap(this.d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f1212f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f1211e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f1213g);
            if (this.f1213g >= 0) {
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f1214h).startAutoMange(this.f1213g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o, Scope... scopeArr) {
            ...
            if (api.getOptions() != null) {
                ...
                this.f1210c.addAll(api.getOptions().getPermissionInfoList(o));
            }
            this.b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
