...
public class NotifyAdapterUtil {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:270:0x01b9, code lost:
        r0 = move-exception;
     */
    /* JADX WARN: Code restructure failed: missing block: B:271:0x01ba, code lost:
        r4 = r17;
    ...
    /* JADX WARN: Removed duplicated region for block: B:268:0x0190 A[Catch: Exception -> 0x01b9, TRY_LEAVE, TryCatch #0 {Exception -> 0x01b9, blocks: (B:266:0x017f, B:268:0x0190), top: B:293:0x017f }] */
    /* JADX WARN: Removed duplicated region for block: B:295:0x01fb A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    */
    private static void pushNotificationBySystem(Context context, List<Bitmap> list, InsideNotificationItem insideNotificationItem, long j2, int i2, r.a aVar) {
        ...
        if (notifyType != 2) {
            ...
            String str3 = str2;
            new com.vivo.push.b.p(str, j2, insideNotificationItem).b(intent);
            ...
            if (notificationManager == null) {
                try {
                    if (k2 == 0) {
                        ...
                        p.a(str3, "unknow notify style ".concat(String.valueOf(k2)));
                        return;
                    }
                } catch (Exception e2) {
                    p.a(str3, e2);
