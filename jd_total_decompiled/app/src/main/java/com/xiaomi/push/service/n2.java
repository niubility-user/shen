    ...
    */
    private void n(String str) {
        ...
        if ("WIFI-ID-UNKNOWN".equals(str)) {
            ...
            i2 = this.a.getInt(a.b(this.f19144c), -1);
            long j2 = this.a.getLong(a.d(this.f19144c), -1L);
            long currentTimeMillis = System.currentTimeMillis();
            if (i2 != -1) {
                if (j2 == -1) {
                    remove = this.a.edit().putLong(a.d(this.f19144c), currentTimeMillis + t());
                } else if (currentTimeMillis > j2) {
                    remove = this.a.edit().remove(a.b(this.f19144c)).remove(a.d(this.f19144c));
                }
                remove.apply();
            }
            this.b.getAndSet(0);
            if (TextUtils.isEmpty(this.f19144c) && a() == -1) {
                this.d = true;
            } else {
                this.d = false;
            }
            g.j.a.a.a.c.o(String.format("[HB] network changed, netid:%s, %s", this.f19144c, Boolean.valueOf(this.d)));
        }
        this.f19144c = str;
        i2 = this.a.getInt(a.b(this.f19144c), -1);
        long j22 = this.a.getLong(a.d(this.f19144c), -1L);
