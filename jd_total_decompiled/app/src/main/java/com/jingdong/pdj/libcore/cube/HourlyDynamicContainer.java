            ...
            dynamicContainer2.bindViewAsync(new IViewBindListener() { // from class: com.jingdong.pdj.libcore.cube.HourlyDynamicContainer$setData$1
                ...
                */
                public final void onDynamicViewBind() {
                    ...
                    HourlyDynamicContainer hourlyDynamicContainer;
                    if (HourlyDynamicContainer.this.getCommFunction().getCubePointData() != null && dJPointVisibleUtil != null) {
                        hourlyDynamicContainer = HourlyDynamicContainer.this.rootView;
                        dJPointVisibleUtil.setPointViewData(hourlyDynamicContainer, HourlyDynamicContainer.this.getCommFunction().getCubePointData());
                    }
                    HourlyDynamicContainer.this.AgainAttach();
                    OKLog.i("DynamicContainer", "\u7ed1\u5b9a\u6570\u636e\u6210\u529f");
                    HourlyDynamicContainer.this.setVisibility(0);
                }
