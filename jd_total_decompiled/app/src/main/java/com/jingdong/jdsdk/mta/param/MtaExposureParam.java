...
public class MtaExposureParam extends BaseEvent {
    private static final String LOG_TYPE = "sr";
    private static final String LTS = "ep";
    ...
    public MtaExposureParam(String str, String str2, String str3, String str4) {
    ...
    public MtaExposureParam(String str, String str2, String str3, String str4, HashMap<String, String> hashMap) {
        this.moduleId = str;
        this.pageId = str2;
        this.eventId = str3;
        this.param = str4;
