...
public class r extends d0 {
    ...
    class a implements l.u {
        ...
        public void onFail() {
            this.a.a(this.b, r.this.putErrMsg("fail", null, this.f13583c));
        }

        @Override // com.jingdong.manto.q.l.u
        public void onSuccess() {
            this.a.a(this.b, r.this.putErrMsg(IMantoBaseModule.SUCCESS, null, this.f13583c));
        }
    }
    ...
    public final void exec(com.jingdong.manto.h hVar, JSONObject jSONObject, int i2, String str) {
        if (hVar.h() == null || hVar.h().f13014f == null) {
            ...
            hVar.h().f13014f.a(jSONObject.optString("url"), false, (l.u) new a(hVar, i2, str));
        }
    }
