...
public class m extends d0 {
    ...
    class a implements com.jingdong.manto.m.t0.d.d.d {
        ...
        public final void a(com.jingdong.manto.m.t0.d.d.e eVar) {
            if (eVar.a != 0) {
                ...
                this.a.a(this.b, m.this.putErrMsg(eVar.b, hashMap));
                return;
            }
            HashMap hashMap2 = new HashMap();
            hashMap2.put("errCode", 0);
            this.a.a(this.b, m.this.putErrMsg(IMantoBaseModule.SUCCESS, hashMap2));
        }
    }
    ...
    public void exec(com.jingdong.manto.h hVar, JSONObject jSONObject, int i2, String str) {
        ...
        if (a2 == null) {
            ...
            com.jingdong.manto.m.t0.d.c.g.g gVar = new com.jingdong.manto.m.t0.d.c.g.g(optString2, optString3);
            gVar.a = optBoolean;
            gVar.d = false;
            gVar.f13655e = optBoolean2;
            a2.a(optString, gVar, new a(hVar, i2));
            return;
        } else {
            hashMap = new HashMap();
