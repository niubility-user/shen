        ...
        public void run() {
            ...
            if (!TextUtils.isEmpty(this.a)) {
                ...
                if (j2 > this.b.length() - 1) {
                    ...
                    if (length + length2 > this.b.length()) {
                        length2 = this.b.length() - length;
                    }
                    long j3 = length2;
                    if (TextUtils.isEmpty(this.d)) {
                        this.f13825f.putString("data", TextUtils.equals(ViewShot.Results.BASE_64, this.d) ? s.b(this.f13824e.b, length, j3) : s.a(this.f13824e.b, this.d, length, j3));
                        mantoResultCallBack = this.f13826g;
                    } else {
                        String a = s.a(this.f13824e.b, length, j3);
                        ByteBuffer wrap = ByteBuffer.wrap(a.getBytes());
                        HashMap hashMap = new HashMap();
                        hashMap.put("data", wrap);
                        JSONObject jSONObject = new JSONObject();
                        if (a.this.convertNativeBuffer(this.f13827h, jSONObject, hashMap, true)) {
                            this.f13825f.putString("__nativeBuffers__", jSONObject.optString("__nativeBuffers__"));
                        } else {
                            this.f13825f.putString("data", a);
                        }
                        mantoResultCallBack = this.f13826g;
                    }
                    if (this.f13826g != null) {
                        this.f13828i.countDown();
                        return;
                    }
                    return;
                }
    ...
    */
    public Bundle handleMethodSync(String str, MantoCore mantoCore, Bundle bundle) {
        ...
        try {
            ...
            switch (c2) {
                case 0:
                    return i(jSONObject, string);
                case 1:
                    return f(jSONObject, string);
                case 2:
                    return a(jSONObject, string);
                case 3:
                    return a(jSONObject, string, true);
                case 4:
                    return g(jSONObject, string);
                case 5:
                    return d(jSONObject, string);
                case 6:
                    return c(jSONObject, string);
                case 7:
                    return b(jSONObject, string);
                case '\b':
                    return h(jSONObject, string);
                case '\t':
                    return a(jSONObject, string, false);
                case '\n':
                    return e(jSONObject, string);
                case 11:
                    return a(mantoCore, jSONObject, string, (MantoResultCallBack) null);
                default:
