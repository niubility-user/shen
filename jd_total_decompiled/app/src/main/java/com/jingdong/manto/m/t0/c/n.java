...
public class n extends d0 {
    ...
    class a implements com.jingdong.manto.m.t0.d.d.d {
        ...
        public void a(com.jingdong.manto.m.t0.d.d.e eVar) {
            int i2 = eVar.a;
            if (i2 != 0) {
                BleHelpExt.callFail(n.this, this.a, this.b, i2, eVar.b);
            } else {
                BleHelpExt.callSuccess(n.this, this.a, this.b);
            }
        }
    }
    ...
    public void exec(com.jingdong.manto.h hVar, JSONObject jSONObject, int i2, String str) {
        ...
        if (a3 == null) {
            ...
            a3.a(optString, new com.jingdong.manto.m.t0.d.c.g.h(Integer.valueOf(jSONObject.optInt("mtu")), optString), new a(a2, i2, hVar));
            return;
        } else {
            hashMap = new HashMap();
