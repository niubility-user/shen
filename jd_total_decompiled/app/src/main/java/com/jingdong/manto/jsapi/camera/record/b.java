...
public class b implements Camera.PreviewCallback {
    ...
    */
    public void a(Surface surface) {
        ...
        int i2 = 90;
        int i3 = (this.f13169l + 90) % R2.attr.additionBottom;
        Matrix matrix = new Matrix();
        int i4 = this.d;
        if (i4 == this.f13162e) {
            f2 = i3;
            ...
            if (this.f13166i == null) {
                this.f13166i = new MediaRecorder();
            }
            if (this.b == null) {
            ...
            this.a.unlock();
            this.f13166i.reset();
            this.f13166i.setCamera(this.a);
            this.f13166i.setVideoSource(1);
            this.f13166i.setAudioSource(1);
            this.f13166i.setOutputFormat(2);
            this.f13166i.setVideoEncoder(2);
            this.f13166i.setAudioEncoder(3);
            this.f13166i.setVideoFrameRate(30);
            int i5 = this.p;
            try {
                String a2 = m.a("cameraVideoBitRate", "");
            ...
            this.f13166i.setVideoEncodingBitRate(i5);
            if (TextUtils.equals("1", m.a("cameraRecordPreviewSize", "1"))) {
                MediaRecorder mediaRecorder = this.f13166i;
                Camera.Size size = this.r;
                mediaRecorder.setVideoSize(size.width, size.height);
            } else {
                com.jingdong.manto.jsapi.camera.record.c b = com.jingdong.manto.jsapi.camera.record.c.b();
                List<Camera.Size> supportedPreviewSizes = this.b.getSupportedPreviewSizes();
                Camera.Size size2 = this.r;
                Camera.Size a3 = b.a(supportedPreviewSizes, size2.width, size2.height);
                if (a3 == null) {
                    com.jingdong.manto.jsapi.camera.record.c b2 = com.jingdong.manto.jsapi.camera.record.c.b();
                    List<Camera.Size> supportedVideoSizes = this.b.getSupportedVideoSizes();
                    Camera.Size size3 = this.r;
                    a3 = b2.a(supportedVideoSizes, size3.width, size3.height);
                    if (a3 == null) {
                        a3 = this.r;
                    }
                }
                this.f13166i.setVideoSize(a3.width, a3.height);
            }
            try {
                if (this.d == this.f13163f) {
                    if (this.f13170m != 270) {
                        if (i3 != 90) {
                        }
                        this.f13166i.setOrientationHint(270);
                        this.f13166i.setPreviewDisplay(surface);
                        if (TextUtils.isEmpty(this.f13167j)) {
                        }
                        this.f13166i.setOutputFile(this.f13167j);
                        this.f13166i.prepare();
                        this.f13166i.start();
                        this.f13165h = true;
                        return;
                    } else if (i3 == 0) {
                        MediaRecorder mediaRecorder2 = this.f13166i;
                        i2 = 180;
                        mediaRecorder2.setOrientationHint(i2);
                        this.f13166i.setPreviewDisplay(surface);
                        if (TextUtils.isEmpty(this.f13167j)) {
                            this.f13167j = n.b + "/video_" + System.currentTimeMillis() + PreDownLoadManager.VIDEO_SKU_SUFFIX;
                        }
                        this.f13166i.setOutputFile(this.f13167j);
                        this.f13166i.prepare();
                        this.f13166i.start();
            ...
            this.f13166i.setOrientationHint(i3);
            this.f13166i.setPreviewDisplay(surface);
            if (TextUtils.isEmpty(this.f13167j)) {
            }
            this.f13166i.setOutputFile(this.f13167j);
    ...
    */
    public void a(e eVar) {
        ...
        if (!this.f13165h || (mediaRecorder = this.f13166i) == null) {
            return;
        }
        mediaRecorder.setOnErrorListener(null);
        this.f13166i.setOnInfoListener(null);
        this.f13166i.setPreviewDisplay(null);
        try {
            try {
                this.f13166i.stop();
                mediaRecorder2 = this.f13166i;
            } catch (RuntimeException e2) {
                e2.printStackTrace();
                this.f13166i = null;
                mediaRecorder2 = new MediaRecorder();
                this.f13166i = mediaRecorder2;
            }
        } catch (Throwable th) {
            MediaRecorder mediaRecorder3 = this.f13166i;
