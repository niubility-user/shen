...
public class UnIconConfigController {
    ...
    /* JADX WARN: Removed duplicated region for block: B:126:0x00a3 A[Catch: all -> 0x00b5, TryCatch #0 {, blocks: (B:93:0x0001, B:98:0x000a, B:100:0x000e, B:101:0x0017, B:103:0x002d, B:108:0x0035, B:112:0x004b, B:114:0x0053, B:117:0x005a, B:124:0x009d, B:126:0x00a3, B:127:0x00aa, B:118:0x005f, B:120:0x007a, B:122:0x0082, B:110:0x003d), top: B:133:0x0001 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public synchronized Bitmap getBitmap(String str, BitmapFactory.Options options, boolean z, int i2) {
        Bitmap bitmap;
        Bitmap bitmap2;
        ...
        IconConfigModel iconConfigModel = UnIconCache.getInstance().get(ninePatchId, idWithSwitch);
        if (iconConfigModel == null || (bitmap2 = iconConfigModel.bitmap) == null) {
            if (iconConfigModel == null || TextUtils.isEmpty(iconConfigModel.path)) {
                iconConfigModel = DataBaseController.getController().getIconConfigModel(ninePatchId, z, isSmall(i2));
            }
            if (iconConfigModel != null && !TextUtils.isEmpty(iconConfigModel.path) && fileIsExists(iconConfigModel)) {
                ...
                Bitmap scaleBitmap = scaleBitmap(bitmap, ninePatchId, z);
                if (iconConfigModel == null) {
                    iconConfigModel = new IconConfigModel();
                    iconConfigModel.id = idWithSwitch;
                }
                iconConfigModel.bitmap = scaleBitmap;
                UnIconCache.getInstance().update(ninePatchId, idWithSwitch, iconConfigModel);
                return scaleBitmap;
            }
            Bitmap assetsBitmap = DefaultDataController.getController().getAssetsBitmap(idWithSwitch + ".png", null, options);
            if (assetsBitmap != null || ninePatchId.contains("_var_")) {
                bitmap = assetsBitmap;
            } else {
                bitmap = DefaultDataController.getController().getAssetsBitmap(ninePatchId + ".png", null, options);
            }
            Bitmap scaleBitmap2 = scaleBitmap(bitmap, ninePatchId, z);
            if (iconConfigModel == null) {
            }
