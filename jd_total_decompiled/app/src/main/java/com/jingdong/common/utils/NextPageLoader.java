...
public abstract class NextPageLoader implements HttpGroup.OnAllListener, IDestroyListener {
    ...
    public class BaseListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            if (NextPageLoader.this.mCallbackScrollListener != null) {
                NextPageLoader.this.mCallbackScrollListener.onScroll(absListView, i2, i3, i4);
            }
            NextPageLoader.this.onScroll(absListView, i2, i3, i4);
        }

        @Override // android.widget.AbsListView.OnScrollListener
        public void onScrollStateChanged(AbsListView absListView, int i2) {
            if (NextPageLoader.this.mCallbackScrollListener != null) {
                NextPageLoader.this.mCallbackScrollListener.onScrollStateChanged(absListView, i2);
            }
            NextPageLoader.this.onScrollStateChanged(absListView, i2);
        }
    }
    ...
    public class GalleryListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> adapterView, View view, int i2, long j2) {
            if (NextPageLoader.this.showItemList == null || r1.size() - 1 != i2 || NextPageLoader.this.isFinishing || NextPageLoader.this.isLoadedLastPage()) {
                return;
            }
    ...
    public abstract class OnScrollLastListener extends BaseListener {
        ...
        @Override // com.jingdong.common.utils.NextPageLoader.BaseListener, android.widget.AbsListView.OnScrollListener
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            this.firstVisibleItem = i2;
            this.visibleItemCount = i3;
            this.totalItemCount = i4;
            NextPageLoader.this.setSelection(i2);
    ...
    */
        ...
        if (z && this.showItemList.size() < 1) {
            ...
            if (adapterView instanceof ListView) {
                ...
                if (mySimpleAdapter != null) {
                    ...
                    final OnScrollLastListener onScrollLastListener = new OnScrollLastListener() { // from class: com.jingdong.common.utils.NextPageLoader.1
                        @Override // com.jingdong.common.utils.NextPageLoader.OnScrollLastListener
                        ...
                        public void onScrollLast() {
                            ...
                            if (OKLog.D) {
                                OKLog.d(NextPageLoader.TAG, "onScrollLast");
                            }
                    ...
                    this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.utils.NextPageLoader.2
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View view3, MotionEvent motionEvent) {
                            if (NextPageLoader.this.jdOnTouchListener != null) {
                                NextPageLoader.this.jdOnTouchListener.onTouch(view3, motionEvent);
                            }
                            int action = motionEvent.getAction();
                            if (action != 0) {
                                if (action == 1 && !NextPageLoader.this.isFling) {
                    ...
                    if (adapterView3 instanceof ListView) {
                        ...
                        this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.utils.NextPageLoader.3
                            @Override // android.view.View.OnTouchListener
                            public boolean onTouch(View view3, MotionEvent motionEvent) {
                                return false;
                            }
                ...
                this.handler.postDelayed(new Runnable() { // from class: com.jingdong.common.utils.NextPageLoader.4
                    @Override // java.lang.Runnable
                    public void run() {
                        ArrayList<Object> arrayList2;
                        NextPageLoader nextPageLoader = NextPageLoader.this;
                        if (nextPageLoader.adapterView == null || (arrayList2 = nextPageLoader.showItemList) == null || arrayList2.size() > NextPageLoader.this.adapterView.getChildCount()) {
                            return;
                        }
                        NextPageLoader.this.tryShowNextPage();
                    }
    ...
    public void onEnd(final HttpResponse httpResponse) {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x003f: INVOKE 
              (wrap: android.os.Handler : 0x0038: IGET (r3v0 'this' com.jingdong.common.utils.NextPageLoader A[IMMUTABLE_TYPE, THIS]) A[WRAPPED] (LINE:7) com.jingdong.common.utils.NextPageLoader.handler android.os.Handler)
              (wrap: java.lang.Runnable : 0x003c: CONSTRUCTOR 
              (r3v0 'this' com.jingdong.common.utils.NextPageLoader A[IMMUTABLE_TYPE, THIS])
             ...
             A[MD:(com.jingdong.common.utils.NextPageLoader, java.util.ArrayList, com.jingdong.jdsdk.network.toolbox.HttpResponse):void (m), WRAPPED] call: com.jingdong.common.utils.NextPageLoader.5.<init>(com.jingdong.common.utils.NextPageLoader, java.util.ArrayList, com.jingdong.jdsdk.network.toolbox.HttpResponse):void type: CONSTRUCTOR)
             type: VIRTUAL call: android.os.Handler.post(java.lang.Runnable):boolean A[MD:(java.lang.Runnable):boolean (c)] (LINE:7) in method: com.jingdong.common.utils.NextPageLoader.onEnd(com.jingdong.jdsdk.network.toolbox.HttpResponse):void, file: classes6.dex
        ...
        /*
            ...
            if (r0 != 0) goto L34
            com.jingdong.jdsdk.utils.JSONObjectProxy r0 = r4.getJSONObject()
            java.lang.String r1 = "totalCount"
            java.lang.Long r0 = r0.getLongOrNull(r1)
            r3.setTotalCount(r0)
        ...
        L34:
            ...
            com.jingdong.common.utils.NextPageLoader$5 r2 = new com.jingdong.common.utils.NextPageLoader$5
            r2.<init>()
            r1.post(r2)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jingdong.common.utils.NextPageLoader.onEnd(com.jingdong.jdsdk.network.toolbox.HttpResponse):void");
    }
    ...
    public void onError(HttpError httpError) {
        ...
        if (getTotalCount() == null || getTotalCount().longValue() != this.showItemList.size()) {
            ...
            if (iMyActivity != null) {
                iMyActivity.post(new Runnable() { // from class: com.jingdong.common.utils.NextPageLoader.6
                    @Override // java.lang.Runnable
                    public void run() {
                        if (NextPageLoader.this.adapter != null) {
                            NextPageLoader.this.adapter.removeFooterView(NextPageLoader.this.loadingView);
                        }
                        NextPageLoader.this.needFooterView = true;
                    }
                });
            }
            showError();
    ...
    public NextPageLoader(IMyActivity iMyActivity, AdapterView adapterView, View view, String str, JSONObject jSONObject, String str2, long j2) {
