...
public class Catelogy implements Serializable {
    ...
    */
    public static ArrayList<Catelogy> toList(JSONArrayPoxy jSONArrayPoxy, int i2) {
        ArrayList<Catelogy> arrayList;
        ArrayList<Catelogy> arrayList2 = null;
        try {
            arrayList = new ArrayList<>();
            for (int i3 = 0; i3 < jSONArrayPoxy.length(); i3++) {
                try {
                    if (jSONArrayPoxy.getJSONObject(i3) != null && !jSONArrayPoxy.getJSONObject(i3).isNull("name")) {
                        arrayList.add(new Catelogy(jSONArrayPoxy.getJSONObject(i3), i2));
                    }
                } catch (JSONException e2) {
                    e = e2;
    ...
    public static class MergedCatelogy implements Serializable {
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public static ArrayList<MergedCatelogy> toList(JSONArrayPoxy jSONArrayPoxy) {
            ArrayList<MergedCatelogy> arrayList;
            ArrayList<MergedCatelogy> arrayList2 = null;
            if (jSONArrayPoxy == null) {
                return null;
            }
            try {
                ...
                for (int i2 = 0; i2 < jSONArrayPoxy.length(); i2++) {
                    try {
                        if (jSONArrayPoxy.getJSONObject(i2) != null && !jSONArrayPoxy.getJSONObject(i2).isNull("name")) {
                            arrayList.add(new MergedCatelogy(jSONArrayPoxy.getJSONObject(i2)));
                        }
                    } catch (JSONException e2) {
                        e = e2;
                        arrayList2 = arrayList;
            ...
            if (OKLog.D) {
                OKLog.d(Catelogy.TAG, "list:" + arrayList);
            }
            return arrayList;
        }
