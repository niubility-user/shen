...
public class JDGuardHelper {
    ...
    */
    private static String keyMapping(String str, String str2) {
        char c2 = '\uffff';
        try {
            ...
            } else if (str2.equals(XView2Constants.XVIEW2_ACTION_INIT)) {
                c2 = 0;
            }
            String str3 = "-1103".equals(str) ? "initCost" : "initWorkerCost";
            return str3;
        } catch (Throwable unused) {
            return null;
        }
