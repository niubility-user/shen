...
public class JDAddressSelectViewHelper {
    ...
    private JDAddressSelectView.AddressHelper addressHelper = new JDAddressSelectView.AddressHelper() { // from class: com.jingdong.common.utils.JDAddressSelectViewHelper.1
        ...
        */
        public void loadAddress(int i2, String str, AddressGlobal addressGlobal, JDAddressSelectView.OnAddressLoadCompletedListener onAddressLoadCompletedListener) {
            String str2;
            boolean z;
            if (i2 == 1) {
                str2 = "usualAddress";
                ...
                if (i2 == 11) {
                    ...
                    if (i2 != 11 || str2.equals("directStock")) {
                        if (onAddressLoadCompletedListener != null) {
                            onAddressLoadCompletedListener.onThirdAddressLoadCompleted(true, 11, null, null, null);
                        }
                        if (JDAddressSelectViewHelper.this.mOnAddressListener == null) {
                            JDAddressSelectViewHelper.this.mOnAddressListener.onSelectCompleted(i2, addressGlobal, z);
                            return;
                        }
                        return;
                    }
                    JDAddressSelectViewHelper jDAddressSelectViewHelper = JDAddressSelectViewHelper.this;
                    jDAddressSelectViewHelper.queryThirdAddress(str2, i2, jDAddressSelectViewHelper.skuId, String.valueOf(addressGlobal.getIdProvince()), String.valueOf(addressGlobal.getIdCity()), String.valueOf(addressGlobal.getIdArea()), String.valueOf(addressGlobal.getIdTown()), z, addressGlobal.isGangAoTai, addressGlobal.isForeignOverSea);
                    return;
                }
            }
            z = false;
