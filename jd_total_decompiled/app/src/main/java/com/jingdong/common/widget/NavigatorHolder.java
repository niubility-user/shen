...
public class NavigatorHolder implements View.OnClickListener {
    ...
    /* JADX WARN: Removed duplicated region for block: B:142:0x0039  */
    ...
    */
    public void setNaviImmersive(boolean z, String str) {
        String str2;
        String str3;
        Context context = this.context;
        if (context == null || !(context instanceof Activity)) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                JSONObject jSONObject = new JSONObject(str);
                str2 = jSONObject.optString("blackImg", "");
                try {
                    str3 = jSONObject.optString("whiteImg", "");
                } catch (Exception e2) {
                    e = e2;
                    OKLog.e(TAG, e);
                    str3 = null;
                    if (WebNaviUtil.greaterOrEqualKitkat()) {
                    }
                }
            } catch (Exception e3) {
                e = e3;
        ...
        boolean z2 = false;
        if (z) {
            this.titleImageUrl1 = str2;
            this.titleImageUrl2 = str3;
            UnStatusBarTintUtil.defaultSetTranslucent(activity);
            setStatusBarHeightViewVisibility(0);
            this.statusBarHeightView.setBackgroundResource(R.color.status_bar_bg);
            UnStatusBarTintUtil.setStatusBarDarkMode(activity);
            this.statusTextStyle = 2;
            ...
            if (childAt != null) {
                childAt.invalidate();
                OKLog.d(TAG, "after setFitsSystemWindows false,rootview padding top: " + childAt.getPaddingTop());
                int statusBarHeight = WebNaviUtil.getStatusBarHeight(activity);
                int paddingTop = childAt.getPaddingTop();
                if (paddingTop >= statusBarHeight) {
                    childAt.setPadding(childAt.getPaddingLeft(), paddingTop - statusBarHeight, childAt.getPaddingRight(), childAt.getPaddingBottom());
                }
            }
            setNaviAndStatusBarHeightViewAlpha(0.0f);
            updateNaviIconAndTitle(2);
            this.naviRootView.setFocusable(true);
            this.naviRootView.setClickable(true);
            return;
        }
        this.titleImageUrl1 = null;
        this.titleImageUrl2 = null;
        if (this.statusbarAlwaysTransparent) {
            ...
            if (UnStatusBarTintUtil.setStatusBarDarkMode(activity)) {
                this.statusTextStyle = 2;
                this.statusBarHeightView.setBackgroundColor(WebNaviSettings.bgDarkModeColor);
                z2 = true;
            }
        ...
        setNaviAndStatusBarHeightViewAlpha(1.0f);
        updateNaviIconAndTitle(this.darkMode ? 2 : 1);
    }
