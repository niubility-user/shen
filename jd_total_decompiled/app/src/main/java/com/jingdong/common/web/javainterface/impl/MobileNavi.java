            ...
            this.webUiBinder.getBaseActivity().post(new Runnable() { // from class: com.jingdong.common.web.javainterface.impl.MobileNavi.3
                ...
                */
                public void run() {
                    ...
                    if (((BaseWebComponent) MobileNavi.this).webUiBinder == null || ((BaseWebComponent) MobileNavi.this).webUiBinder.getBaseActivity() == null || ((BaseWebComponent) MobileNavi.this).webUiBinder.getJdWebView() == null || (parseObject = JDJSON.parseObject(str)) == null) {
                        return;
                    }
                    ...
                    if (1 == optInt) {
                        ((BaseWebComponent) MobileNavi.this).webUiBinder.getJdWebView().setCanPullRefresh(true);
                    } else if (2 == optInt && (optJSONObject = parseObject.optJSONObject("refreshParams")) != null) {
                        int optInt2 = optJSONObject.optInt("maxTime");
                        String optString2 = optJSONObject.optString("refreshCallBackName");
                        if (!TextUtils.isEmpty(optString2)) {
                            ((BaseWebComponent) MobileNavi.this).webUiBinder.getJdWebView().setCanPullRefresh(true);
                            ((BaseWebComponent) MobileNavi.this).webUiBinder.getJdWebView().setMRefreshCallback(((BaseWebComponent) MobileNavi.this).webUiBinder, optString2, optInt2);
                        }
                    }
                    JDJSONObject optJSONObject2 = parseObject.optJSONObject("tranParams");
                    if (optJSONObject2 != null) {
                        if (z2) {
                            z = ((BaseWebComponent) MobileNavi.this).webUiBinder.getJdWebView().setImmersive(true, optJSONObject2.toJSONString());
                            navigatorHolder = ((BaseWebComponent) MobileNavi.this).webUiBinder.getJdWebView().getNavigatorHolder();
                            if (navigatorHolder != null) {
                                navigatorHolder.setTitleImgWidth(dip2px);
                                if (navigatorHolder.topLogoGrayEnable) {
                            ...
                            if (TextUtils.isEmpty(optString)) {
                                ...
                                try {
                                    int statusBarHeightPx = MobileNavi.this.getStatusBarHeightPx();
                                    int naviHeightPx = MobileNavi.this.getNaviHeightPx();
                                    int h5ContentTopPadding = MobileNavi.this.getH5ContentTopPadding(statusBarHeightPx, naviHeightPx);
                                    jSONObject.put("isImmersive", z);
                                    jSONObject.put("naviIsHidden", navigatorHolder != null ? navigatorHolder.isOnlyNaviGone() : false);
                                    jSONObject.put("naviBarHeight", h5ContentTopPadding);
                                    jSONObject.put("statusBarHeight", DPIUtil.px2dip(statusBarHeightPx));
                                    jSONObject.put("navigationHeight", DPIUtil.px2dip(naviHeightPx));
                                } catch (Exception e2) {
                                    if (Log.E) {
                                        Log.e(MobileNavi.this.TAG, e2.getMessage(), e2);
                                    }
                                }
                                WebUtils.sendJSONStr2M(((BaseWebComponent) MobileNavi.this).webUiBinder, optString, WebUtils.stringfyJSonData("0", jSONObject, ""));
                                return;
                            }
                            return;
                        }
    ...
    public void n(final String str) {
        ...
        if (jDWebView != null && this.isPreRender && !jDWebView.isAttached()) {
            this.webView.getXUiBinder().addCacheJsBridgeInterface(new ICallback() { // from class: com.jingdong.common.web.javainterface.impl.j
                @Override // com.jingdong.common.web.xrender.ICallback
                public final void execute() {
                    MobileNavi.this.n(str);
                }
            }, getName() + ".getActualNaviStatusHeight");
        } else if (TextUtils.isEmpty(str)) {
        } else {
            int px2dip = DPIUtil.px2dip(getStatusBarHeightPx());
            int px2dip2 = DPIUtil.px2dip(getNaviHeightPx());
            JDJSONObject jDJSONObject2 = null;
            try {
                jDJSONObject = new JDJSONObject();
                try {
                    jDJSONObject.put("statusBarHeight", (Object) Integer.valueOf(px2dip));
                    jDJSONObject.put("navigationHeight", (Object) Integer.valueOf(px2dip2));
                } catch (Exception e2) {
                    e = e2;
                    ...
                    this.webUiBinder.getBaseActivity().post(new Runnable() { // from class: com.jingdong.common.web.javainterface.impl.MobileNavi.13
                        @Override // java.lang.Runnable
                        public void run() {
                            ((BaseWebComponent) MobileNavi.this).webUiBinder.getJdWebView().injectJs("javascript:" + str + "('" + r3 + "');");
                        }
                    });
                }
            } catch (Exception e3) {
            ...
            final String jSONString = jDJSONObject == null ? jDJSONObject.toJSONString() : "";
            this.webUiBinder.getBaseActivity().post(new Runnable() { // from class: com.jingdong.common.web.javainterface.impl.MobileNavi.13
                @Override // java.lang.Runnable
                public void run() {
                    ((BaseWebComponent) MobileNavi.this).webUiBinder.getJdWebView().injectJs("javascript:" + str + "('" + jSONString + "');");
                }
            });
        }
    }
