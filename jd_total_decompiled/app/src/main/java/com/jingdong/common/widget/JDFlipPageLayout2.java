...
public class JDFlipPageLayout2 extends ViewGroup {
    ...
    */
    public boolean onTouchEvent(MotionEvent motionEvent) {
        OutSideTouchListener outSideTouchListener = this.mOutSideTouchListener;
        if (outSideTouchListener != null && this.isAddFinish) {
            outSideTouchListener.onTouchEvent(motionEvent);
        }
        ...
        if (action != 0) {
            ...
            if (this.mTouchState == 1) {
                ...
                if (Math.abs(yVelocity) > 1000) {
                    ...
                    } else if (yVelocity < 0 && this.mCurrentScreen == 0) {
                        snapToScreen(this.mDataIndex + 1);
                    } else {
                        snapToScreen(this.mDataIndex);
                    }
