...
public abstract class JshopFastjsonNextPageLoader implements HttpGroup.OnAllListener, IDestroyListener {
    ...
    public class BaseListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            if (JshopFastjsonNextPageLoader.this.mCallbackScrollListener != null) {
                JshopFastjsonNextPageLoader.this.mCallbackScrollListener.onScroll(absListView, i2, i3, i4);
            }
            JshopFastjsonNextPageLoader.this.onScroll(absListView, i2, i3, i4);
        }

        @Override // android.widget.AbsListView.OnScrollListener
        public void onScrollStateChanged(AbsListView absListView, int i2) {
            if (JshopFastjsonNextPageLoader.this.mCallbackScrollListener != null) {
                JshopFastjsonNextPageLoader.this.mCallbackScrollListener.onScrollStateChanged(absListView, i2);
            }
            JshopFastjsonNextPageLoader.this.onScrollStateChanged(absListView, i2);
        }
    }
    ...
    public class GalleryListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> adapterView, View view, int i2, long j2) {
            if (JshopFastjsonNextPageLoader.this.showItemList == null || r1.size() - 1 != i2 || JshopFastjsonNextPageLoader.this.isFinishing || JshopFastjsonNextPageLoader.this.isLoadedLastPage()) {
                return;
            }
            JshopFastjsonNextPageLoader.this.tryShowNextPage();
        }
    ...
    public abstract class OnScrollLastListener extends BaseListener {
        ...
        @Override // com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.BaseListener, android.widget.AbsListView.OnScrollListener
        public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
            this.firstVisibleItem = i2;
            this.visibleItemCount = i3;
            this.totalItemCount = i4;
            JshopFastjsonNextPageLoader.this.setSelection(i2);
    ...
    public JshopFastjsonNextPageLoader(IMyActivity iMyActivity, AdapterView adapterView, View view, String str) {
    ...
    */
    public void showNextPage(ArrayList<?> arrayList, boolean z) {
        ...
        boolean z2 = this.isNeedNoDateView;
        String str = StringUtil.no_data;
        if (z2 && this.showItemList.size() < 1) {
            ...
            if (adapterView instanceof ListView) {
                ...
                if (mySimpleAdapter != null) {
                    ...
                    final OnScrollLastListener onScrollLastListener = new OnScrollLastListener() { // from class: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.1
                        @Override // com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.OnScrollLastListener
                        public void onScrollFling() {
                            JshopFastjsonNextPageLoader.this.isFling = true;
                        }

                        @Override // com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.OnScrollLastListener
                        public void onScrollIdle() {
                            JshopFastjsonNextPageLoader.this.isHolding = false;
                            JshopFastjsonNextPageLoader.this.isFling = false;
                            if (JshopFastjsonNextPageLoader.this.isFinishing) {
                                return;
                            }
                            if (JshopFastjsonNextPageLoader.this.hasNotify) {
                                JshopFastjsonNextPageLoader.this.hasNotify = false;
                                if (JshopFastjsonNextPageLoader.this.adapter != null) {
                                    JshopFastjsonNextPageLoader.this.adapter.notifyDataSetChanged();
                                }
                            }
                            checkLast();
                        }
                        ...
                        public void onScrollLast() {
                            if (JshopFastjsonNextPageLoader.this.isFinishing || JshopFastjsonNextPageLoader.this.isLoadedLastPage()) {
                                return;
                            }
                            JshopFastjsonNextPageLoader.this.tryShowNextPage();
                        }
                    };
                    this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.2
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View view3, MotionEvent motionEvent) {
                            if (JshopFastjsonNextPageLoader.this.jdOnTouchListener != null) {
                                JshopFastjsonNextPageLoader.this.jdOnTouchListener.onTouch(view3, motionEvent);
                            }
                            int action = motionEvent.getAction();
                            if (action != 0) {
                                if (action == 1 && !JshopFastjsonNextPageLoader.this.isFling) {
                                    onScrollLastListener.onScrollIdle();
                                    return false;
                                }
                                return false;
                            }
                            JshopFastjsonNextPageLoader.this.isHolding = true;
                            return false;
                        }
                    });
                    ...
                    if (adapterView3 instanceof ListView) {
                        ...
                        this.adapterView.setOnTouchListener(new View.OnTouchListener() { // from class: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.3
                            @Override // android.view.View.OnTouchListener
                            public boolean onTouch(View view3, MotionEvent motionEvent) {
                                return false;
                            }
                ...
                this.handler.postDelayed(new Runnable() { // from class: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.4
                    @Override // java.lang.Runnable
                    public void run() {
                        ArrayList<Object> arrayList2;
                        JshopFastjsonNextPageLoader jshopFastjsonNextPageLoader = JshopFastjsonNextPageLoader.this;
                        if (jshopFastjsonNextPageLoader.adapterView == null || (arrayList2 = jshopFastjsonNextPageLoader.showItemList) == null || arrayList2.isEmpty() || JshopFastjsonNextPageLoader.this.showItemList.size() > JshopFastjsonNextPageLoader.this.adapterView.getChildCount()) {
                            return;
                        }
                        JshopFastjsonNextPageLoader.this.tryShowNextPage();
                    }
    ...
    public synchronized void tryShowNextPage() {
        ...
        if (this.nextItemList == null) {
            ...
            showNextPage(this.nextItemList, true);
        }
    }
    ...
    public MySimpleAdapter getMySimpleAdapter() {
        return this.adapter;
    }
    ...
    public void onEnd(final HttpResponse httpResponse) {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0043: INVOKE 
              (wrap: android.os.Handler : 0x003c: IGET (r3v0 'this' com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader A[IMMUTABLE_TYPE, THIS]) A[WRAPPED] (LINE:7) com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.handler android.os.Handler)
              (wrap: java.lang.Runnable : 0x0040: CONSTRUCTOR 
              (r3v0 'this' com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader A[IMMUTABLE_TYPE, THIS])
             ...
             A[MD:(com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader, java.util.ArrayList, com.jingdong.jdsdk.network.toolbox.HttpResponse):void (m), WRAPPED] call: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.5.<init>(com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader, java.util.ArrayList, com.jingdong.jdsdk.network.toolbox.HttpResponse):void type: CONSTRUCTOR)
             type: VIRTUAL call: android.os.Handler.post(java.lang.Runnable):boolean A[MD:(java.lang.Runnable):boolean (c)] (LINE:7) in method: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.onEnd(com.jingdong.jdsdk.network.toolbox.HttpResponse):void, file: classes6.dex
        ...
        L38:
            ...
            com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader$5 r2 = new com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader$5
            r2.<init>()
            r1.post(r2)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.onEnd(com.jingdong.jdsdk.network.toolbox.HttpResponse):void");
    }
    ...
    public void onError(HttpError httpError) {
        ...
        if (getTotalCount() == null || getTotalCount().longValue() != this.showItemList.size()) {
            ...
            if (iMyActivity != null) {
                iMyActivity.post(new Runnable() { // from class: com.jingdong.common.sample.jshop.utils.JshopFastjsonNextPageLoader.6
                    @Override // java.lang.Runnable
                    public void run() {
                        if (JshopFastjsonNextPageLoader.this.adapter != null) {
                            JshopFastjsonNextPageLoader.this.adapter.removeFooterView(JshopFastjsonNextPageLoader.this.loadingView);
                        }
                        JshopFastjsonNextPageLoader.this.needFooterView = true;
                    }
                });
            }
            showError(true);
    ...
    protected abstract void showError(boolean z);
    ...
    public JshopFastjsonNextPageLoader(IMyActivity iMyActivity, AdapterView adapterView, View view, String str, JSONObject jSONObject) {
        this(iMyActivity, adapterView, view, str);
        this.params = jSONObject;
        this.isPreloading = true;
    }

    public JshopFastjsonNextPageLoader(IMyActivity iMyActivity, AdapterView adapterView, View view, String str, JSONObject jSONObject, String str2) {
        this(iMyActivity, adapterView, view, str, jSONObject);
        this.noDataHint = str2;
        this.isPreloading = true;
    }

    public JshopFastjsonNextPageLoader(IMyActivity iMyActivity, AdapterView adapterView, View view, String str, JSONObject jSONObject, String str2, long j2) {
