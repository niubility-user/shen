...
public class Recommend9ProductViewHolder extends BaseRecommendBeltPriceViewHolder {
    ...
    /* JADX WARN: Removed duplicated region for block: B:56:0x001a  */
    /* JADX WARN: Removed duplicated region for block: B:65:? A[RETURN, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private float getViewRatio(RecommendProduct recommendProduct) {
        float parseFloat;
        if (recommendProduct == null) {
            return 1.0f;
        }
        if (!TextUtils.isEmpty(recommendProduct.longImageScale)) {
            try {
                parseFloat = Float.parseFloat(recommendProduct.longImageScale);
            } catch (NumberFormatException unused) {
            }
            if (parseFloat > 0.0f) {
                return recommendProduct.imageurlType != 0 ? 0.78f : 1.0f;
            }
            return parseFloat;
        }
        parseFloat = 0.0f;
    ...
    /* JADX WARN: Removed duplicated region for block: B:52:0x0028 A[RETURN] */
    /* JADX WARN: Removed duplicated region for block: B:54:0x002a A[RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
