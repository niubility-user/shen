    ...
    public class DomainDialingTask extends BaseDialingTask {
        ...
        */
        protected String dialing() {
            ...
            try {
                if (OKLog.D) {
                    OKLog.d(CDNRouteSelector.TAG, "DialingTask Dns\u67e5\u8be2\u5f00\u59cb: " + this.mDomain + " ===================");
                }
                long currentTimeMillis = System.currentTimeMillis();
                List<InetAddress> dnsLookup = CDNRouteSelector.this.dnsLookup(this.mDomain);
                long currentTimeMillis2 = System.currentTimeMillis() - currentTimeMillis;
                if (OKLog.D) {
                    OKLog.d(CDNRouteSelector.TAG, "DialingTask Dns\u67e5\u8be2\u7ed3\u675f\uff0c\u8017\u65f6 : " + this.mDomain + " -> " + currentTimeMillis2 + " ms.");
                }
                if (dnsLookup != null && !dnsLookup.isEmpty()) {
                    ...
                    final String str3 = !arrayList2.isEmpty() ? (String) arrayList2.get(0) : "";
                    final String str4 = !arrayList3.isEmpty() ? (String) arrayList3.get(0) : "";
                    if (OKLog.D) {
                        if (!TextUtils.isEmpty(str3)) {
                            OKLog.d(CDNRouteSelector.TAG, "DialingTask Dns\u67e5\u8be2\u7ed3\u679c " + this.mDomain + " V4s : " + arrayList2 + "\uff0c\u9009\u53d6\u7b2c\u4e00\u4f4d : " + str3 + " \u5373\u5c06\u63a2\u6d4b");
                        }
                        if (!TextUtils.isEmpty(str4)) {
                            OKLog.d(CDNRouteSelector.TAG, "DialingTask Dns\u67e5\u8be2\u7ed3\u679c " + this.mDomain + " V6s : " + arrayList3 + "\uff0c\u9009\u53d6\u7b2c\u4e00\u4f4d : " + str4 + " \u5373\u5c06\u63a2\u6d4b");
                        }
                    }
                    ...
                    if (TextUtils.isEmpty(str3)) {
                        str = "";
                        j2 = 0;
                    } else if (CDNRouteSelector.this.mAvailableIPSet.contains(str3)) {
                        if (OKLog.D) {
                            OKLog.e(CDNRouteSelector.TAG, "DialingTask " + this.mDomain + " \u5bf9\u5e94v4 " + str3 + " \u547d\u4e2d\u7f13\u5b58\u7ed3\u679c");
                        }
                        j2 = ((Long) CDNRouteSelector.this.mAvailableIPSet.get(str3)).longValue();
                        str = "";
                    } else {
                        if (OKLog.D) {
                            OKLog.e(CDNRouteSelector.TAG, "DialingTask " + this.mDomain + " \u5bf9\u5e94v4 " + str3 + " \u542f\u52a8\u63a2\u6d4b");
                        }
                        Future submit = GlobalExecutorService.newCachedThreadPool().submit(new Callable<Long>() { // from class: com.jingdong.common.network.CDNRouteSelector.DomainDialingTask.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // java.util.concurrent.Callable
                            public Long call() {
                                return Long.valueOf(DialingExecutor.connect(str3, 443, 2000));
                            }
                        });
                        if (submit != null) {
                            try {
                                j2 = ((Long) submit.get()).longValue();
                            } catch (Exception e2) {
                                e2.printStackTrace();
                            }
                            if (OKLog.D) {
                                ...
                                sb2.append(" \u63a2\u6d4b\u7ed3\u679c: ");
                                sb2.append(j2);
                                OKLog.e(CDNRouteSelector.TAG, sb2.toString());
                            }
                            if (j2 > 0) {
                                CDNRouteSelector.this.mAvailableIPSet.put(str3, Long.valueOf(j2));
                            }
                        }
                        j2 = 0;
                        if (OKLog.D) {
                    ...
                    if (TextUtils.isEmpty(str4)) {
                        j3 = 0;
                    } else if (CDNRouteSelector.this.mAvailableIPSet.contains(str4)) {
                        if (OKLog.D) {
                            OKLog.e(CDNRouteSelector.TAG, "DialingTask " + this.mDomain + " \u5bf9\u5e94v6 " + str4 + " \u547d\u4e2d\u7f13\u5b58\u7ed3\u679c");
                        }
                        j3 = ((Long) CDNRouteSelector.this.mAvailableIPSet.get(str4)).longValue();
                    } else {
                        if (OKLog.D) {
                            OKLog.e(CDNRouteSelector.TAG, "DialingTask " + this.mDomain + " \u5bf9\u5e94v6 " + str4 + " \u542f\u52a8\u63a2\u6d4b");
                        }
                        Future submit2 = GlobalExecutorService.newCachedThreadPool().submit(new Callable<Long>() { // from class: com.jingdong.common.network.CDNRouteSelector.DomainDialingTask.2
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // java.util.concurrent.Callable
                            public Long call() {
                                return Long.valueOf(DialingExecutor.connect(str4, 443, 2000));
                            }
                        });
                        if (submit2 != null) {
                            try {
                                longValue = ((Long) submit2.get()).longValue();
                            } catch (Exception e3) {
                                e3.printStackTrace();
                            }
                            if (OKLog.D) {
                                OKLog.e(CDNRouteSelector.TAG, "DialingTask " + this.mDomain + " \u5bf9\u5e94v6 " + str4 + " \u63a2\u6d4b\u7ed3\u679c: " + longValue);
                            }
                            if (longValue > 0) {
                                CDNRouteSelector.this.mAvailableIPSet.put(str4, Long.valueOf(longValue));
                            }
                            j3 = longValue;
                        }
                        longValue = 0;
                    ...
                    if (OKLog.D) {
                        OKLog.d(CDNRouteSelector.TAG, "DialingTask Dns\u63a2\u6d4b\u7ed3\u679c : " + this.mDomain + "\u3010v4\u901f\u5ea6 : " + j2 + "\uff0cv6\u901f\u5ea6 : " + j3 + "\u3011 \u63a2\u6d4b\u8017\u65f6 \uff1a" + currentTimeMillis4 + "\u6beb\u79d2");
                        StringBuilder sb3 = new StringBuilder();
                        sb3.append("DialingTask Dns\u63a2\u6d4b\u7ed3\u679c : ");
                        sb3.append(this.mDomain);
                        sb3.append(" \u6700\u7ec8\u7ed3\u679c : ");
                        sb3.append(str2);
                        OKLog.d(CDNRouteSelector.TAG, sb3.toString());
                    }
                    return str2;
                }
                if (OKLog.D) {
                    OKLog.e(CDNRouteSelector.TAG, "DialingTask " + this.mDomain + "Dns\u89e3\u6790\u5931\u8d25 :<");
                }
                this.mStatus = 2;
                return null;
            } finally {
