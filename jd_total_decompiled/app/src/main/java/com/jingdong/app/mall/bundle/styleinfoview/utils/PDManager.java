...
import com.jingdong.app.mall.bundle.styleinfoview.entitys.PDVedioShareEntity;
import com.jingdong.app.mall.bundle.styleinfoview.floor.FloorThemeHelper;
...
public class PDManager {
    ...
    public static void showProduct(String str, String str2) {
        getInstances(str).post("pd_ProductDetailActivity", "pd_PDTopViewrefreshProduct", str2);
    }
