        ...
        if (n() == null) {
            ...
            if (n2 == null) {
                ...
                if (this.mPreWidth != d.f9279g) {
                    f.c(this.mEmptyImage, this.mEmptyImgSize);
                    f.c(this.mEmptyTv, this.mEmptyTvSize);
                    f.c(this.mNoneImage, this.mNoneImgSize);
                    f.c(this.mTvNone, this.mNoneTvSize);
                    f.c(this.mProgressBar, this.mProgressSize);
                    this.mTvLoading.setTextSize(0, d.d(30));
                    this.mTvError.setTextSize(0, d.d(30));
                    this.mTvNone.setTextSize(0, d.d(24));
                    this.mEmptyTv.setTextSize(0, d.d(24));
                    this.mPreWidth = d.f9279g;
                }
                this.mLoadingView.setVisibility((num != null && num.intValue() == 4) ? 0 : 8);
                this.mLoadingLayout.setVisibility((num != null && num.intValue() == 0) ? 0 : 8);
                this.mTvError.setVisibility((num != null && num.intValue() == 1) ? 0 : 8);
                this.mNoneImage.setVisibility((num != null && num.intValue() == 2) ? 0 : 8);
                this.mTvNone.setVisibility((num != null && num.intValue() == 2) ? 0 : 8);
                this.mEmptyImage.setVisibility((num != null && num.intValue() == 3) ? 0 : 8);
                this.mEmptyTv.setVisibility((num == null && num.intValue() == 3) ? 0 : 8);
            }
            G = n2.G();
        }
