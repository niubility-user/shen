...
public class PDCouponAdditionEntity implements Parcelable {
    public static final Parcelable.Creator<PDCouponAdditionEntity> CREATOR = new Parcelable.Creator<PDCouponAdditionEntity>() { // from class: com.jingdong.app.mall.bundle.styleinfoview.entitys.coupon.PDCouponAdditionEntity.1
