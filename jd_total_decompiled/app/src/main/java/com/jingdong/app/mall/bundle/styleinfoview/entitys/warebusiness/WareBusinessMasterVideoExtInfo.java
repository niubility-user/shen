...
public class WareBusinessMasterVideoExtInfo implements Parcelable {
    public static final Parcelable.Creator<WareBusinessMasterVideoExtInfo> CREATOR = new Parcelable.Creator<WareBusinessMasterVideoExtInfo>() { // from class: com.jingdong.app.mall.bundle.styleinfoview.entitys.warebusiness.WareBusinessMasterVideoExtInfo.1
