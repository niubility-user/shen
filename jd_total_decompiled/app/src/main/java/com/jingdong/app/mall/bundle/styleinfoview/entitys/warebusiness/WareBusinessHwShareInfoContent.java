...
public class WareBusinessHwShareInfoContent implements Parcelable {
    public static final Parcelable.Creator<WareBusinessHwShareInfoContent> CREATOR = new Parcelable.Creator<WareBusinessHwShareInfoContent>() { // from class: com.jingdong.app.mall.bundle.styleinfoview.entitys.warebusiness.WareBusinessHwShareInfoContent.1
