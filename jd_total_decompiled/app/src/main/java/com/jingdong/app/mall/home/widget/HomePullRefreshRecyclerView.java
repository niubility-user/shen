...
public class HomePullRefreshRecyclerView extends BaseVerticalRefresh<RecyclerView> {
    ...
    /*  JADX ERROR: NullPointerException in pass: RegionMakerVisitor
        java.lang.NullPointerException
        	...
        	at jadx.core.utils.BlockUtils.getPathCross(BlockUtils.java:739)
        	at jadx.core.utils.BlockUtils.getPathCross(BlockUtils.java:818)
        	...
        	at jadx.core.dex.visitors.regions.RegionMaker.processIf(RegionMaker.java:744)
        	at jadx.core.dex.visitors.regions.RegionMaker.traverse(RegionMaker.java:156)
        	at jadx.core.dex.visitors.regions.RegionMaker.makeRegion(RegionMaker.java:95)
