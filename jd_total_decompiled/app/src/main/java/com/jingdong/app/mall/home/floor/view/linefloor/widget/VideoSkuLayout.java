...
public class VideoSkuLayout extends BaseAnimateLayout {
    ...
    */
    private void x(com.jingdong.app.mall.home.floor.view.linefloor.base.b bVar, f fVar, boolean z, int i2) {
        String j2;
        boolean z2;
        c cVar = bVar.a;
        if (cVar != c.SPECIAL) {
        ...
        this.p = cVar.changeSkuSize(this, this.s, z, bVar);
        if (!z) {
            t(true, this.y);
            return;
        }
        SkuLabelSpecialLayout skuLabelSpecialLayout = this.y;
        if (skuLabelSpecialLayout == null) {
            this.y = new SkuLabelSpecialLayout(getContext());
            f fVar2 = new f(-1, 36);
            this.z = fVar2;
            fVar2.E(0, -14, 0, 0);
            this.z.J(0, 0, 0, 2);
            ...
            f.c(skuLabelSpecialLayout, this.z);
        }
        t(false, this.y);
        this.y.setBgColor(bVar.X(i2), fVar.v());
        this.y.setTextGradient(GradientTextView.GradientType.LeftToRight, bVar.a0(i2));
        String b0 = bVar.b0(i2);
        if ("1".equals(bVar.U(i2))) {
            j2 = com.jingdong.app.mall.home.category.floor.feedssub.a.d(b0, OrderISVUtil.MONEY_DECIMAL, 1.0f).toString();
        } else {
            j2 = com.jingdong.app.mall.home.o.a.f.j(6, b0);
            if (j2.length() >= 6) {
                z2 = true;
                this.z.J(0, 0, 0, z2 ? 6 : 2);
                this.y.setText(j2, !z2 ? 20 : 22);
                f.d(this.y, this.z, true);
            }
        }
        z2 = false;
        this.z.J(0, 0, 0, z2 ? 6 : 2);
