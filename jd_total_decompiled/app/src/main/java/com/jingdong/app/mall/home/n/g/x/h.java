...
public final class h extends com.jingdong.app.mall.home.n.g.u.f {
    public h(@Nullable JDJSONObject jDJSONObject, @Nullable com.jingdong.app.mall.home.n.b bVar) {
    ...
    protected void n(@NotNull com.jingdong.app.mall.home.n.g.v.c cVar) {
        cVar.p("Category_Main_Subcategory_Detail");
    }
