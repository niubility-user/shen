...
public class PdActiveRuleContent implements Parcelable {
    public static final Parcelable.Creator<PdActiveRuleContent> CREATOR = new Parcelable.Creator<PdActiveRuleContent>() { // from class: com.jingdong.app.mall.bundle.styleinfoview.entitys.giftshopping.PdActiveRuleContent.1
