                    ...
                    if (i5 != 16) {
                        ...
                        if (i5 != 0) {
                            if (str.regionMatches(i2, ":", 0, 1)) {
                                i2++;
                            } else if (!str.regionMatches(i2, OrderISVUtil.MONEY_DECIMAL, 0, 1) || !decodeIpv4Suffix(str, i7, i3, bArr, i5 - 2)) {
                                return null;
                            } else {
                                i5 += 2;
                            }
                        ...
                        int i92 = 0;
                        while (i2 < i3) {
                            int decodeHexDigit = DeepLinkUri.decodeHexDigit(str.charAt(i2));
                            if (decodeHexDigit == -1) {
                                break;
                            }
