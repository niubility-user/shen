...
public class FloorCooperateManager {
    ...
    */
    private IBaseView getLocalBaseView(ViewGroup viewGroup, String str, String str2) {
            ...
            for (BaseLoadFloorOption baseLoadFloorOption : list) {
                if (baseLoadFloorOption != null) {
                    try {
                        ...
                        if (registViews != null) {
                            ...
                            while (it.hasNext()) {
                                if (TextUtils.equals(it.next(), str)) {
                                    IBaseView createView = baseLoadFloorOption.createView(viewGroup, str);
                                    createView.onCreateView(viewGroup);
                                    if (createView != null && str2 != null) {
                        ...
                        HashMap<String, Class<? extends IBaseView>> viewList = baseLoadFloorOption.getViewList();
                        if (viewList != null) {
                            Iterator<Map.Entry<String, Class<? extends IBaseView>>> it2 = viewList.entrySet().iterator();
                            while (true) {
                                if (it2.hasNext()) {
                                    Map.Entry<String, Class<? extends IBaseView>> next = it2.next();
                                    if (TextUtils.equals(next.getKey(), str)) {
                                        Class<? extends IBaseView> value = next.getValue();
                                        if (value != null) {
                                            IBaseView newInstance = value.newInstance();
                                            newInstance.onCreateView(viewGroup);
                                            if (str2 != null) {
                                                newInstance.onBindData(str2);
                                            }
                                            return newInstance;
                                        }
                                    }
                        ...
                        reportOptionError(baseLoadFloorOption, "getLocalBaseView");
