...
public class d {
    ...
    */
    private com.jingdong.sdk.jdcrashreport.e.a.a a(String str) {
        BufferedReader bufferedReader;
        BufferedReader bufferedReader2;
        String group;
        Pattern compile = Pattern.compile("^-----\\spid\\s(\\d+)\\sat\\s(.+)\\s-----$");
        Pattern compile2 = Pattern.compile("^Cmd\\sline:\\s+(.*)$");
        StringBuilder sb = new StringBuilder();
        StringBuilder sb2 = new StringBuilder();
        r.b("JDCrashReport", "parse trace file");
        try {
                ...
                while (true) {
                    try {
                        try {
                            ...
                            if (!z && trim.startsWith("----- pid ")) {
                                Matcher matcher = compile.matcher(trim);
                                if (matcher.find() && matcher.groupCount() == 2) {
                                    String group2 = matcher.group(1);
                                    str2 = matcher.group(2);
                                    if (group2 != null && str2 != null && this.a == Integer.parseInt(group2)) {
                                        String readLine2 = bufferedReader2.readLine();
                                        if (readLine2 == null) {
                                            break loop0;
                                        }
                                        Matcher matcher2 = compile2.matcher(readLine2);
                                        if (matcher2.find() && matcher2.groupCount() == 1 && (group = matcher2.group(1)) != null && group.equals(this.b)) {
                        ...
                        e = e2;
                        r.c("JDCrashReport", String.format(Locale.getDefault(), "parse trace file exception, %s", e.getMessage()), e);
            ...
            if (sb.length() > 0) {
                return new com.jingdong.sdk.jdcrashreport.e.a.a(this.a, this.b, str3, sb.toString(), sb2.toString());
            }
            r.b("JDCrashReport", String.format(Locale.getDefault(), "Not found trace of process '%s(%d)' need to process", this.b, Integer.valueOf(this.a)));
            return null;
        } catch (Exception e3) {
            e = e3;
