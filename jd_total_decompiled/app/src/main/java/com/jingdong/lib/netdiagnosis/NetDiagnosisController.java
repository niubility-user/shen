...
public class NetDiagnosisController {
    ...
    public class h implements Callable<Object> {
        ...
        /* JADX WARN: Removed duplicated region for block: B:274:0x00c7 A[EXC_TOP_SPLITTER, SYNTHETIC] */
        @Override // java.util.concurrent.Callable
        /*
        ...
        */
        public Object call() throws Exception {
            ...
            JSONArray jSONArray;
            NetDiagnosisController netDiagnosisController = NetDiagnosisController.this;
            netDiagnosisController.saveFile = netDiagnosisController.getSaveFile();
            File file = NetDiagnosisController.this.saveFile;
            ...
            synchronized (file) {
                try {
                    try {
                        lineNumberReader = new LineNumberReader(new FileReader(NetDiagnosisController.this.saveFile));
                        try {
                    ...
                    if (jSONArray.length() <= 0) {
                        try {
                            ...
                            if (OKLog.E) {
                                OKLog.e(NetDiagnosisController.TAG, e4);
                            }
                        }
                        return null;
                    }
                    ...
                    try {
                        ...
                        try {
                            ...
                            e = e5;
                            if (OKLog.E) {
                                str = NetDiagnosisController.TAG;
                                OKLog.e(str, e);
                            }
                        }
                    } catch (Exception e6) {
                        e = e6;
                        if (OKLog.E) {
                            OKLog.e(NetDiagnosisController.TAG, e);
                        }
                        ...
                        httpSetting.setFunctionId(NetDiagnosisController.FUNCTIONID);
                    ...
                    try {
                        HttpGroupSetting createNewSettings2 = HttpGroupUtils.createNewSettings();
                        createNewSettings2.setPriority(1000);
                        createNewSettings2.setType(1000);
                        HttpGroup httpGroup2 = HttpGroup.getHttpGroup(createNewSettings2);
                        HttpSetting httpSetting2 = new HttpSetting();
                        httpSetting2.setFunctionId(NetDiagnosisController.FUNCTIONID);
                        httpSetting2.setHost(Configuration.getNgwHost());
                        httpSetting2.setJsonParams(jSONObject);
                        httpSetting2.setListener(new a());
                        httpGroup2.add(httpSetting2);
                    } catch (Exception e8) {
                        OKLog.e(NetDiagnosisController.TAG, e8);
                    }
                    return null;
                } catch (Throwable th3) {
                    th = th3;
                    if (0 != 0) {
                        try {
                            ...
                            if (OKLog.E) {
                                OKLog.e(NetDiagnosisController.TAG, e9);
                            }
                        }
                    }
                    throw th;
    ...
    /* JADX WARN: Not initialized variable reg: 2, insn: 0x0061: MOVE (r1 I:??[OBJECT, ARRAY]) = (r2 I:??[OBJECT, ARRAY]), block:B:91:0x0061 */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:265:0x0062, code lost:
        if (r2 == null) goto L267;
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:304:0x00f7 A[Catch: all -> 0x010e, TRY_LEAVE, TryCatch #11 {, blocks: (B:306:0x00fe, B:314:0x010c, B:311:0x0105, B:293:0x00e4, B:287:0x00d9, B:290:0x00de, B:302:0x00f3, B:304:0x00f7), top: B:329:0x0028 }] */
    /* JADX WARN: Removed duplicated region for block: B:330:0x00fe A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Type inference failed for: r2v13, types: [java.lang.String] */
    /* JADX WARN: Type inference failed for: r2v2 */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void saveReport2File(String str) {
        LineNumberReader lineNumberReader;
        ...
        synchronized (saveFile) {
            ...
            try {
                try {
                    try {
                        lineNumberReader2 = new LineNumberReader(new FileReader(this.saveFile));
                        try {
                    ...
                    BufferedWriter bufferedWriter2 = new BufferedWriter(new FileWriter(this.saveFile, z));
                    try {
                        if (!z) {
                            int size2 = arrayList.size();
                            for (int i2 = 0; i2 < size2; i2++) {
                                if (i2 == 0) {
                                    bufferedWriter2.append((CharSequence) arrayList.get(i2));
                                } else {
                                    bufferedWriter2.append((CharSequence) (ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + ((String) arrayList.get(i2))));
                                }
                            }
                        } else if (size == 0) {
                            bufferedWriter2.append((CharSequence) str);
                        } else {
                            bufferedWriter2.append((CharSequence) (ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + str));
                        }
