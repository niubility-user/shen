...
public class UPTsmAddon {
    ...
    /* JADX WARN: Removed duplicated region for block: B:115:0x0052 A[Catch: all -> 0x006d, TRY_ENTER, TRY_LEAVE, TryCatch #2 {, blocks: (B:100:0x000a, B:102:0x000e, B:104:0x001c, B:106:0x0022, B:107:0x0038, B:115:0x0052, B:110:0x0040, B:111:0x0048, B:112:0x0049, B:121:0x005b, B:122:0x0063, B:123:0x0064), top: B:137:0x000a, inners: #0, #1 }] */
    /* JADX WARN: Removed duplicated region for block: B:118:0x0058 A[DONT_GENERATE] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public synchronized int clearEncryptData(int i2) throws RemoteException {
        ...
        if (i2 < 2000 || i2 > 2002) {
            ...
            i3 = -1;
        } else if (!b(this.f18196c.getPackageName())) {
            return a(4, (SafetyKeyboardRequestParams) null, i2, (OnSafetyKeyboardCallback) null, (Context) null);
        } else if (d()) {
            ...
            try {
                clearEncryptData = this.f18197e.clearKeyboardEncryptData(clearEncryptDataRequestParams, i2);
            ...
            try {
                clearEncryptData = this.f18197e.clearEncryptData(i2);
                if (-2 != clearEncryptData) {
                }
            } catch (Exception e3) {
                e3.printStackTrace();
    ...
    /* JADX WARN: Removed duplicated region for block: B:101:0x0050 A[DONT_GENERATE] */
    /* JADX WARN: Removed duplicated region for block: B:98:0x004a A[Catch: all -> 0x0065, TRY_ENTER, TRY_LEAVE, TryCatch #0 {, blocks: (B:83:0x0001, B:85:0x0005, B:87:0x0014, B:89:0x001a, B:90:0x0030, B:98:0x004a, B:93:0x0038, B:94:0x0040, B:95:0x0041, B:104:0x0053, B:105:0x005b, B:106:0x005c), top: B:115:0x0001, inners: #1, #2 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public synchronized int hideKeyboard() throws RemoteException {
        ...
        if (!b(this.f18196c.getPackageName())) {
            ...
            try {
                hideKeyboard = this.f18197e.hideSafetyKeyboard(hideSafetyKeyboardRequestParams);
                if (-2 != hideKeyboard) {
                    return a(5, (SafetyKeyboardRequestParams) null, 0, (OnSafetyKeyboardCallback) null, (Context) null);
                }
                return hideKeyboard;
            ...
            try {
                hideKeyboard = this.f18197e.hideKeyboard();
                if (-2 != hideKeyboard) {
                }
            } catch (Exception e3) {
                e3.printStackTrace();
