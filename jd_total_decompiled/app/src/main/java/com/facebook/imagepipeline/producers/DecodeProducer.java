    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        */
        public void doDecode(EncodedImage encodedImage, int i2) {
            ...
            String str2 = encodedImage.getWidth() + JshopConst.JSHOP_PROMOTIO_X + encodedImage.getHeight();
            ...
            if (resizeOptions != null) {
                str = resizeOptions.width + JshopConst.JSHOP_PROMOTIO_X + resizeOptions.height;
            }
            String str3 = str;
            try {
                ...
                try {
                        ...
                        try {
                            if (!z && !statusHasFlag) {
                                ...
                                if (!z && !statusHasFlag) {
                                    ...
                                    this.mProducerListener.onProducerFinishWithSuccess(this.mProducerContext, DecodeProducer.PRODUCER_NAME, getExtraMap(decode, queuedTime, qualityInfo, isLast, name, str2, str3, valueOf));
                                    if (decode != null) {
                                        decode.setOriginalEncodedImageInfo(new OriginalEncodedImageInfo(this.mProducerContext.getImageRequest().getSourceUri(), this.mProducerContext.getEncodedImageOrigin(), this.mProducerContext.getCallerContext(), encodedImage.getWidth(), encodedImage.getHeight(), encodedImage.getSize()));
                                    }
                            ...
                            e = e2;
                            closeableImage = decode;
                            this.mProducerListener.onProducerFinishWithFailure(this.mProducerContext, DecodeProducer.PRODUCER_NAME, e, getExtraMap(closeableImage, queuedTime, qualityInfo, isLast, name, str2, str3, valueOf));
                            handleError(e);
                            return;
                        }
                        decode = DecodeProducer.this.mImageDecoder.decode(encodedImage, size, qualityInfo, this.mImageDecodeOptions);
                    ...
                    EncodedImage encodedImage2 = e4.getEncodedImage();
                    FLog.w("ProgressiveDecoder", "%s, {uri: %s, firstEncodedBytes: %s, length: %d}", e4.getMessage(), valueOf2, encodedImage2.getFirstBytesAsHexString(10), Integer.valueOf(encodedImage2.getSize()));
                    throw e4;
                }
