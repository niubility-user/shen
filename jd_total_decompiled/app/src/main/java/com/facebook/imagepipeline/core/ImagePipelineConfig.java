    ...
    */
    private ImagePipelineConfig(Builder builder) {
        ...
        if (webpBitmapFactory == null) {
            honeycombBitmapCreator = (build.isWebpSupportEnabled() && WebpSupportStatus.sIsWebpSupportRequired && (webpBitmapFactory = WebpSupportStatus.loadWebpBitmapFactoryIfExists()) != null) ? new HoneycombBitmapCreator(getPoolFactory()) : honeycombBitmapCreator;
            if (FrescoSystrace.isTracing()) {
                return;
            }
            FrescoSystrace.endSection();
        ...
        setWebpBitmapFactory(webpBitmapFactory, build, honeycombBitmapCreator);
        if (FrescoSystrace.isTracing()) {
        }
    }
