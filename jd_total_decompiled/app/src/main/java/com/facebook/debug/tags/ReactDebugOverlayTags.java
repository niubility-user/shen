...
public class ReactDebugOverlayTags {
    ...
    public static final DebugOverlayTag NAVIGATION = new DebugOverlayTag("Navigation", "Tag for navigation", Color.rgb((int) R2.anim.out_to_bottom_slow, 39, (int) R2.anim.popup_center_enter));
