...
public class ReactScrollView extends ScrollView implements ReactClippingViewGroup, ViewGroup.OnHierarchyChangeListener, View.OnLayoutChangeListener {
    ...
    */
    public void flingAndSnap(int i2) {
        ...
        int i8 = predictFinalScrollPosition - i4;
        ...
        if (!this.mSnapToEnd && predictFinalScrollPosition >= i3) {
            ...
            i5 = predictFinalScrollPosition;
        } else if (this.mSnapToStart || predictFinalScrollPosition > i5) {
            if (i2 > 0) {
                double d3 = i9;
                Double.isNaN(d3);
                i6 = i2 + ((int) (d3 * 10.0d));
            ...
            if (overScroller != null) {
                ...
                overScroller.fling(scrollX, scrollY, 0, i6, 0, 0, min22, min22, 0, (min22 == 0 || min22 == maxScrollY) ? height / 2 : 0);
                postInvalidateOnAnimation();
                return;
            }
            smoothScrollTo(getScrollX(), min22);
            return;
        }
        i6 = i2;
        int min222 = Math.min(Math.max(0, i5), maxScrollY);
        overScroller = this.mScroller;
        if (overScroller != null) {
        }
    }
    ...
    */
    private ViewGroup getScrollView() {
        View view = this;
        while (view != null && view.getParent() != null && !(view.getParent() instanceof ReactHorizontalScrollView)) {
