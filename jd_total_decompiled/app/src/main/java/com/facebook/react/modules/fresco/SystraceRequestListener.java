...
public class SystraceRequestListener extends BaseRequestListener {
    ...
    public void onProducerEvent(String str, String str2, String str3) {
        if (Systrace.isTracing(0L)) {
            Systrace.traceInstant(0L, "FRESCO_PRODUCER_EVENT_" + str.replace(':', '_') + CartConstant.KEY_YB_INFO_LINK + str2.replace(':', '_') + CartConstant.KEY_YB_INFO_LINK + str3.replace(':', '_'), Systrace.EventScope.THREAD);
        }
    }
