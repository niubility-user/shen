...
public class MessageQueueThreadImpl implements MessageQueueThread {
    ...
    public void quitSynchronous() {
        ...
        MessageQueueThreadHandler messageQueueThreadHandler = this.mHandler;
        if (messageQueueThreadHandler != null) {
            messageQueueThreadHandler.destroy();
        }
    }
    ...
    public void assertIsOnThread(String str) {
        SoftAssertions.assertCondition(isOnThread(), this.mAssertionErrorMessage + LangUtils.SINGLE_SPACE + str);
    }
}
