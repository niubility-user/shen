...
public class ReactHorizontalScrollView extends HorizontalScrollView implements ReactClippingViewGroup {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:63:0x0028, code lost:
        if ((r0.getParent() instanceof com.facebook.react.views.scroll.ReactHorizontalScrollView) != false) goto L66;
     */
    /* JADX WARN: Code restructure failed: missing block: B:65:0x0030, code lost:
        if ((r0.getParent() instanceof androidx.viewpager.widget.ViewPager) == false) goto L74;
     */
