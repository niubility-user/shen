            ...
            if (!uri.toString().equals("")) {
                ...
                if (string == null) {
                    ...
                    if (string.equals("addToQQFavorites")) {
                        ...
                        intent2.putExtra(Constants.KEY_REQUEST_CODE, 10108);
                        ...
                        intent3.putExtra(Constants.KEY_REQUEST_CODE, 10110);
                        ...
                        intent4.putExtra(Constants.KEY_REQUEST_CODE, 10109);
                        ...
                        intent5.putExtra(Constants.KEY_REQUEST_CODE, 10112);
                        ...
                        intent6.putExtra(Constants.KEY_REQUEST_CODE, 10111);
                        ...
                        intent7.putExtra(Constants.KEY_REQUEST_CODE, 10113);
