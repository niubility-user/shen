...
public class BaseWXApiImplV10 implements IWXAPI {
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                if (iWXChannelJumpInfo instanceof WXChannelJumpMiniProgramInfo) {
                    jSONObject.put(MobileCertConstants.USERNAME, ((WXChannelJumpMiniProgramInfo) iWXChannelJumpInfo).username);
    ...
    private String getTokenFromWX(Context context) {
        Cursor query = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "638062336"}, null);
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (b.b(queryParameter)) {
            ...
            resp.scene = b.a(parse.getQueryParameter(BaseEvent.SCENE), 0);
    ...
    public boolean registerApp(String str, long j2) {
        ...
        c0805a.a = "com.tencent.mm";
        c0805a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0805a.f17599c = "weixin://registerapp?appid=" + this.appId;
        c0805a.d = j2;
        return a.a(this.context, c0805a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0805a c0805a = new a.C0805a();
        c0805a.a = "com.tencent.mm";
        c0805a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0805a.f17599c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0805a);
    }
}
