...
public class c {
    ...
    public boolean c() {
        ...
        sb.append(this.b.isSessionValid() ? DYConstants.DY_TRUE : DYConstants.DY_FALSE);
    ...
    public int a(Activity activity, IUiListener iUiListener, Map<String, Object> map) {
        ...
        return a(activity, (Fragment) null, m.a(map, Constants.KEY_SCOPE, NavigationDbConstants.TB_COLUMN_FREQUENCY_RULE_POSITION_ALL), iUiListener, "", m.a(map, Constants.KEY_QRCODE, false), map);
    }
