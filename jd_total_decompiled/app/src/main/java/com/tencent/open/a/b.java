...
public class b implements a {
    ...
    private void a(HttpURLConnection httpURLConnection) {
        ...
        httpURLConnection.setRequestProperty("User-Agent", this.f17633c);
    ...
    public g a(String str, Map<String, String> map, String str2, byte[] bArr) throws IOException {
        ...
        try {
            ...
            try {
                ...
                httpURLConnection.setRequestProperty(HttpHeaders.CONTENT_TYPE, HTTP.CONTENT_TYPE_FORM_DATA + ";boundary=" + uuid);
            } catch (Throwable th) {
                th = th;
            }
        } catch (Throwable th2) {
