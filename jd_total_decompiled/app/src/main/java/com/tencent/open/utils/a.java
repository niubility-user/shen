...
public class a {
    ...
    private SecretKeySpec c() throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            return new SecretKeySpec(cipher.doFinal(Base64.decode(string, 0)), AES.ALGORITHM_STANDARD);
        }
        return new SecretKeySpec(Base64.decode(string, 0), AES.ALGORITHM_STANDARD);
    }
