...
public class xc extends AggregationOverlayInfo implements uc {
    private AggregationOverlayProvider a;

    public xc(AggregationOverlayProvider aggregationOverlayProvider) {
    ...
    public xc(VectorHeatOverlayOptions vectorHeatOverlayOptions) {
