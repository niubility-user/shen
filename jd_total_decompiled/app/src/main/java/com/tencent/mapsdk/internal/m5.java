...
public class m5 implements BitmapDescriptor.BitmapFormator {
    ...
    */
    private Bitmap a(Context context, int i2) {
        ...
        switch (i2) {
            case 1:
                return a7.a(context, this.f16861c);
            case 2:
                Bitmap b = a7.b(context, this.d);
                if (b == null) {
                    Bitmap c2 = a7.c(context, this.d);
                    return (c2 == null || this.d.equals(s5.M)) ? c2 : a7.a(c2);
                }
                return b;
            case 3:
                return a7.a(context, this.f16862e);
            case 4:
                return a7.a(this.f16863f);
            case 5:
                str = "marker_default.png";
                return a7.c(context, str);
            case 6:
                str = a(this.f16864g);
                break;
            case 7:
