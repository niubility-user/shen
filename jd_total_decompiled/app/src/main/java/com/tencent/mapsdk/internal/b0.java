...
public class b0 implements g5, ke {
    ...
    */
    private void k() {
        JSONArray jSONArray;
        VectorMap vectorMap;
        int b2 = this.f16258g.b(l4.B);
        int b3 = this.f16258g.b(l4.C);
        String d2 = this.f16258g.d(l4.D);
        try {
        } catch (Exception e2) {
            ma.a(la.f16827n, "indoor auth init failed", e2);
        }
        if (!TextUtils.isEmpty(d2)) {
            jSONArray = new JSONArray(d2);
            if (b2 != -1 && b3 != -1 && jSONArray != null) {
                this.f16259h = new r5(b2, b3, jSONArray);
            }
            vectorMap = this.f16264m;
            if (vectorMap == null) {
                vectorMap.a(j());
                if (b3 == 1) {
                    this.f16264m.a(c());
