    ...
    public class c implements Runnable {
        ...
        */
        public void run() {
            ...
            NetResponse report;
            g gVar = g.UPLOAD;
            i.a(gVar).a(this.a).a(f.START).a(e6.this.f16445k);
            byte[] bArr = this.a;
            if (bArr == null || bArr.length == 0) {
                e eVar2 = this.b;
                if (eVar2 != null) {
                ...
                i.a(gVar).a((byte[]) null).a(false).a(f.END).a(e6.this.f16445k);
                return;
            }
            boolean z = true;
            e6.this.f16443i = true;
            try {
                i.a(gVar).a(f.PROCESSING).a(e6.this.f16445k);
                report = ((d3) ((r3) l2.a(r3.class)).d()).report(e6.this.d, e6.this.f16439e, b7.N(), e6.this.f16440f, b7.y(), b7.A(), b7.I(), b7.M(), b7.E(), b7.O(), b7.G(), this.a);
            } catch (Exception e2) {
                ma.b("err:" + e2.getMessage());
            }
            if (report != null) {
                ma.c("Post statistic data with response:" + new String(report.data, report.charset));
                i.a(g.UPLOAD).a(this.a).a(f.END).a(z).a(e6.this.f16445k);
                eVar = this.b;
                if (eVar != null) {
                    eVar.a(Boolean.valueOf(z));
                }
                e6.this.f16443i = false;
            }
            z = false;
            i.a(g.UPLOAD).a(this.a).a(f.END).a(z).a(e6.this.f16445k);
            eVar = this.b;
