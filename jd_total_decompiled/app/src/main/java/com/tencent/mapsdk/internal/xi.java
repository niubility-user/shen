...
public class xi extends ej implements TencentMap.OnCameraChangeListener {
    ...
    /* JADX WARN: Removed duplicated region for block: B:155:0x0034 A[Catch: all -> 0x0109, TryCatch #1 {, blocks: (B:138:0x0003, B:140:0x000e, B:142:0x0012, B:146:0x0021, B:148:0x0027, B:155:0x0034, B:157:0x006d, B:159:0x0073, B:163:0x007b, B:165:0x0081, B:167:0x0096, B:168:0x00ab, B:170:0x00ad, B:172:0x00b3, B:174:0x00b5), top: B:200:0x0003 }] */
    /* JADX WARN: Removed duplicated region for block: B:157:0x006d A[Catch: all -> 0x0109, TryCatch #1 {, blocks: (B:138:0x0003, B:140:0x000e, B:142:0x0012, B:146:0x0021, B:148:0x0027, B:155:0x0034, B:157:0x006d, B:159:0x0073, B:163:0x007b, B:165:0x0081, B:167:0x0096, B:168:0x00ab, B:170:0x00ad, B:172:0x00b3, B:174:0x00b5), top: B:200:0x0003 }] */
    /* JADX WARN: Removed duplicated region for block: B:170:0x00ad A[Catch: all -> 0x0109, TryCatch #1 {, blocks: (B:138:0x0003, B:140:0x000e, B:142:0x0012, B:146:0x0021, B:148:0x0027, B:155:0x0034, B:157:0x006d, B:159:0x0073, B:163:0x007b, B:165:0x0081, B:167:0x0096, B:168:0x00ab, B:170:0x00ad, B:172:0x00b3, B:174:0x00b5), top: B:200:0x0003 }] */
    ...
    */
    public boolean b(float f2, float f3) {
        boolean z;
        synchronized (this.I) {
            af afVar = (af) a(this.J);
            q4 q4Var = null;
            q4 q4Var2 = afVar != null ? afVar.e0 : null;
            if (this.J.equals("") || afVar == null || q4Var2 == null || !q4Var2.r()) {
                z = false;
            } else {
                z = q4Var2.onTap(f2, f3);
                if (z) {
                    q4Var = q4Var2;
                    if (!z) {
                        Object[] objArr = {Boolean.valueOf(z), afVar, q4Var};
                        Util.where(getMapContext().Z().h(), new b(f2, f3, objArr));
                    ...
                    if (!z) {
                        if (getMap() != null && this.b0 != null && afVar != null && q4Var != null && afVar.isInfoWindowShown()) {
                            this.b0.onInfoWindowClick(afVar);
                            Rect screenBound = q4Var.getScreenBound(getMap().getProjection());
                            if (screenBound != null) {
                                this.b0.onInfoWindowClickLocation(screenBound.width(), screenBound.height(), ((int) f2) - screenBound.left, ((int) f3) - screenBound.top);
                            }
                        }
                        return true;
                    }
                    ...
                    if (this.K) {
                        synchronized (this.I) {
                            Util.foreach(getMapContext().Z().h(), new c());
                        }
                    }
                    if (a(f2, f3)) {
                        return true;
                    ...
                    if (this.U != null && this.p) {
                        this.U.onMapClick(ea.d(getMap().getProjection().a(new o5(f2, f3))));
                    }
                    a();
                    return false;
                }
