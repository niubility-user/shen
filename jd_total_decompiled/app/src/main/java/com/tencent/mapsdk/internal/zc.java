...
public class zc extends sc<bd> implements ArcLineOverlay {
    public zc(ad adVar, bd bdVar) {
        super(adVar, bdVar);
    }
    ...
    public ReturnInfoModelClass.ReturnStatus executeCommandFunction(CommandFunctionModelClass.BaseCommandFunction baseCommandFunction) {
        ...
        if (name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$SetZoomLevelRangeCommand")) {
            ...
            ((bd) this.f17245j).setZoomLevelRange(zoomLevelRangeParams.minLevel, zoomLevelRangeParams.maxLevel);
            a((zc) this.f17245j);
            ...
            return new ReturnInfoModelClass.BaseBooleanReturnInfo(((bd) this.f17245j).isVisible());
        } else {
    ...
    public void setLevel(int i2) {
        if (((bd) this.f17245j).a() != null) {
            ((bd) this.f17245j).a().displayLevel(i2);
        }
        ((bd) this.f17245j).setDisplayLevel(i2);
        a((zc) this.f17245j);
    }
    ...
    public void setOpacity(float f2) {
        if (((bd) this.f17245j).a() != null) {
            ((bd) this.f17245j).a().opacity(f2);
        }
        ((bd) this.f17245j).setOpacity(f2);
        a((zc) this.f17245j);
    }
    ...
    public void setVisibility(boolean z) {
        if (((bd) this.f17245j).a() != null) {
            ((bd) this.f17245j).a().visibility(z);
        }
        ((bd) this.f17245j).setVisibility(z);
        a((zc) this.f17245j);
    }
    ...
    public void setZIndex(int i2) {
        if (((bd) this.f17245j).a() != null) {
            ((bd) this.f17245j).a().zIndex(i2);
        }
        ((bd) this.f17245j).setzIndex(i2);
        a((zc) this.f17245j);
    }
}
