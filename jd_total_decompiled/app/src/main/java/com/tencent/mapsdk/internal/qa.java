...
public class qa implements pa {
    ...
    /* JADX WARN: Removed duplicated region for block: B:229:0x010b A[LOOP:2: B:228:0x0109->B:229:0x010b, LOOP_END] */
    ...
    */
    public static void b(int i2, String str, Object... objArr) {
        ...
        AtomicInteger atomicInteger = a0;
        ...
        if (stackTraceElement.isNativeMethod()) {
            ...
            if (stackTraceElement.getFileName() != null) {
                ...
                if (lineNumber < 0) {
                    ...
                    if (i2 == 2) {
                        ma.f(str, sb.toString());
                        return;
                    } else if (i2 == 3) {
                        ma.a(str, sb.toString());
                        return;
                    } else if (i2 == 4) {
                        ma.c(str, sb.toString());
                        return;
                    } else if (i2 == 5) {
                        ma.g(str, sb.toString());
                        return;
                    } else if (i2 != 6) {
                        return;
                    } else {
                        ma.b(str, sb.toString());
                        return;
                    }
                }
                sb.append(stackTraceElement.getFileName());
