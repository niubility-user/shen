    ...
    public int b(fg fgVar) {
        ...
        if (W[0] == 33) {
            ...
            if (W[0] == 20) {
                z7 = true;
                int[] iArr = new int[0];
                if (fgVar.getPattern() != null) {
                    iArr = new int[fgVar.getPattern().size()];
                    for (int i7 = 0; i7 < fgVar.getPattern().size(); i7++) {
                        iArr[i7] = fgVar.getPattern().get(i7).intValue();
                    }
                }
                int[] iArr2 = iArr;
                int[] iArr3 = new int[0];
                if (fgVar.K() != null) {
                    iArr3 = new int[fgVar.K().length];
                    for (int i8 = 0; i8 < fgVar.K().length; i8++) {
                        iArr3[i8] = fgVar.K()[i8];
                    }
                }
                return ((Integer) c((CallbackRunnable<o3>) new o3(fgVar, i6, z6, z7, iArr3, iArr2), (o3) (-1))).intValue();
            }
        }
        z7 = false;
        int[] iArr4 = new int[0];
        ...
        return ((Integer) c((CallbackRunnable<o3>) new o3(fgVar, i6, z6, z7, iArr32, iArr22), (o3) (-1))).intValue();
    }
