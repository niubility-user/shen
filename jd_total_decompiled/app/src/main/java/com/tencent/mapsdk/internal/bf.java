    ...
    private boolean a(GeoPoint geoPoint) {
        ...
        while (true) {
            ...
            if (i2 >= i4) {
                ...
                GeoPoint geoPoint2 = bfVar.B.get(i4);
                GeoPoint geoPoint3 = bfVar.B.get(0);
                ...
                if (a(d2, d, longitudeE62, latitudeE62, longitudeE63, latitudeE63)) {
                    return true;
                }
                Double.isNaN(latitudeE63);
                Double.isNaN(latitudeE62);
                if (Math.abs(latitudeE63 - latitudeE62) >= 1.0E-9d) {
                    if (!a(longitudeE62, latitudeE62, d2, d, 180.0d, d)) {
                        if (a(longitudeE63, latitudeE63, d2, d, 180.0d, d)) {
                        }
                    }
                }
                return i3 % 2 == 1;
            }
            GeoPoint geoPoint4 = bfVar.B.get(i2);
            int i5 = i2 + 1;
            GeoPoint geoPoint5 = bfVar.B.get(i5);
            ...
            if (a(longitudeE6, latitudeE6, longitudeE64, latitudeE64, longitudeE65, latitudeE65)) {
                return true;
            }
            Double.isNaN(latitudeE65);
            Double.isNaN(latitudeE64);
            if (Math.abs(latitudeE65 - latitudeE64) >= 1.0E-9d) {
                if (a(longitudeE64, latitudeE64, d4, d3, 180.0d, d3)) {
                    if (latitudeE64 <= latitudeE65) {
                    }
                    i3++;
                } else if (a(longitudeE65, latitudeE65, d4, d3, 180.0d, d3)) {
                    if (latitudeE65 <= latitudeE64) {
                    }
                    i3++;
                } else {
                    if (!a(longitudeE64, latitudeE64, longitudeE65, latitudeE65, d4, d3, 180.0d, d3)) {
                    }
                    i3++;
                }
            }
