...
public class QbSdk {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:289:0x01a3 -> B:335:0x01a5). Please submit an issue!!! */
    ...
    */
    public static boolean canLoadVideo(Context context) {
        ...
        int i2;
        Object a2 = com.tencent.smtt.utils.j.a(s, "canLoadVideo", new Class[]{Integer.TYPE}, 0);
        if (a2 != null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:108:0x006c A[EXC_TOP_SPLITTER, SYNTHETIC] */
