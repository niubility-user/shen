...
public class PictureParameterSet extends BitstreamElement {
    ...
    public int hashCode() {
        ...
        boolean z = this.constrained_intra_pred_flag;
        int i2 = R2.attr.layout_constraintWidth;
        int i3 = (((((hashCode + (z ? R2.attr.layout_constraintWidth : R2.attr.layout_editor_absoluteX)) * 31) + (this.deblocking_filter_control_present_flag ? R2.attr.layout_constraintWidth : R2.attr.layout_editor_absoluteX)) * 31) + (this.entropy_coding_mode_flag ? R2.attr.layout_constraintWidth : R2.attr.layout_editor_absoluteX)) * 31;
        PPSExt pPSExt = this.extended;
        int hashCode2 = (((((((((((((((((((((((((((((((((i3 + (pPSExt == null ? 0 : pPSExt.hashCode())) * 31) + this.num_ref_idx_l0_active_minus1) * 31) + this.num_ref_idx_l1_active_minus1) * 31) + this.num_slice_groups_minus1) * 31) + this.pic_init_qp_minus26) * 31) + this.pic_init_qs_minus26) * 31) + (this.bottom_field_pic_order_in_frame_present_flag ? R2.attr.layout_constraintWidth : R2.attr.layout_editor_absoluteX)) * 31) + this.pic_parameter_set_id) * 31) + (this.redundant_pic_cnt_present_flag ? R2.attr.layout_constraintWidth : R2.attr.layout_editor_absoluteX)) * 31) + Arrays.hashCode(this.run_length_minus1)) * 31) + this.seq_parameter_set_id) * 31) + (this.slice_group_change_direction_flag ? R2.attr.layout_constraintWidth : R2.attr.layout_editor_absoluteX)) * 31) + this.slice_group_change_rate_minus1) * 31) + Arrays.hashCode(this.slice_group_id)) * 31) + this.slice_group_map_type) * 31) + Arrays.hashCode(this.top_left)) * 31) + this.weighted_bipred_idc) * 31;
        if (!this.weighted_pred_flag) {
            i2 = R2.attr.layout_editor_absoluteX;
        }
        return hashCode2 + i2;
    }
