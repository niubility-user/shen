...
public class Matrix {
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(matrix.a, this.a) == 0 && Double.compare(matrix.b, this.b) == 0 && Double.compare(matrix.f1076c, this.f1076c) == 0 && Double.compare(matrix.d, this.d) == 0 && Double.compare(matrix.tx, this.tx) == 0 && Double.compare(matrix.ty, this.ty) == 0 && Double.compare(matrix.u, this.u) == 0 && Double.compare(matrix.v, this.v) == 0 && Double.compare(matrix.w, this.w) == 0;
    }
    ...
    public void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter.writeFixedPoint1616(byteBuffer, this.f1076c);
    ...
    public int hashCode() {
        ...
        long doubleToLongBits6 = Double.doubleToLongBits(this.f1076c);
    ...
    public String toString() {
        ...
        return "Matrix{u=" + this.u + ", v=" + this.v + ", w=" + this.w + ", a=" + this.a + ", b=" + this.b + ", c=" + this.f1076c + ", d=" + this.d + ", tx=" + this.tx + ", ty=" + this.ty + '}';
    }
}
