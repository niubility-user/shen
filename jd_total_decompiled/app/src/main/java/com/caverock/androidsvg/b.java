...
public class b {
    ...
    public static class d extends l.i {
        ...
        /* JADX WARN: Removed duplicated region for block: B:220:0x0036  */
        /* JADX WARN: Removed duplicated region for block: B:221:0x003c  */
        ...
        */
        boolean M(s sVar) throws com.caverock.androidsvg.a {
            ...
            if (!sVar.f()) {
                ...
                while (!h()) {
                    if (f(OrderISVUtil.MONEY_DECIMAL_CHAR)) {
                        if (tVar == null) {
                            tVar = new t(eVar, null);
                        }
                        String H2 = H();
                        if (H2 != null) {
                            tVar.a("class", c.EQUALS, H2);
                            sVar.b();
                        } else {
