...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:244:0x0037  */
        /* JADX WARN: Removed duplicated region for block: B:253:0x005c  */
        /* JADX WARN: Removed duplicated region for block: B:255:0x005f  */
        ...
        /* JADX WARN: Removed duplicated region for block: B:326:0x020c  */
        /* JADX WARN: Removed duplicated region for block: B:332:0x0228 A[ADDED_TO_REGION] */
        @Nullable
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
                                ...
                                if (viewHolder == null) {
                                    ...
                                    if (j2 == Long.MAX_VALUE || this.mRecyclerPool.willCreateInTime(itemViewType, nanoTime, j2)) {
                                        ...
                                        if (!RecyclerView.this.mState.isPreLayout() && viewHolder2.isBound()) {
                                            ...
                                            tryBindViewHolderByDeadline = tryBindViewHolderByDeadline(viewHolder2, RecyclerView.this.mAdapterHelper.findPositionOffset(i2), i2, j2);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState == 1) {
                ...
                if (gapWorker != null && (i5 != 0 || i8 != 0)) {
                    gapWorker.postFromTraversal(this, i5, i8);
                }
            }
        } else if (actionMasked == 3) {
            cancelScroll();
