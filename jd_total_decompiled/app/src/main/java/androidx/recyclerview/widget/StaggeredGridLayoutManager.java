...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /* JADX WARN: Removed duplicated region for block: B:87:0x0043 A[RETURN] */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:155:0x0074, code lost:
        if (r10 == r11) goto L161;
     */
    /* JADX WARN: Code restructure failed: missing block: B:160:0x0086, code lost:
        if (r10 == r11) goto L161;
     */
    ...
    */
    View hasGapsToFix() {
        ...
        char c2 = (this.mOrientation == 1 && isLayoutRTL()) ? (char) 1 : '\uffff';
        if (this.mShouldReverseLayout) {
            i2 = -1;
        } else {
            i2 = childCount + 1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:293:0x0157, code lost:
        if (checkForGaps() != false) goto L296;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
