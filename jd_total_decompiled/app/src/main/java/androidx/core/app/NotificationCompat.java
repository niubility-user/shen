...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        /* JADX WARN: Removed duplicated region for block: B:246:0x0178  */
        /* JADX WARN: Removed duplicated region for block: B:247:0x0182  */
        /* JADX WARN: Removed duplicated region for block: B:250:0x018a A[ADDED_TO_REGION] */
        /* JADX WARN: Removed duplicated region for block: B:252:0x018e  */
        /* JADX WARN: Removed duplicated region for block: B:256:0x01b0  */
        ...
        /* JADX WARN: Removed duplicated region for block: B:273:0x020a  */
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        /*
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i2, boolean z2) {
            ...
            if (builder.mLargeIcon != null) {
                if (i3 >= 16) {
                    ...
                    remoteViews.setImageViewBitmap(i4, this.mBuilder.mLargeIcon);
                } else {
                ...
                if (i3 >= 21) {
                    ...
                    remoteViews.setImageViewBitmap(i5, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            ...
            boolean z9 = i3 < 21 && this.mBuilder.mLargeIcon != null;
            Builder builder4 = this.mBuilder;
            CharSequence charSequence5 = builder4.mContentInfo;
            if (charSequence5 != null) {
                int i6 = R.id.info;
                remoteViews.setTextViewText(i6, charSequence5);
                ...
                if (charSequence != null && i3 >= 16) {
                    ...
                    if (charSequence2 == null) {
                        ...
                        if (this.mBuilder.getWhenIfShowing() == 0) {
                            z7 = z5;
                        } else if (this.mBuilder.mUseChronometer && i3 >= 16) {
