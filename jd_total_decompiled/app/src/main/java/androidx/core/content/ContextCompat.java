...
public class ContextCompat {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            hashMap.put(ClipboardManager.class, CashierCustomMessage.KEY.CHANNEL_CLIP_BOARD);
            hashMap.put(ConnectivityManager.class, "connectivity");
            hashMap.put(DevicePolicyManager.class, "device_policy");
            hashMap.put(DownloadManager.class, IExceptionHandler.DynamicExceptionData.TYPE_DOWNLOAD);
            hashMap.put(DropBoxManager.class, "dropbox");
            hashMap.put(InputMethodManager.class, "input_method");
            hashMap.put(KeyguardManager.class, "keyguard");
            hashMap.put(LayoutInflater.class, "layout_inflater");
            hashMap.put(LocationManager.class, ThemeTitleConstant.TITLE_LOCATION_DRAWABLE_ID);
            hashMap.put(NfcManager.class, "nfc");
            hashMap.put(NotificationManager.class, RemoteMessageConst.NOTIFICATION);
            hashMap.put(PowerManager.class, "power");
            hashMap.put(SearchManager.class, "search");
            hashMap.put(SensorManager.class, "sensor");
            hashMap.put(StorageManager.class, IExceptionHandler.DynamicExceptionData.TYPE_STORAGE);
            hashMap.put(TelephonyManager.class, SignUpTable.TB_COLUMN_PHONE);
