...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    /* JADX WARN: Removed duplicated region for block: B:229:0x00fe  */
    /* JADX WARN: Removed duplicated region for block: B:234:0x010b A[SYNTHETIC] */
    /*
        ...
        if (view instanceof ViewGroup) {
            ...
            while (i9 < childCount) {
                ...
                if (i2 >= 0 && (childAt.getTag() instanceof String)) {
                    ...
                    if (str2.endsWith("_0") && str2.startsWith("layout") && str2.indexOf(47) > 0 && (findIncludeIndex = findIncludeIndex(str2, i10, includedLayouts, i2)) >= 0) {
                        int i11 = findIncludeIndex + 1;
                        int i12 = includedLayouts.indexes[i2][findIncludeIndex];
                        int i13 = includedLayouts.layoutIds[i2][findIncludeIndex];
