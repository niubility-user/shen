...
public abstract class FragmentManager implements FragmentResultOwner {
        ...
        if (!z3 && this.mCurState >= 1) {
            if (!USE_STATE_MANAGER) {
                ...
                for (i9 = i2; i9 < i8; i9++) {
                    ...
                    if (arrayList4.get(i9).booleanValue() && backStackRecord3.mIndex >= 0) {
            ...
            for (int i13 = i2; i13 < i3; i13++) {
                Iterator<FragmentTransaction.Op> it2 = arrayList.get(i13).mOps.iterator();
                while (it2.hasNext()) {
    ...
    */
    void moveToState(@NonNull Fragment fragment, int i2) {
        ...
        int min = Math.min(i2, fragmentStateManager.computeExpectedState());
