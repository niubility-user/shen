        ...
        while (true) {
            ...
            if (virtualChildAt == null) {
                ...
                if (mode == i18 && ((ViewGroup.MarginLayoutParams) layoutParams).width == 0 && f4 > 0.0f) {
                    ...
                    if (((ViewGroup.MarginLayoutParams) layoutParams).width != 0 || f4 <= 0.0f) {
                ...
                if (virtualChildAt == null) {
                    ...
                    if (virtualChildAt.getVisibility() == 8) {
                        ...
                        if (mode2 == 1073741824 && ((ViewGroup.MarginLayoutParams) layoutParams).height == 0 && f3 > 0.0f) {
                            ...
                            int i31 = i22;
                            if (((ViewGroup.MarginLayoutParams) layoutParams).height != 0 || f3 <= 0.0f) {
                            ...
                            if (f6 > 0.0f) {
                                ...
                                if (((ViewGroup.MarginLayoutParams) layoutParams3).height == 0) {
                                    ...
                                    if (i40 == 1073741824) {
                                        ...
                                        i5 = View.combineMeasuredStates(i5, virtualChildAt4.getMeasuredState() & InputDeviceCompat.SOURCE_ANY);
                                        f2 = f7;
                                    }
                                } else {
                                    i11 = 1073741824;
