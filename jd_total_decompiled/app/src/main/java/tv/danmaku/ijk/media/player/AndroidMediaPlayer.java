...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    public class AndroidMediaPlayerListenerHolder implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnTimedTextListener, IMediaPlayer.OnExtInfoListener {
        ...
        public void onCompletion(MediaPlayer mediaPlayer) {
            ...
            AndroidMediaPlayer.access$010(androidMediaPlayer);
            if (androidMediaPlayer.mLoopCount > 0) {
                androidMediaPlayer.seekTo(0L);
        ...
        public void onExtInfo(IMediaPlayer iMediaPlayer, int i2, int i3, int i4, HashMap<String, Object> hashMap) {
            AndroidMediaPlayer.this.notifyOnExtInfo(i2, i3, i4, hashMap);
        }
        ...
        public void onPrepared(MediaPlayer mediaPlayer) {
            ...
            AndroidMediaPlayer.this.notifyOnPrepared(SystemClock.elapsedRealtime() - AndroidMediaPlayer.this.mPrepareStartTime);
        }
    ...
    static /* synthetic */ int access$010(AndroidMediaPlayer androidMediaPlayer) {
        int i2 = androidMediaPlayer.mLoopCount;
        androidMediaPlayer.mLoopCount = i2 - 1;
        return i2;
    }
