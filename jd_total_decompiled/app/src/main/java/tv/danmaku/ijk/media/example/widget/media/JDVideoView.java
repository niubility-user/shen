...
public class JDVideoView extends IJDVideoPlayer {
    ...
    public JDVideoView(Context context) {
        ...
        this.mPreparedListener = new IMediaPlayer.OnPreparedListener() { // from class: tv.danmaku.ijk.media.example.widget.media.JDVideoView.4
            ...
            /* JADX WARN: Code restructure failed: missing block: B:161:0x00a3, code lost:
                if (r0.mSurfaceHeight == r0.mVideoHeight) goto L162;
             */
            ...
            */
            public void onPrepared(IMediaPlayer iMediaPlayer) {
                ...
                JDVideoView jDVideoView2 = JDVideoView.this;
                if (jDVideoView2.mPlayerOptions.isStartOnPrepared) {
                    jDVideoView2.mPlayDurationStatistics.start();
                    if ((!MediaPlayerHelper.isLoadJniOk || JDVideoView.this.mPlayerOptions.isForceAndroidPlayer) && ((IJDVideoPlayer) JDVideoView.this).mMediaPlayer != null) {
                        ((IJDVideoPlayer) JDVideoView.this).mMediaPlayer.start();
                    }
                }
                ...
                int i3 = JDVideoView.this.mSeekWhenPrepared;
                if (i3 != 0) {
                    JDVideoView.this.seekTo(i3);
                }
                JDVideoView jDVideoView3 = JDVideoView.this;
                IPlayerControl.PlayerOptions playerOptions2 = jDVideoView3.mPlayerOptions;
                if (playerOptions2 != null && playerOptions2.isStartOnPrepared) {
                    jDVideoView3.mTargetState = 3;
                }
                JDVideoView jDVideoView4 = JDVideoView.this;
                int i4 = jDVideoView4.mVideoWidth;
                if (i4 == 0 || (i2 = jDVideoView4.mVideoHeight) == 0) {
                    if (jDVideoView4.mTargetState == 3) {
                        JDVideoView.this.start();
                    }
                } else {
                    IRenderView iRenderView = jDVideoView4.mRenderView;
                    if (iRenderView != null) {
                        iRenderView.setVideoSize(i4, i2);
                        JDVideoView jDVideoView5 = JDVideoView.this;
                        jDVideoView5.mRenderView.setVideoSampleAspectRatio(jDVideoView5.mVideoSarNum, jDVideoView5.mVideoSarDen);
                        if (JDVideoView.this.mRenderView.shouldWaitForResize()) {
                            JDVideoView jDVideoView6 = JDVideoView.this;
                            if (jDVideoView6.mSurfaceWidth == jDVideoView6.mVideoWidth) {
                            }
                        }
                        if (JDVideoView.this.mTargetState == 3) {
                            if (((IJDVideoPlayer) JDVideoView.this).mMediaPlayer != null && !((IJDVideoPlayer) JDVideoView.this).mMediaPlayer.isPlaying()) {
                                JDVideoView.this.start();
                            }
                            if (JDVideoView.this.mMediaController != null && ((playerOptions = (jDVideoView = JDVideoView.this).mPlayerOptions) == null || playerOptions.showControllerOnStart)) {
                                jDVideoView.mMediaController.show();
                            }
                        } else if (!JDVideoView.this.isPlaying() && ((i3 != 0 || JDVideoView.this.getCurrentPosition() > 0) && JDVideoView.this.mMediaController != null)) {
                            JDVideoView.this.mMediaController.show(0);
                        }
                    }
                }
                JDVideoView.this.postDelayed(new Runnable() { // from class: tv.danmaku.ijk.media.example.widget.media.JDVideoView.4.1
                    {
                    ...
                    public void run() {
                        ...
                        if (iRenderView2 == null || iRenderView2.getView().getVisibility() == 0) {
                            return;
                        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:227:0x0186 A[Catch: IllegalArgumentException -> 0x018e, IOException -> 0x01b1, TRY_LEAVE, TryCatch #2 {IOException -> 0x01b1, IllegalArgumentException -> 0x018e, blocks: (B:208:0x00a4, B:210:0x00aa, B:213:0x00af, B:220:0x015e, B:222:0x0165, B:224:0x016f, B:225:0x0182, B:227:0x0186, B:214:0x011f, B:216:0x0125, B:218:0x0129, B:219:0x0159), top: B:246:0x00a4 }] */
    ...
    */
    public void openVideo() {
        ...
        DebugLog.d(TAG, "[" + this.tag + "] openVideo 0");
        if (this.mPlayerOptions == null) {
            return;
        }
        if ((this.bIsForceRelease.get() || this.mSurfaceHolder == null) && (playerOptions = this.mPlayerOptions) != null && !playerOptions.usePreDraw && !playerOptions.sharePlayer) {
            return;
        }
        ...
        if (!authCheck.isValidPlayType(new AuthPlayInfo(playerOptions3.playTypeId, playerOptions3.isLive ? "1" : "0", playerOptions3.isForceAndroidPlayer ? "2" : "0"))) {
        ...
        DebugLog.d(TAG, "[" + this.tag + "] openVideo 1");
        IPlayerControl.PlayerOptions playerOptions4 = this.mPlayerOptions;
        if (!playerOptions4.usePreDraw && !playerOptions4.sharePlayer) {
            release(false);
        }
        this.isCouldStartOnRendered = true;
        checkAudioFocus();
        try {
            playerOptions2 = this.mPlayerOptions;
        ...
        if (!playerOptions2.usePreDraw && !playerOptions2.sharePlayer) {
            DebugLog.d(TAG, "[" + this.tag + "] openVideo create player");
            this.mMediaPlayer = JDPlayerHelper.getInstance().createIdlePlayer(this.mPlayerOptions, this.mUri);
            addPlayerListeners();
            this.mMediaPlayer.notifyPlayEvent(0);
            this.mMediaPlayer.notifyPlayState(0, 0L, null, null);
            this.mCurrentBufferPercentage = 0;
            this.mUri = JDPlayerHelper.getInstance().setDataSource(this.mMediaPlayer, this.rawDataSourceProvider, this.mPlayerOptions, this.mHeaders, this.mUri, this.originUrl);
            createPlayerMonitor();
            bindSurfaceHolder(this.mMediaPlayer, this.mSurfaceHolder);
            this.mMediaPlayer.prepareAsync();
            this.mCurrentState = 1;
            attachMediaController();
            createPlayerMtaReport(true);
            l2 = this.expireTime;
            if (l2 != null && l2.longValue() >= 0) {
                getHandler().postDelayed(this.expireRunnable, this.expireTime.longValue() * 1000);
            }
            infoHudViewHolder = this.mHudViewHolder;
            ...
            iRenderView = this.mRenderView;
            if (iRenderView == null) {
                IPlayerControl.PlayerOptions playerOptions5 = this.mPlayerOptions;
                if (playerOptions5.usePreDraw || playerOptions5.sharePlayer) {
                    return;
                }
        ...
        this.preDrawAutoPlay = true;
        if (this.mMediaPlayer != null && this.mCurrentState >= 1) {
            DebugLog.d(TAG, "[" + this.tag + "] openVideo start");
            this.mMediaPlayer.notifyPlayEvent(16);
            this.mMediaPlayer.notifyPlayState(7, 0L, null, null);
            start();
        } else {
            preDraw(this.originUrl, playerOptions2);
        }
        createPlayerMtaReport(true);
        l2 = this.expireTime;
        if (l2 != null) {
        ...
        this.mPreparedListener = new IMediaPlayer.OnPreparedListener() { // from class: tv.danmaku.ijk.media.example.widget.media.JDVideoView.4
            ...
            */
            public void onPrepared(IMediaPlayer iMediaPlayer) {
                ...
                JDVideoView jDVideoView4 = JDVideoView.this;
                int i4 = jDVideoView4.mVideoWidth;
                if (i4 == 0 || (i22 = jDVideoView4.mVideoHeight) == 0) {
                    if (jDVideoView4.mTargetState == 3) {
                        JDVideoView.this.start();
                    }
                } else {
                    IRenderView iRenderView = jDVideoView4.mRenderView;
                    if (iRenderView != null) {
                        iRenderView.setVideoSize(i4, i22);
                        JDVideoView jDVideoView5 = JDVideoView.this;
                        jDVideoView5.mRenderView.setVideoSampleAspectRatio(jDVideoView5.mVideoSarNum, jDVideoView5.mVideoSarDen);
                        if (JDVideoView.this.mRenderView.shouldWaitForResize()) {
                            JDVideoView jDVideoView6 = JDVideoView.this;
        ...
        this.mPreparedListener = new IMediaPlayer.OnPreparedListener() { // from class: tv.danmaku.ijk.media.example.widget.media.JDVideoView.4
            ...
            */
            public void onPrepared(IMediaPlayer iMediaPlayer) {
                ...
                int i32 = JDVideoView.this.mSeekWhenPrepared;
                if (i32 != 0) {
                    JDVideoView.this.seekTo(i32);
                }
                JDVideoView jDVideoView3 = JDVideoView.this;
                IPlayerControl.PlayerOptions playerOptions2 = jDVideoView3.mPlayerOptions;
                if (playerOptions2 != null && playerOptions2.isStartOnPrepared) {
                ...
                if (i4 == 0 || (i22 = jDVideoView4.mVideoHeight) == 0) {
                    ...
                    if (iRenderView != null) {
                        ...
                        } else if (!JDVideoView.this.isPlaying() && ((i32 != 0 || JDVideoView.this.getCurrentPosition() > 0) && JDVideoView.this.mMediaController != null)) {
                            JDVideoView.this.mMediaController.show(0);
                        }
                    }
                }
