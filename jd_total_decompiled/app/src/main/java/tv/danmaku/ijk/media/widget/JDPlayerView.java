        ...
        this.onPlayerStateListener = new IPlayerControl.OnPlayerStateListener() { // from class: tv.danmaku.ijk.media.widget.JDPlayerView.6
            ...
            */
            public boolean onInfo(int i3, int i4) {
                if (JDPlayerView.this.playerStateListener != null) {
                    JDPlayerView.this.playerStateListener.onInfo(i3, i4);
                }
                if (i3 != 3) {
                    if (i3 == 30003) {
                        this.loopCompleted = true;
                    } else if (i3 == 701) {
                        if (JDPlayerView.this.enableLoading && !this.loopCompleted) {
                            JDPlayerView.this.progressBar.setVisibility(0);
                        }
                ...
                if (i3 == 3 && JDPlayerView.this.imgCover != null) {
    ...
    public JDPlayerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2, int i3) {
        ...
        this.onPlayerStateListener = new IPlayerControl.OnPlayerStateListener() { // from class: tv.danmaku.ijk.media.widget.JDPlayerView.6
            ...
            /*
                Code decompiled incorrectly, please refer to instructions dump.
            */
            public boolean onInfo(int i32, int i4) {
                if (JDPlayerView.this.playerStateListener != null) {
                    JDPlayerView.this.playerStateListener.onInfo(i32, i4);
                }
                if (i32 != 3) {
                    if (i32 == 30003) {
                        this.loopCompleted = true;
                ...
                if (i32 == 3 && JDPlayerView.this.imgCover != null) {
                    JDPlayerView.this.imgCover.setVisibility(8);
                }
                JDPlayerView.this.hasError = false;
                JDPlayerView.this.isCompleted = false;
