...
public class DJPointImageView extends AppCompatImageView implements DJPointView, RoundMethodInterface, DarkViewInterface {
    ...
    public DJPointImageView(Context context, @Nullable AttributeSet attributeSet) {
    ...
    public DJPointImageView(Context context, @Nullable AttributeSet attributeSet, int i2) {
