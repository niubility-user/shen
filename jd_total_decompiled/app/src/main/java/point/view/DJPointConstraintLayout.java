...
public class DJPointConstraintLayout extends ConstraintLayout implements DJPointView, RoundMethodInterface, DarkViewInterface {
    private final DJPointViewDelegate djPointViewDelegate;
    private int mDarkColor;
    private RoundHelper mHelper;
    private boolean mSwitchDark;

    public DJPointConstraintLayout(Context context) {
        this(context, null);
    }
    ...
    public DJPointConstraintLayout(Context context, @Nullable AttributeSet attributeSet) {
    ...
    public DJPointConstraintLayout(Context context, @Nullable AttributeSet attributeSet, int i2) {
