...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private Address createAddress(HttpUrl httpUrl) {
        ...
        return new Address(httpUrl.host(), httpUrl.port(), this.client.dns(), httpUrl.getResolverInetAddress(), this.client.socketFactory(), sSLSocketFactory, hostnameVerifier, certificatePinner, this.client.proxyAuthenticator(), this.client.proxy(), this.client.protocols(), this.client.connectionSpecs(), this.client.proxySelector());
    }
    ...
    private Request followUpRequest(Response response, Route route) throws IOException {
        ...
        if (response != null) {
            ...
            if (code == 307 || code == 308) {
                if (!method.equals("GET") && !method.equals(UrlHelper.METHOD_HEAD)) {
                    return null;
                }
            } else if (code != 401) {
                if (code == 503) {
