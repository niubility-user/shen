...
public class JdkWithJettyBootPlatform extends Platform {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            if (name.equals("unsupported") && Void.TYPE == returnType) {
                ...
                if ((name.equals("selectProtocol") || name.equals("select")) && String.class == returnType && objArr.length == 1 && (objArr[0] instanceof List)) {
                    ...
                    this.selected = str2;
                    return str2;
                } else if ((name.equals("protocolSelected") || name.equals(DYConstants.DY_SELECTED)) && objArr.length == 1) {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            return new JdkWithJettyBootPlatform(cls.getMethod("put", SSLSocket.class, cls2), cls.getMethod(IMantoServerRequester.GET, SSLSocket.class), cls.getMethod("remove", SSLSocket.class), Class.forName("org.eclipse.jetty.alpn.ALPN$ClientProvider"), Class.forName("org.eclipse.jetty.alpn.ALPN$ServerProvider"));
