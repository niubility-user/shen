...
public class AndroidPlatform extends Platform {
    ...
    static final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
        ...
        public List<Certificate> clean(List<Certificate> list, String str) throws SSLPeerUnverifiedException {
            try {
                return (List) this.checkServerTrusted.invoke(this.x509TrustManagerExtensions, (X509Certificate[]) list.toArray(new X509Certificate[list.size()]), RSAUtils.KEY_ALGORITHM, str);
    ...
    static final class CloseGuard {
        ...
        static CloseGuard get() {
            ...
            try {
                ...
                Method method4 = cls.getMethod(IMantoServerRequester.GET, new Class[0]);
                method2 = cls.getMethod(JshopConst.JSKEY_CATE_OPEN, String.class);
