            ...
            if (name.equalsIgnoreCase(HttpHeaders.CACHE_CONTROL)) {
                if (str2 == null) {
                    ...
                    for (i2 = 0; i2 < value.length(); i2 = i3) {
                        int skipUntil = okhttp3.internal.http.HttpHeaders.skipUntil(value, i2, "=,;");
                        ...
                        if (skipUntil == value.length() || value.charAt(skipUntil) == ',' || value.charAt(skipUntil) == ';') {
                            ...
                            if (skipWhitespace < value.length() && value.charAt(skipWhitespace) == '\"') {
                                ...
                                int skipUntil2 = okhttp3.internal.http.HttpHeaders.skipUntil(value, i9, "\"");
                                str = value.substring(i9, skipUntil2);
                                i3 = skipUntil2 + 1;
                            } else {
                                i3 = okhttp3.internal.http.HttpHeaders.skipUntil(value, skipWhitespace, ",;");
                        ...
                        if ("no-cache".equalsIgnoreCase(trim)) {
                            ...
                            i7 = okhttp3.internal.http.HttpHeaders.parseSeconds(str, Integer.MAX_VALUE);
                        } else if ("min-fresh".equalsIgnoreCase(trim)) {
                            i8 = okhttp3.internal.http.HttpHeaders.parseSeconds(str, -1);
