...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder delete(@Nullable RequestBody requestBody) {
            return method(UrlHelper.METHOD_DELETE, requestBody);
        }
        ...
        public Builder head() {
            return method(UrlHelper.METHOD_HEAD, null);
        }
        ...
        public Builder patch(RequestBody requestBody) {
            return method(UrlHelper.METHOD_PATCH, requestBody);
        }
        ...
        public Builder put(RequestBody requestBody) {
            return method(UrlHelper.METHOD_PUT, requestBody);
        }
