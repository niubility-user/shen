...
public class LockFreeLinkedListNode {
    ...
    public static abstract class AbstractAtomicDesc extends AtomicDesc {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:159:0x0053, code lost:
            if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED() == false) goto L167;
         */
        /* JADX WARN: Code restructure failed: missing block: B:160:0x0055, code lost:
            if (r4 != null) goto L162;
         */
        /* JADX WARN: Code restructure failed: missing block: B:161:0x0057, code lost:
            r7 = true;
         */
         ...
         */
        /* JADX WARN: Code restructure failed: missing block: B:166:0x0062, code lost:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:138:0x0048, code lost:
        if (kotlinx.coroutines.internal.LockFreeLinkedListNode._next$FU.compareAndSet(r3, r2, ((kotlinx.coroutines.internal.Removed[) r4).Removed[) != false) goto L140;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
