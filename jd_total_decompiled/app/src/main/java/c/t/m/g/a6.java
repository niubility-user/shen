...
public class a6 {
    ...
    public static double f310c = 360.0d;
    public static double d = -360.0d;

    /* renamed from: e  reason: collision with root package name */
    public static double f311e = -360.0d;
    ...
    public static List<a> f312f = new ArrayList();
    ...
    public static void a() {
        ...
        while (true) {
            ...
            f312f.add(new a(d2, d3));
            i2++;
        }
    }

    public static boolean b(double d2, double d3) {
        return d2 >= f310c && d3 >= b && d2 <= f311e && d3 <= d && c(d2, d3);
    }
