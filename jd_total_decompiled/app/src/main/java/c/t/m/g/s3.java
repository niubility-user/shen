...
public class s3 {
    ...
    public s3(y4 y4Var) {
        ...
        if (TextUtils.isEmpty(TencentLocationManagerOptions.getExtraKey())) {
            if (!TextUtils.isEmpty(TencentLocationManagerOptions.getKey())) {
                g5Var = this.A;
                key = TencentLocationManagerOptions.getKey();
            }
            o4.n("7.4.9.official_1-220803");
            String A = this.A.A();
            m2 = m(A);
            this.T = m2;
            if (!TextUtils.isEmpty(m2)) {
                StringBuilder sb = new StringBuilder("requestLocationUpdates: illegal key [");
                sb.append(A);
                sb.append("]");
                this.s = 2;
                return;
            ...
            this.r = new h5(this.z);
            this.o = u2.b(y4Var.a);
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    this.p = new p1(this.z.a);
            ...
            try {
                q2.i(this.z.a, "txsdk", "7.4.9.official_1");
                q2.j(this.T);
                return;
            } catch (Throwable unused4) {
                return;
        ...
        g5Var = this.A;
        key = TencentLocationManagerOptions.getExtraKey();
        g5Var.r(key);
        o4.n("7.4.9.official_1-220803");
        String A2 = this.A.A();
        m2 = m(A2);
    ...
    */
    public final void o(int i2, int i3, int i4) {
        ...
        String str3 = "unknown";
        switch (i3) {
            case R2.drawable.wxa_trading_guarantee_icon_green /* 12001 */:
                str = "wifi";
                if (i4 == 0) {
                    str3 = "wifi disabled";
                } else if (i4 == 1) {
                ...
                str2 = str3;
                break;
            case R2.drawable.x5_icon /* 12002 */:
                if (i4 == 0) {
                    str2 = "gps disabled";
                    break;
                } else {
            ...
            case R2.drawable.x_dialog_bg2 /* 12003 */:
                str = "cell";
                str2 = i4 == 1 ? "cell enabled" : i4 == 0 ? "cell disabled" : "unknown";
                break;
            case R2.drawable.x_dialog_bottom /* 12004 */:
                if (i4 == 3) {
                    str2 = "gps available";
                    break;
                } else {
        ...
        if (i3 == 12004) {
            if (this.b0 != i4) {
                o4.o(str, "s:".concat(String.valueOf(i4)));
            }
            this.b0 = i4;
        } else {
            o4.o(str, "s:".concat(String.valueOf(i4)));
        ...
        f fVar = this.f665f;
        if (fVar != null) {
            Message obtainMessage = fVar.obtainMessage(R2.color.bubble_chat_from_bg_color);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:106:0x0056, code lost:
        if ((java.lang.System.currentTimeMillis() - r11.I) <= r0) goto L112;
     */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void s(c.t.m.g.f fVar) {
        int i2;
        String str;
        y4 y4Var;
        this.v = fVar;
        long max = Math.max(this.K.getInterval(), 20000L);
        List<ScanResult> emptyList = Collections.emptyList();
        if (this.W) {
            i2 = 1;
        } else {
            i2 = k1.d ? 0 : p0();
            if (i2 != 1 && (y4Var = this.z) != null) {
                emptyList = k1.c(y4Var.n(), false);
                emptyList.size();
            }
        }
        if (i2 != 1 && emptyList.size() != 0) {
            long j2 = this.I;
            if (j2 != -1) {
                if (j2 > 0) {
                }
                StringBuilder sb = new StringBuilder("cell change run prepare json,because status:");
                sb.append(i2);
                sb.append(",mLastWF:");
                sb.append(this.I);
                sb.append(",current:");
                ...
                if (fVar == null) {
                    String str2 = fVar.d + DYConstants.DY_REGEX_COMMA + fVar.f406f;
                    if (this.a0.equals(str2)) {
                        return;
                    }
                    String str3 = "cell:" + fVar.b + DYConstants.DY_REGEX_COMMA + fVar.f404c + DYConstants.DY_REGEX_COMMA + fVar.d + DYConstants.DY_REGEX_COMMA + fVar.f406f + DYConstants.DY_REGEX_COMMA + fVar.f405e + DYConstants.DY_REGEX_COMMA;
                    if (fVar.f407g == Integer.MAX_VALUE || fVar.f408h == Integer.MAX_VALUE) {
                        str = str3 + "-1,-1";
                    } else {
                        str = str3 + String.format(Locale.ENGLISH, "%.6f,%.6f", Float.valueOf(fVar.f407g / 14400.0f), Float.valueOf(fVar.f408h / 14400.0f));
                    }
                    o4.o("CELL", str);
                    this.a0 = str2;
                    return;
        ...
        StringBuilder sb2 = new StringBuilder("cell change run prepare json,because status:");
        sb2.append(i2);
        sb2.append(",mLastWF:");
        sb2.append(this.I);
        sb2.append(",current:");
